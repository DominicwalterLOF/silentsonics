...
/* compiled from: ttake.yail */
public class ttake extends Form implements Runnable {
    ...
    static {
        ...
        int[] iArr = new int[2];
        iArr[0] = -14344902;
        Lit12 = IntNum.make(iArr);
        new SimpleSymbol("PrimaryColorDark");
        Lit11 = (SimpleSymbol) simpleSymbol18.readResolve();
        int[] iArr2 = new int[2];
        iArr2[0] = -14015152;
        Lit10 = IntNum.make(iArr2);
        new SimpleSymbol("PrimaryColor");
        Lit9 = (SimpleSymbol) simpleSymbol19.readResolve();
        new SimpleSymbol("AppName");
        Lit8 = (SimpleSymbol) simpleSymbol20.readResolve();
        new SimpleSymbol(PropertyTypeConstants.PROPERTY_TYPE_TEXT);
        Lit7 = (SimpleSymbol) simpleSymbol21.readResolve();
        new SimpleSymbol("AppId");
        Lit6 = (SimpleSymbol) simpleSymbol22.readResolve();
        new SimpleSymbol("number");
        Lit5 = (SimpleSymbol) simpleSymbol23.readResolve();
        int[] iArr3 = new int[2];
        iArr3[0] = -35072;
        Lit4 = IntNum.make(iArr3);
        new SimpleSymbol("AccentColor");
        Lit3 = (SimpleSymbol) simpleSymbol24.readResolve();
        new SimpleSymbol("*the-null-value*");
        Lit2 = (SimpleSymbol) simpleSymbol25.readResolve();
        new SimpleSymbol("getMessage");
        Lit1 = (SimpleSymbol) simpleSymbol26.readResolve();
        new SimpleSymbol("ttake");
        Lit0 = (SimpleSymbol) simpleSymbol27.readResolve();
    }
    ...
    public ttake() {
        ...
        ModuleMethod moduleMethod19 = moduleMethod;
        new frame();
        frame frame3 = frame2;
        frame3.$main = this;
        frame frame4 = frame3;
        new ModuleMethod(frame4, 1, Lit16, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.get$Mnsimple$Mnname = moduleMethod19;
        new ModuleMethod(frame4, 2, Lit17, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.android$Mnlog$Mnform = moduleMethod2;
        new ModuleMethod(frame4, 3, Lit18, 8194);
        this.add$Mnto$Mnform$Mnenvironment = moduleMethod3;
        new ModuleMethod(frame4, 4, Lit19, 8193);
        this.lookup$Mnin$Mnform$Mnenvironment = moduleMethod4;
        new ModuleMethod(frame4, 6, Lit20, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.is$Mnbound$Mnin$Mnform$Mnenvironment = moduleMethod5;
        new ModuleMethod(frame4, 7, Lit21, 8194);
        this.add$Mnto$Mnglobal$Mnvar$Mnenvironment = moduleMethod6;
        new ModuleMethod(frame4, 8, Lit22, 8194);
        this.add$Mnto$Mnevents = moduleMethod7;
        new ModuleMethod(frame4, 9, Lit23, 16388);
        this.add$Mnto$Mncomponents = moduleMethod8;
        new ModuleMethod(frame4, 10, Lit24, 8194);
        this.add$Mnto$Mnglobal$Mnvars = moduleMethod9;
        new ModuleMethod(frame4, 11, Lit25, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnform$Mndo$Mnafter$Mncreation = moduleMethod10;
        new ModuleMethod(frame4, 12, Lit26, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        new ModuleMethod(frame4, 14, Lit27, 16388);
        this.dispatchEvent = moduleMethod13;
        new ModuleMethod(frame4, 15, Lit28, 16388);
        this.dispatchGenericEvent = moduleMethod14;
        new ModuleMethod(frame4, 16, Lit29, 8194);
    ...
    public final void run(CallContext $ctx) {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            ...
            Object andCoerceProperty$Ex7 = runtime.setAndCoerceProperty$Ex(Lit0, Lit14, "AppTheme.Light.DarkActionBar", Lit7);
            Values.writeValues(runtime.setAndCoerceProperty$Ex(Lit0, Lit15, "ttake", Lit7), $result);
        } else {
    ...
    static Object lambda3() {
        ...
        Object andCoerceProperty$Ex6 = runtime.setAndCoerceProperty$Ex(Lit0, Lit13, AlgorithmIdentifiers.NONE, Lit7);
        Object andCoerceProperty$Ex7 = runtime.setAndCoerceProperty$Ex(Lit0, Lit14, "AppTheme.Light.DarkActionBar", Lit7);
        return runtime.setAndCoerceProperty$Ex(Lit0, Lit15, "ttake", Lit7);
    }
    ...
    public class frame extends ModuleBody {
        ...
        public Object apply0(ModuleMethod moduleMethod) {
            ...
            switch (moduleMethod2.selector) {
                case 17:
                    return ttake.lambda2();
                case 18:
                    this.$main.$define();
                    return Values.empty;
                case 19:
                    return ttake.lambda3();
                default:
