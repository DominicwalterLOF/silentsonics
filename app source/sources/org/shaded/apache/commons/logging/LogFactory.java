            ...
            public Object run() {
                ...
                try {
                    ...
                    if (LogFactory.isDiagnosticsEnabled()) {
                        new StringBuffer();
                        LogFactory.access$000(stringBuffer.append("Exception while trying to find configuration file ").append(this.val$name).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(e2.getMessage()).toString());
                    }
                    return null;
