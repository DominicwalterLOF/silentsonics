...
public class SocketHttpServerConnection extends AbstractHttpServerConnection implements HttpInetConnection {
    ...
    public void bind(Socket socket2, HttpParams httpParams) throws IOException {
        ...
        if (socket3 == null) {
            ...
            init(createHttpDataReceiver(socket3, buffersize, params), createHttpDataTransmitter(socket3, buffersize, params), params);
            this.open = true;
        }
    }
    ...
    public void close() throws java.io.IOException {
        ...
        L_0x0028:
            ...
            goto L_0x001b
        */
        throw new UnsupportedOperationException("Method not decompiled: org.shaded.apache.http.impl.SocketHttpServerConnection.close():void");
    }
}
