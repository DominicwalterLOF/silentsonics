    ...
    private String createDigest(Credentials credentials) throws AuthenticationException {
        ...
        if (uri == null) {
            ...
            if (this.qopVariant == 0) {
                ...
                new StringBuilder(hasha1.length() + nonce.length() + NC.length() + cnonce3.length() + qopOption.length() + hasha2.length() + 5);
                ...
                StringBuilder append20 = tmp23.append(NC);
