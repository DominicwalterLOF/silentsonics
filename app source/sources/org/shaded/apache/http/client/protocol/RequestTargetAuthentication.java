...
public class RequestTargetAuthentication implements HttpRequestInterceptor {
    ...
    public void process(HttpRequest httpRequest, HttpContext httpContext) throws HttpException, IOException {
        ...
        if (request == null) {
            ...
            throw th4;
        } else if (!request.getRequestLine().getMethod().equalsIgnoreCase("CONNECT") && !request.containsHeader("Authorization") && (authState = (AuthState) context.getAttribute(ClientContext.TARGET_AUTH_STATE)) != null && (authScheme = authState.getAuthScheme()) != null) {
