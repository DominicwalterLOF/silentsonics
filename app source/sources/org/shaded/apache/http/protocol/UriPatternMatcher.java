...
public class UriPatternMatcher {
    ...
    public boolean matchUriRequestPattern(String str, String str2) {
        ...
        return (pattern.endsWith(Marker.ANY_MARKER) && requestUri.startsWith(pattern.substring(0, pattern.length() + -1))) || (pattern.startsWith(Marker.ANY_MARKER) && requestUri.endsWith(pattern.substring(1, pattern.length())));
    }
}
