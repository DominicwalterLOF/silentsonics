...
public class GravitySensor extends AndroidNonvisibleComponent implements SensorEventListener, Deleteable, OnPauseListener, OnResumeListener, OnStopListener, SensorComponent {
    private int M2XSrcNVsTj86KbWYhtzmFwqCl4FRN4hJC3YQ2jC5nTG9V14APZgqJsIs4HMKSeu = 9;
    ...
    public boolean Available() {
        return this.sensorManager.getSensorList(this.M2XSrcNVsTj86KbWYhtzmFwqCl4FRN4hJC3YQ2jC5nTG9V14APZgqJsIs4HMKSeu).size() > 0;
    }
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (this.enabled && sensorEvent2.sensor.getType() == this.M2XSrcNVsTj86KbWYhtzmFwqCl4FRN4hJC3YQ2jC5nTG9V14APZgqJsIs4HMKSeu) {
