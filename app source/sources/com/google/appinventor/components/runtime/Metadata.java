...
public class Metadata extends AndroidNonvisibleComponent implements Component {
    private String IQizCoownq3QMuqjiN3SEtpvqAzYOMGAuQhX0ytYpmBBjgggyq4HRoSxolTbNj90;
    ...
    static /* synthetic */ String hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(Metadata metadata, String str) {
        String str2 = str;
        String str3 = str2;
        metadata.IQizCoownq3QMuqjiN3SEtpvqAzYOMGAuQhX0ytYpmBBjgggyq4HRoSxolTbNj90 = str3;
        return str2;
    }
    ...
    private java.lang.String hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(android.graphics.Bitmap r10) {
        /*
            ...
            r4 = 0
            r2 = r4
            java.io.ByteArrayOutputStream r4 = new java.io.ByteArrayOutputStream     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            r8 = r4
            r4 = r8
            r5 = r8
            r5.<init>()     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            r3 = r4
            r4 = r1
            android.graphics.Bitmap$CompressFormat r5 = android.graphics.Bitmap.CompressFormat.PNG     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            r6 = 0
            r7 = r3
            boolean r4 = r4.compress(r5, r6, r7)     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            java.io.File r4 = new java.io.File     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            r8 = r4
            r4 = r8
            r5 = r8
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            r8 = r6
            r6 = r8
            r7 = r8
            r7.<init>()     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            r7 = r0
            android.content.Context r7 = r7.context     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            java.io.File r7 = com.google.appinventor.components.runtime.util.QUtil.getExternalStorageDir(r7)     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            java.lang.StringBuilder r6 = r6.append(r7)     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            java.lang.String r7 = "/"
            java.lang.StringBuilder r6 = r6.append(r7)     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            r7 = r0
            java.lang.String r7 = r7.IQizCoownq3QMuqjiN3SEtpvqAzYOMGAuQhX0ytYpmBBjgggyq4HRoSxolTbNj90     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            java.lang.StringBuilder r6 = r6.append(r7)     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            java.lang.String r6 = r6.toString()     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            r5.<init>(r6)     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            r1 = r4
            java.io.FileOutputStream r4 = new java.io.FileOutputStream     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            r8 = r4
            r4 = r8
            r5 = r8
            r6 = r1
            ...
            r2 = r5
            r5 = r3
            byte[] r5 = r5.toByteArray()     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            r4.write(r5)     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            r4 = r2
            r4.flush()     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            r4 = r2
            r4.close()     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            r4 = r1
            java.lang.String r4 = r4.getAbsolutePath()     // Catch:{ PermissionException -> 0x0081, Exception -> 0x00af }
            r3 = r4
            r4 = r2
        ...
        L_0x0081:
            ...
            r3 = r4
            r4 = r0
            com.google.appinventor.components.runtime.Form r4 = r4.form     // Catch:{ all -> 0x00dc }
            r5 = r0
            java.lang.String r6 = "EmbeddedPicture"
            r7 = r3
            r4.dispatchPermissionDeniedEvent((com.google.appinventor.components.runtime.Component) r5, (java.lang.String) r6, (com.google.appinventor.components.runtime.errors.PermissionException) r7)     // Catch:{ all -> 0x00dc }
            java.lang.String r4 = "PERMISSION_DENIED_ERROR"
            r1 = r4
            r4 = r2
            if (r4 == 0) goto L_0x009d
            r4 = r2
            r4.flush()     // Catch:{ Exception -> 0x00a0 }
            r4 = r2
        ...
        L_0x00af:
            ...
            java.lang.String r4 = "KodularMetadata"
            r5 = r3
            java.lang.String r5 = java.lang.String.valueOf(r5)     // Catch:{ all -> 0x00dc }
            int r4 = android.util.Log.e(r4, r5)     // Catch:{ all -> 0x00dc }
            r4 = r2
        ...
        L_0x00dc:
            ...
            r4 = r2
            r4.flush()     // Catch:{ Exception -> 0x00eb }
            r4 = r2
    ...
    private String hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(int i, String str) {
        int i2 = i;
        String str2 = str;
        if (this.IQizCoownq3QMuqjiN3SEtpvqAzYOMGAuQhX0ytYpmBBjgggyq4HRoSxolTbNj90 != null) {
            try {
    ...
    public void NoMetadata(String str) {
        ...
        objArr[0] = sb2.append(str2.isEmpty() ? CommonProperties.TYPE : str2).append(" found in the metadata of the file").toString();
