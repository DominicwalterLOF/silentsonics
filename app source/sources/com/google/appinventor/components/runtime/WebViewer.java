...
public final class WebViewer extends AndroidViewComponent implements DownloadListener, ActivityResultListener, OnPauseListener, OnResumeListener {
    ...
    static /* synthetic */ boolean access$802(WebViewer webViewer, boolean z) {
        boolean z2 = z;
        boolean z3 = z2;
    ...
    public class MyWebViewClient extends WebViewClient {
        ...
        public void onPageFinished(WebView webView, String str) {
            ...
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.PageLoaded(str2);
        }

        public WebResourceResponse shouldInterceptRequest(WebView webView, String str) {
            WebView webView2 = webView;
            String str2 = str;
            if (str2.startsWith("http://localhost/") || str2.startsWith(Form.ASSETS_PREFIX)) {
                return this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.handleAppRequest(str2);
            }
        ...
        public WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
            ...
            int d = Log.d(WebViewer.LOG_TAG, sb.append(webResourceRequest2.getUrl().getScheme()).toString());
            if (webResourceRequest2.getUrl().getAuthority().equals("localhost") || webResourceRequest2.getUrl().toString().startsWith(Form.ASSETS_PREFIX)) {
                return this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.handleAppRequest(webResourceRequest2.getUrl().toString());
            }
        ...
        public boolean shouldOverrideUrlLoading(WebView webView, WebResourceRequest webResourceRequest) {
            WebView webView2 = webView;
            return this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.shouldOverrideUrlLoading(webResourceRequest.getUrl().toString());
        }
        ...
        public void onReceivedSslError(WebView webView, SslErrorHandler sslErrorHandler, SslError sslError) {
            ...
            if (this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.ignoreSslErrors) {
                sslErrorHandler2.proceed();
                return;
            }
            sslErrorHandler2.cancel();
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.form.dispatchErrorOccurredEvent(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, "WebView", ErrorMessages.ERROR_WEBVIEW_SSL_ERROR, new Object[0]);
        }
        ...
        public void onReceivedError(WebView webView, int i, String str, String str2) {
            ...
            new Runnable(this) {
                private /* synthetic */ MyWebViewClient hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
                ...
                public final void run() {
                    WebViewer webViewer = this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
                    ...
                    Object[] objArr3 = objArr2;
                    objArr3[2] = str4;
                    boolean dispatchEvent = EventDispatcher.dispatchEvent(webViewer, "ErrorOccurred", objArr3);
                }
            };
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.form.runOnUiThread(runnable);
        }
    }
    ...
    public final WebResourceResponse handleAppRequest(String str) {
        ...
        String str2 = str;
        if (str2.startsWith(Form.ASSETS_PREFIX)) {
            substring = str2.substring(22);
        } else {
            String str3 = str2;
            substring = str3.substring(str3.indexOf("//localhost/") + 12);
        }
        try {
            int i = Log.i(LOG_TAG, "webviewer requested path = ".concat(String.valueOf(substring)));
            InputStream openAsset = this.form.openAsset(substring);
            new HashMap();
            Map map2 = map;
            Map map3 = map2;
            Object put = map2.put("Access-Control-Allow-Origin", "localhost");
            String contentTypeFor = URLConnection.getFileNameMap().getContentTypeFor(substring);
            String str4 = "utf-8";
            int i2 = Log.i(LOG_TAG, "Mime type = ".concat(String.valueOf(contentTypeFor)));
            if (!contentTypeFor.startsWith("text/")) {
                str4 = null;
            }
            WebResourceResponse webResourceResponse3 = webResourceResponse2;
            new WebResourceResponse(contentTypeFor, str4, 200, "OK", map3, openAsset);
            return webResourceResponse3;
        } catch (IOException e) {
            new ByteArrayInputStream(NanoHTTPD.HTTP_NOTFOUND.getBytes());
            new WebResourceResponse("text/plain", "utf-8", 404, "Not Found", (Map) null, inputStream);
    ...
    private void loadUrl(String str, String str2) {
        ...
        if (str4.startsWith("file:///mnt/sdcard/AppInventor/")) {
            str4 = str4.replaceFirst("AppInventor", "Kodular");
        }
        if (this.havePermission || !MediaUtil.isExternalFileUrl(this.form, str4)) {
                ...
                public final void run() {
                    ...
                    new PermissionResultHandler(this) {
                        ...
                        public final void HandlePermissionResponse(String str, boolean z) {
                            String str2 = str;
                            if (z) {
                                boolean access$802 = WebViewer.access$802(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, true);
                            ...
                            boolean access$8022 = WebViewer.access$802(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, false);
    ...
    public final void PageLoaded(String str) {
        boolean dispatchEvent = EventDispatcher.dispatchEvent(this, "PageLoaded", str);
    }
    ...
    public static void setupWebViewGeoLoc(WebViewer webViewer, WebView webView, Activity activity2) {
        ...
        new WebChromeClient(webViewer) {
            ...
            private /* synthetic */ WebViewer f264B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T;

            {
                this.f264B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T = r6;
            }
            ...
            public final void onGeolocationPermissionsShowPrompt(String str, GeolocationPermissions.Callback callback) {
                ...
                String str3 = str2;
                if (this.f264B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.PromptforPermission()) {
                    ...
                    new DialogInterface.OnClickListener(this) {
                        ...
                        private /* synthetic */ AnonymousClass6 f265hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

                        {
                            this.f265hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r7;
                        }
                    ...
                    new DialogInterface.OnClickListener(this) {
                        ...
                        /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
                        private /* synthetic */ AnonymousClass6 f266hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

                        {
                            this.f266hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r7;
                        }
    ...
    public class WebViewInterface {
        ...
        /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
        final /* synthetic */ WebViewer f267hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

        WebViewInterface(WebViewer webViewer, Context context) {
            this.f267hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = webViewer;
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = context;
        }

        @JavascriptInterface
        public String getWebViewString() {
            return this.PSE7l4KPPlsF25SGtLyfrRQNAOx6mjYRNm7iKMXDtxC5YDpv0OiYAkqPZjvcwjm5;
        }
        ...
        public void setWebViewString(String str) {
            Runnable runnable;
            String str2 = str;
            this.PSE7l4KPPlsF25SGtLyfrRQNAOx6mjYRNm7iKMXDtxC5YDpv0OiYAkqPZjvcwjm5 = str2;
            ...
            new Runnable(this) {
                ...
                public final void run() {
                    this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.f267hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.WebViewStringChange(str3);
                }
            };
            this.f267hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.form.runOnUiThread(runnable);
        }
