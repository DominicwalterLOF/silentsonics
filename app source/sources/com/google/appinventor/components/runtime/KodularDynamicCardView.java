...
public final class KodularDynamicCardView extends AndroidNonvisibleComponent {
    ...
    private int SHSZV5sTay8ykRHafXU624sH0bmI6VeYHAe3FtLV8LV4djzabBBIyQGaIvRsAwmk;
    private int XkTExsgDjzL7UIaxQorrmSTr7jZbDxCmXSVfTpg7zAbwFxeOpcI2x1hAyx12QFiS;
    private int ZYL9KAfl6ZZzM9RsykyXLexYTPR8S0eQ9Guil6cW84HmbyBTkvTBFTgEwGE4p6T;
    private int backgroundColor;
    private Context context;
    private int eQeQhiSmlElGLbwx31fXfv53XsxBlAuCtzOUdhRtXefyKZkKyhRMzOCKSg7WR08;
    private Form form;
    private boolean fullClick;
    private List<KodularDynamicModel> kodularDynamicModelList;
    private int l557Ll1q9gLt3cEfyQaLTgWgvIutpQIPuKKLXX2glk42j33zjQ1xoBSDeCkOGk6j;
    ...
    public final void CreateCardView(int i, AndroidViewComponent androidViewComponent, int i2, int i3) {
        ...
        try {
            ...
            kodularCardView7.setStrokeColor(this.SHSZV5sTay8ykRHafXU624sH0bmI6VeYHAe3FtLV8LV4djzabBBIyQGaIvRsAwmk);
            ...
            KodularRippleDrawable.setRippleDrawable(kodularCardView7, this.backgroundColor, this.l557Ll1q9gLt3cEfyQaLTgWgvIutpQIPuKKLXX2glk42j33zjQ1xoBSDeCkOGk6j);
