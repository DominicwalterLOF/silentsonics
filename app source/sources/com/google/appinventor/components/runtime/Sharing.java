...
@UsesQueries(intents = {@IntentFilterElement(actionElements = {@ActionElement(name = "android.intent.action.SEND")})}, packageNames = {"com.facebook.orca", "com.facebook.katana", "com.twitter.android", "org.telegram.messenger", "com.whatsapp", "com.snapchat.android", "com.google.android.apps.plus"})
@SimpleObject
...
public class Sharing extends AndroidNonvisibleComponent {
    ...
    public void ShareMessage(String str) {
        ...
        this.form.startActivity(Intent.createChooser(intent3, this.peQa36WzmOGDKVPxAtWvq1pN83yXrV2fw2e1QvLyEngIwdojN2EAkDoWXzH8bj7w));
    }
        ...
        if (str3 != null && !str3.isEmpty()) {
            try {
                ...
                if (file2.isFile()) {
                    ...
                    Form form = this.form;
                    new StringBuilder();
                    Uri uriForFile = FileProvider.getUriForFile(form, sb.append(this.form.getPackageName()).append(".provider").toString(), file3);
                    new Intent("android.intent.action.SEND");
                    Intent intent2 = intent;
                    Intent intent3 = intent2;
    ...
    public void ShareDialogMessage(String str) {
        ...
        this.peQa36WzmOGDKVPxAtWvq1pN83yXrV2fw2e1QvLyEngIwdojN2EAkDoWXzH8bj7w = str2;
    }
    ...
    public void ShareMessageToFacebook(String str) {
        ...
        ShareUtil("com.facebook.katana", str2, KodularAnalyticsUtil.Ads.NETWORK_FACEBOOK, "ShareMessageToFacebook- ");
    }
