...
public class Polygon extends PolygonBase implements MapFactory.MapPolygon {
    ...
    private boolean pixa37in9tdgjNQb2jpfjxTaBGtatW1GnEvNM302mGQljyvLBwDosTGoRPcRGYok = false;
    ...
    public Polygon(com.google.appinventor.components.runtime.util.MapFactory.MapFeatureContainer r7) {
        /*
            ...
            r2 = r0
            r3 = 0
            r2.pixa37in9tdgjNQb2jpfjxTaBGtatW1GnEvNM302mGQljyvLBwDosTGoRPcRGYok = r3
            r2 = r0
            r3 = 0
            r2.initialized = r3
            r2 = r1
    ...
    public void PointsFromString(String str) {
        ...
        try {
            ...
            this.pixa37in9tdgjNQb2jpfjxTaBGtatW1GnEvNM302mGQljyvLBwDosTGoRPcRGYok = this.KbzcIEn6WDqjdY1QBot1TMrBwhEYy4xAUKG2cbzQ22VNohlOtuBGKUJsEeMNZyEH.size() > 1;
            if (this.initialized) {
                clearGeometry();
                this.map.getController().updateFeaturePosition((MapFactory.MapPolygon) this);
            }
    ...
    public void HolePoints(YailList yailList) {
        ...
        try {
            ...
            } else if (this.pixa37in9tdgjNQb2jpfjxTaBGtatW1GnEvNM302mGQljyvLBwDosTGoRPcRGYok) {
