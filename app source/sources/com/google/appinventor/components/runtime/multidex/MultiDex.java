...
public final class MultiDex {
    private static final boolean FWhlgAfItZPAj52Sbrmx0NIMbFKmURdRAyv8T1hdxDpczs3OJmULpy7aDRNSO45K = wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou(System.getProperty("java.vm.version"));
    private static final Set<String> hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO;
    private static final String x18EVrDLKYshSIJOaOzhjZZ2d7f1HPcCxsJsFR3IcZlc2NwZ4Zt12KeOiP0vPHe3;
    ...
    static {
        ...
        x18EVrDLKYshSIJOaOzhjZZ2d7f1HPcCxsJsFR3IcZlc2NwZ4Zt12KeOiP0vPHe3 = sb.append(File.separator).append("secondary-dexes").toString();
        new HashSet();
    ...
    public static boolean install(Context context, boolean z) {
        ...
        if (FWhlgAfItZPAj52Sbrmx0NIMbFKmURdRAyv8T1hdxDpczs3OJmULpy7aDRNSO45K) {
            ...
            try {
                ...
                synchronized (set) {
                    try {
                        ...
                        new File(applicationInfo.dataDir, x18EVrDLKYshSIJOaOzhjZZ2d7f1HPcCxsJsFR3IcZlc2NwZ4Zt12KeOiP0vPHe3);
                        File file2 = file;
                        if (z2 || !a.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(context2, applicationInfo)) {
                            int d2 = Log.d("MultiDex", "Proceeding with installation...");
                            List<File> hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME2 = a.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(context2, applicationInfo, file2, false);
                            ...
                            if (hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME2)) {
                                ...
                                List<File> hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME3 = a.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(context2, applicationInfo, file2, true);
    ...
    private static void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(ClassLoader classLoader, File file, List<File> list) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException, IOException {
        ...
        if (!list2.isEmpty()) {
            File file3 = file2;
            File file4 = file3;
            a.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(classLoader2, list2, file3);
        }
    }
