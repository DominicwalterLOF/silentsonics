...
public class ScaledFrameLayout extends ViewGroup {
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.R6I3TvhVUzjImNcsZnPIarNQNa08KFL5suF8ZyHVabZqiWX3lxOTmOWImMG2ChIe = 0;
        this.HThm2UFiN8mNIb2OEGwVoJpkwNLFwrt8FHi6kSBOC6T1EOtocK0hkK9xDo2LJOJZ = 0;
        int i5 = 0;
        int i6 = 0;
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                this.R6I3TvhVUzjImNcsZnPIarNQNa08KFL5suF8ZyHVabZqiWX3lxOTmOWImMG2ChIe += Math.max(0, view.getMeasuredWidth());
                i5 = Math.max(i5, view.getMeasuredHeight());
                i6 = combineMeasuredStates(i6, view.getMeasuredState());
            }
        }
        setMeasuredDimension(resolveSizeAndState(Math.max(0 + this.R6I3TvhVUzjImNcsZnPIarNQNa08KFL5suF8ZyHVabZqiWX3lxOTmOWImMG2ChIe, getSuggestedMinimumWidth()), i3, i6), resolveSizeAndState(Math.max(i5, getSuggestedMinimumHeight()), i4, i6 << 16));
    }
