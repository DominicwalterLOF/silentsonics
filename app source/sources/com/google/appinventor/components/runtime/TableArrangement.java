...
public class TableArrangement extends AndroidViewComponent implements Component, ComponentContainer {
    ...
    private final TableLayout f247hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public TableArrangement(com.google.appinventor.components.runtime.ComponentContainer r10) {
        /*
            ...
            r7 = 2
            r4.<init>(r5, r6, r7)
            r2.f247hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r1
            r3 = r0
            r2.$add(r3)
            return
    ...
    public int Columns() {
        return this.f247hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getNumColumns();
    }

    @DesignerProperty(defaultValue = "2", editorType = "non_negative_integer")
    @SimpleProperty(userVisible = false)
    public void Columns(int i) {
        this.f247hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setNumColumns(i);
    }

    @SimpleProperty(userVisible = false)
    public int Rows() {
        return this.f247hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getNumRows();
    }

    @DesignerProperty(defaultValue = "2", editorType = "non_negative_integer")
    @SimpleProperty(userVisible = false)
    public void Rows(int i) {
        this.f247hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setNumRows(i);
    }
    ...
    public void $add(AndroidViewComponent androidViewComponent) {
        this.f247hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.add(androidViewComponent);
    }
    ...
    public View getView() {
        return this.f247hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getLayoutManager();
    }
}
