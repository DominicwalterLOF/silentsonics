...
@UsesLibraries({"play-services-ads.jar", "play-services-ads.aar", "browser.jar", "browser.aar", "play-services-ads-base.jar", "play-services-ads-base.aar", "play-services-ads-identifier.jar", "play-services-ads-identifier.aar", "play-services-ads-lite.jar", "play-services-ads-lite.aar", "play-services-basement.jar", "play-services-basement.aar", "play-services-gass.jar", "play-services-gass.aar"})
@SimpleObject
...
public class AdmobRewardedVideo extends AndroidNonvisibleComponent implements RewardedVideoAdListener, Component, OnDestroyListener, OnPauseListener, OnResumeListener {
    ...
    private MakeroidDataProtection f47hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public AdmobRewardedVideo(com.google.appinventor.components.runtime.ComponentContainer r9) {
        /*
            ...
            r4.<init>(r5, r6)
            r2.f47hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            com.google.appinventor.components.runtime.util.MakeroidDataProtection r2 = r2.f47hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
            r3 = r0
    ...
    public void AdUnitId(String str) {
        String str2 = str;
        if (this.adUnitId == null || this.adUnitId.equals(KodularAdsUtil.ADMOB_REWARDED_VIDEO_TEST_ID)) {
            this.adUnitId = str2;
        }
    }
    ...
    public void onRewardedVideoAdLoaded() {
        KodularAnalyticsUtil.adEvent(KodularAnalyticsUtil.Ads.NETWORK_ADMOB, KodularAnalyticsUtil.Ads.FORMAT_VIDEO, this.form);
        AdLoaded();
    ...
    public void ConsentTitle(String str) {
        this.f47hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setTitle(str);
    }

    @SimpleProperty
    public String ConsentTitle() {
        return this.f47hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getTitle();
    }
    ...
    public void ConsentMessage(String str) {
        this.f47hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setMessage(str);
    }

    @SimpleProperty
    public String ConsentMessage() {
        return this.f47hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getMessage();
    }

    @SimpleFunction(description = "Deletes the user's consent. Useful if you want to test the consent dialog in development.")
    public void RevokeConsent() {
        this.f47hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.RevokeConsent();
    }
    ...
    public boolean PersonalizedResult() {
        return this.f47hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getPersonalizedResult();
    }
    ...
    public void ConsentDevelopmentMode(boolean z) {
        this.f47hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setDevelopmentMode(z);
    }

    @SimpleProperty
    public boolean ConsentDevelopmentMode() {
        return this.f47hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getDevelopmentMode();
    }
}
