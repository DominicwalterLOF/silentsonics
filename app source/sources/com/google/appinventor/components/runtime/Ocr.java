...
public class Ocr extends AndroidNonvisibleComponent implements Component {
    ...
    private boolean l1RC65VA1OrEFGFIoMpcm9UdXKH0b4XYT6Sp5a4IfmUrLMcXzEdiTdgfLz7JJ5B0 = false;
    ...
    static /* synthetic */ boolean hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(Ocr ocr, boolean z) {
        boolean z2 = z;
        boolean z3 = z2;
        ocr.l1RC65VA1OrEFGFIoMpcm9UdXKH0b4XYT6Sp5a4IfmUrLMcXzEdiTdgfLz7JJ5B0 = z3;
        return z2;
    }
    ...
    public void GetTextFromImageUrl(String str) {
        ...
        if (str2 == null || str2.isEmpty()) {
            str2 = this.PMWpqVMsyfTUgqkfqh3FKX4Q3IYlcybzKrBGEl7qtzs6HNVssJ63V430Ige89pyP;
        }
    ...
    public void UploadImage(String str) {
        ...
        if (str4.startsWith("file:///")) {
            ...
            if (!str4.startsWith("/")) {
                new StringBuilder();
                str5 = sb.append(externalStorageDir).append(File.separator).append(str4).toString();
            } else if (!str4.startsWith(externalStorageDir.toString())) {
                new StringBuilder();
                str5 = sb2.append(externalStorageDir).append(str4).toString();
            }
        } else if (this.repl) {
            new StringBuilder();
            str5 = sb4.append(QUtil.getReplAssetPath(this.context)).append(str4).toString();
        } else {
            new StringBuilder();
    ...
    class c extends AsyncTask<String, Void, String> {
        ...
        public java.lang.String doInBackground(java.lang.String... r12) {
            ...
            L_0x0057:
                ...
                r6 = r0
                com.google.appinventor.components.runtime.Ocr r6 = r6.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME     // Catch:{ PermissionException -> 0x0179, Exception -> 0x01a6 }
                java.lang.String r6 = r6.tFNQ38WX0EWx1sBmwkfGOavwj0ohdRyv5RfL5KQ0qa5Pnr6qc7YsZTQu1aP3NtmA     // Catch:{ PermissionException -> 0x0179, Exception -> 0x01a6 }
                org.json.JSONObject r4 = r4.put(r5, r6)     // Catch:{ PermissionException -> 0x0179, Exception -> 0x01a6 }
                r4 = r1
                r5 = 1
            ...
            L_0x01a6:
                ...
                goto L_0x0176
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.appinventor.components.runtime.Ocr.c.doInBackground(java.lang.String[]):java.lang.String");
        }
    }
    ...
    public void ReturnOnlyMessage(boolean z) {
        boolean z2 = z;
        this.D5WW7ko68TBhY3rWGJixZsWe3BbuoJE4ehTpLkVzvzCwqdv8qeJ2dPQYU5v0Rxk = z2;
    }
