...
public final class Surface extends AndroidViewComponent implements Camera.FaceDetectionListener, Camera.PreviewCallback, SurfaceHolder.Callback, ComponentContainer, OnDestroyListener {
    ...
    public Surface(com.google.appinventor.components.runtime.ComponentContainer r11) {
        /*
            ...
            r2.setHorizontalAlignment((int) r3)
            r2 = r0
            com.google.appinventor.components.runtime.util.AlignmentUtil r2 = r2.alignmentSetter
            r3 = r0
            int r3 = r3.verticalAlignment
            r2.setVerticalAlignment((int) r3)
            r2 = r0
    ...
    public final void setChildWidth(AndroidViewComponent androidViewComponent, int i, int i2) {
        ...
        if (Width == 0 && i4 < 2) {
            ...
            new Runnable(this) {
                ...
                private /* synthetic */ Surface f245hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

                {
                    this.f245hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r8;
                }

                public final void run() {
                    this.f245hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setChildWidth(androidViewComponent3, i6, i7 + 1);
                }
            };
    ...
    public final void setChildHeight(AndroidViewComponent androidViewComponent, int i) {
        ...
        if (Height == 0) {
            ...
            new Runnable(this) {
                ...
                /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
                private /* synthetic */ Surface f246hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

                {
                    this.f246hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r7;
                }

                public final void run() {
                    this.f246hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setChildHeight(androidViewComponent3, i4);
                }
            };
            boolean postDelayed = this.androidUIHandler.postDelayed(runnable, 100);
        }
    ...
    public final void onPreviewFrame(byte[] bArr, Camera camera) {
        ...
        if (this.saveAsFile) {
            try {
                ...
                new StringBuilder();
                new File(sb.append(QUtil.getExternalStoragePath(this.context)).append("/preMak.jpg").toString());
                File file2 = file;
        ...
        if (this.myCamera != null) {
            new Camera.PictureCallback(this) {
                ...
                public final void onPictureTaken(byte[] bArr, Camera camera) {
                    ...
                    try {
                        new StringBuilder();
                        new File(sb.append(QUtil.getExternalStoragePath(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.context)).append("/takenPicture.jpg").toString());
                        File file2 = file;
                        new FileOutputStream(file2);
