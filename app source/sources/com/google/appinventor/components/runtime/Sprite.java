...
public abstract class Sprite extends VisibleComponent implements AlarmHandler, Deleteable, OnDestroyListener {
    ...
    public void Z(double d) {
        ...
        canvas3.f62hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.invalidate();
    }
    ...
    public void EdgeReached(@Options(Direction.class) int i) {
        ...
        Direction direction = fromUnderlyingValue;
        if (fromUnderlyingValue != null) {
            EdgeReachedAbstract(direction);
        }
    }
    ...
    public void BounceAbstract(Direction direction) {
        ...
        if ((direction2 == Direction.East && (d2 < 90.0d || d2 > 270.0d)) || (direction2 == Direction.West && d2 > 90.0d && d2 < 270.0d)) {
            Heading(180.0d - d2);
        } else if ((direction2 == Direction.North && d2 > 0.0d && d2 < 180.0d) || (direction2 == Direction.South && d2 > 180.0d)) {
            Heading(360.0d - d2);
        } else if ((direction2 == Direction.Northeast && d2 > 0.0d && d2 < 90.0d) || ((direction2 == Direction.Northwest && d2 > 90.0d && d2 < 180.0d) || ((direction2 == Direction.Southwest && d2 > 180.0d && d2 < 270.0d) || (direction2 == Direction.Southeast && d2 > 270.0d)))) {
            Heading(d2 + 180.0d);
        }
    }
    ...
    public void registerChange() {
        ...
        Direction direction = hitEdgeAbstract;
    ...
    public int hitEdge() {
        ...
        return direction.toUnderlyingValue().intValue();
    }
    ...
    public final void moveIntoBounds(int i, int i2) {
        ...
        } else if (vSp02fkBXgM8EI0gm0rKWXHQ6wdQINJBQuAtCR15YU8g4XNqVKV8r32SYxkQYxkq()) {
            this.xLeft = 0.0d;
            this.xCenter = hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(this.xLeft);
            z = true;
