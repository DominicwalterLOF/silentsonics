...
public abstract class MapFeatureContainerBase extends AndroidViewComponent implements MapFactory.MapFeatureContainer {
    ...
    public void processGeoJSON(String str, String str2) throws JSONException {
        ...
        String str3 = str;
        String str4 = str2;
        String geoJSONType = GeoJSONUtil.getGeoJSONType(str4, "type");
        if (GEOJSON_FEATURECOLLECTION.equals(geoJSONType) || GEOJSON_GEOMETRYCOLLECTION.equals(geoJSONType)) {
            final String str5 = str3;
            final List<YailList> geoJSONFeatures = GeoJSONUtil.getGeoJSONFeatures(TAG, str4);
            new Runnable(this) {
                private /* synthetic */ MapFeatureContainerBase hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
                ...
                public final void run() {
                    this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.GotFeatures(str5, YailList.makeList(geoJSONFeatures));
                }
            };
            $form().runOnUiThread(runnable);
            return;
        ...
        new Runnable(this) {
            ...
            public final void run() {
                this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.LoadError(str6, -3, MapFeatureContainerBase.ERROR_MALFORMED_GEOJSON);
            }
        };
        $form().runOnUiThread(runnable2);
    }
