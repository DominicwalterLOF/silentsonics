...
public class PhoneStatus extends AndroidNonvisibleComponent implements Component {
    private static boolean I1fbWPe6RJ2coGGe88dnbV3SwCWOYXWySlRHSiEJVMw7CeEp0YdmKizbxY7zqrk2 = true;
    private static Activity activity;
    private static PhoneStatus hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = null;
    private String Sj3UMCQcT7f46E8U4TVavenawPElr174psURarVHJJBTqMXe22hIekct3fzxe7Vm = null;
    ...
    public String setHmacSeedReturnCode(String str, String str2) {
        ...
        if (this.yHAbLPerXNK4pCwn5nqbt3OeUjDvQdxh29RmVa0moB4dUtgatbeaGoP5jClPUWFb != null) {
            if (!this.yHAbLPerXNK4pCwn5nqbt3OeUjDvQdxh29RmVa0moB4dUtgatbeaGoP5jClPUWFb.equals(str3)) {
                new Runnable(this) {
                    ...
                    public final void run() {
                        this.B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.form.finish();
                        System.exit(0);
                    }
                };
                Notifier.oneButtonAlert((Activity) this.form, "You cannot use two codes with one start up of the Companion. You should restart the Companion and try again.", "Warning", "OK", runnable);
            }
            return this.Sj3UMCQcT7f46E8U4TVavenawPElr174psURarVHJJBTqMXe22hIekct3fzxe7Vm;
        }
        this.yHAbLPerXNK4pCwn5nqbt3OeUjDvQdxh29RmVa0moB4dUtgatbeaGoP5jClPUWFb = str3;
        if (!I1fbWPe6RJ2coGGe88dnbV3SwCWOYXWySlRHSiEJVMw7CeEp0YdmKizbxY7zqrk2) {
        ...
        try {
            ...
            this.Sj3UMCQcT7f46E8U4TVavenawPElr174psURarVHJJBTqMXe22hIekct3fzxe7Vm = stringBuffer2.toString();
            return this.Sj3UMCQcT7f46E8U4TVavenawPElr174psURarVHJJBTqMXe22hIekct3fzxe7Vm;
        } catch (Exception e) {
    ...
    public void startWebRTC(String str, String str2) {
        ...
        String str4 = str2;
        if (I1fbWPe6RJ2coGGe88dnbV3SwCWOYXWySlRHSiEJVMw7CeEp0YdmKizbxY7zqrk2) {
            new WebRTCNativeMgr(str3, str4);
            WebRTCNativeMgr webRTCNativeMgr2 = webRTCNativeMgr;
            webRTCNativeMgr2.initiate((ReplForm) this.form, activity, this.yHAbLPerXNK4pCwn5nqbt3OeUjDvQdxh29RmVa0moB4dUtgatbeaGoP5jClPUWFb);
    ...
    public void startHTTPD(boolean z) {
        boolean z2 = z;
        if (this.form.isRepl()) {
            ((ReplForm) this.form).startHTTPD(z2);
        }
    }
    ...
    public void WebRTC(boolean z) {
        I1fbWPe6RJ2coGGe88dnbV3SwCWOYXWySlRHSiEJVMw7CeEp0YdmKizbxY7zqrk2 = z;
    }
    ...
    public boolean WebRTC() {
        return I1fbWPe6RJ2coGGe88dnbV3SwCWOYXWySlRHSiEJVMw7CeEp0YdmKizbxY7zqrk2;
    }
