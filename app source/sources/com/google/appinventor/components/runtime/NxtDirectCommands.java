...
public class NxtDirectCommands extends LegoMindstormsNxtBase {
    ...
    public void SetOutputState(@Options(NxtMotorPort.class) String str, int i, @Options(NxtMotorMode.class) int i2, @Options(NxtRegulationMode.class) int i3, int i4, @Options(NxtRunState.class) int i5, long j) {
        ...
        if (checkBluetooth(str3)) {
            NxtMotorPort fromUnderlyingValue = NxtMotorPort.fromUnderlyingValue(str2);
            ...
            NxtMotorMode fromUnderlyingValue2 = NxtMotorMode.fromUnderlyingValue(Integer.valueOf(i7));
            NxtMotorMode nxtMotorMode = fromUnderlyingValue2;
            if (fromUnderlyingValue2 == null) {
                this.form.dispatchErrorOccurredEvent(this, str3, 420, Integer.valueOf(i7));
                return;
            }
            NxtRegulationMode fromUnderlyingValue3 = NxtRegulationMode.fromUnderlyingValue(Integer.valueOf(i8));
            NxtRegulationMode nxtRegulationMode = fromUnderlyingValue3;
            if (fromUnderlyingValue3 == null) {
                this.form.dispatchErrorOccurredEvent(this, str3, ErrorMessages.ERROR_NXT_INVALID_REGULATION_MODE, nxtRegulationMode);
                return;
            }
            setOutputState(str3, nxtMotorPort, i6, nxtMotorMode, nxtRegulationMode, i9, NxtRunState.fromUnderlyingValue(Integer.valueOf(i10)), j2);
        }
    }
    ...
    public void SetInputMode(@Options(NxtSensorPort.class) String str, @Options(NxtSensorType.class) int i, @Options(NxtSensorMode.class) int i2) {
        ...
        if (checkBluetooth(str3)) {
            ...
            NxtSensorType fromUnderlyingValue2 = NxtSensorType.fromUnderlyingValue(Integer.valueOf(i3));
            NxtSensorType nxtSensorType = fromUnderlyingValue2;
            if (fromUnderlyingValue2 == null) {
                this.form.dispatchErrorOccurredEvent(this, str3, 422, nxtSensorType);
                return;
            }
            NxtSensorMode fromUnderlyingValue3 = NxtSensorMode.fromUnderlyingValue(Integer.valueOf(i4));
            NxtSensorMode nxtSensorMode = fromUnderlyingValue3;
            if (fromUnderlyingValue3 == null) {
                this.form.dispatchErrorOccurredEvent(this, str3, 423, nxtSensorMode);
                return;
            }
            setInputMode(str3, nxtSensorPort, nxtSensorType, nxtSensorMode);
        }
    }

    /* JADX WARNING: Removed duplicated region for block: B:13:0x0084  */
    /* JADX WARNING: Removed duplicated region for block: B:16:0x0157  */
    ...
    public java.util.List<java.lang.Number> GetOutputState(@com.google.appinventor.components.annotations.Options(com.google.appinventor.components.common.NxtMotorPort.class) java.lang.String r15) {
        /*
            r14 = this;
            r0 = r14
            r1 = r15
        ...
        L_0x0018:
            r5 = r1
            com.google.appinventor.components.common.NxtMotorPort r5 = com.google.appinventor.components.common.NxtMotorPort.fromUnderlyingValue(r5)
            r13 = r5
            r5 = r13
            r6 = r13
            r3 = r6
    ...
    public List<Object> GetInputValues(@Options(NxtSensorPort.class) String str) {
        ...
        byte[] inputValues = getInputValues(str3, nxtSensorPort);
    ...
    public void ResetInputScaledValue(@Options(NxtSensorPort.class) String str) {
        ...
        if (checkBluetooth(str3)) {
            ...
            resetInputScaledValue(str3, nxtSensorPort);
            byte[] bArr = new byte[3];
            byte[] bArr2 = bArr;
            bArr[0] = Byte.MIN_VALUE;
            bArr2[1] = 8;
            copyUBYTEValueToBytes(nxtSensorPort.toInt().intValue(), bArr2, 2);
            sendCommand(str3, bArr2);
        }
    }
    ...
    public void ResetMotorPosition(@Options(NxtMotorPort.class) String str, boolean z) {
        ...
        if (checkBluetooth(str3)) {
            ...
            bArr[0] = Byte.MIN_VALUE;
            bArr2[1] = 10;
            copyUBYTEValueToBytes(nxtMotorPort.toInt().intValue(), bArr2, 2);
    ...
    public int LsGetStatus(@Options(NxtSensorPort.class) String str) {
        ...
        NxtSensorPort nxtSensorPort = fromUnderlyingValue;
        if (fromUnderlyingValue != null) {
            return lsGetStatus(str3, nxtSensorPort);
        }
        this.form.dispatchErrorOccurredEvent(this, str3, 408, str2);
        return 0;
    }
    ...
    public void LsWrite(@Options(NxtSensorPort.class) String str, YailList yailList, int i) {
        ...
        if (checkBluetooth(str3)) {
            ...
            if (fromUnderlyingValue == null) {
                ...
                lsWrite(str3, nxtSensorPort, bArr, i2);
            }
        }
    }
    ...
    public List<Integer> LsRead(@Options(NxtSensorPort.class) String str) {
        ...
        byte[] lsRead = lsRead(str3, nxtSensorPort);
        byte[] bArr = lsRead;
        if (lsRead != null) {
            new ArrayList();
    ...
    public String MessageRead(@Options(NxtMailbox.class) int i) {
        ...
        NxtMailbox fromUnderlyingValue = NxtMailbox.fromUnderlyingValue(Integer.valueOf(i2));
        NxtMailbox nxtMailbox = fromUnderlyingValue;
        if (fromUnderlyingValue != null) {
            return MessageReadAbstract(nxtMailbox);
        }
    ...
    public String MessageReadAbstract(NxtMailbox nxtMailbox) {
        ...
        copyUBYTEValueToBytes(intValue, bArr2, 3);
        copyBooleanValueToBytes(true, bArr2, 4);
        byte[] sendCommandAndReceiveReturnPackage = sendCommandAndReceiveReturnPackage("MessageRead", bArr2);
        if (evaluateStatus("MessageRead", sendCommandAndReceiveReturnPackage, bArr2[1])) {
            if (sendCommandAndReceiveReturnPackage.length == 64) {
                ...
                int i = uBYTEValueFromBytes;
                if (uBYTEValueFromBytes != intValue) {
                    String str = this.logTag;
                    new StringBuilder("MessageRead: unexpected return mailbox: Box");
                    int w = Log.w(str, sb2.append(i).append(" (expected ").append(intValue).append(")").toString());
                }
            ...
            int w2 = Log.w(str2, sb.append(sendCommandAndReceiveReturnPackage.length).append(" (expected 64)").toString());
        }
        return "";
    }
    ...
    public void MessageWrite(@Options(NxtMailbox.class) int i, String str) {
        ...
        MessageWriteAbstract(nxtMailbox, str2);
    }

    public void MessageWriteAbstract(NxtMailbox nxtMailbox, String str) {
        NxtMailbox nxtMailbox2 = nxtMailbox;
        String str2 = str;
        if (checkBluetooth("MessageWrite")) {
            ...
            bArr[0] = Byte.MIN_VALUE;
            bArr2[1] = 9;
            copyUBYTEValueToBytes(nxtMailbox2.toInt().intValue(), bArr2, 2);
            copyUBYTEValueToBytes(i + 1, bArr2, 3);
            copyStringValueToBytes(str2, bArr2, 4, i);
            sendCommand("MessageWrite", bArr2);
        }
    }
            ...
            if (str3.length() == 0) {
                ...
                try {
                    ...
                    try {
                        ...
                        new BufferedInputStream(FileUtil.openFile(this.form, copyMediaToTempFile), 1024);
