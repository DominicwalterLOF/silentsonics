...
@UsesLibraries({"play-services-ads.jar", "play-services-ads.aar", "browser.jar", "browser.aar", "play-services-ads-base.jar", "play-services-ads-base.aar", "play-services-ads-identifier.jar", "play-services-ads-identifier.aar", "play-services-ads-lite.jar", "play-services-ads-lite.aar", "play-services-basement.jar", "play-services-basement.aar", "play-services-gass.jar", "play-services-gass.aar", "unity-ads.aar", "unity-ads.jar"})
@SimpleObject
...
public class AdMobInterstitial extends AndroidNonvisibleComponent implements Component {
    ...
    private MakeroidDataProtection f43hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private KodularInterstitial f44hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    static /* synthetic */ String hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(AdMobInterstitial adMobInterstitial, String str) {
        String str2 = str;
        String str3 = str2;
        adMobInterstitial.vOibdtOfNxMVixWab9VDGgvD9L4Kqb2ZDQBius3PMdhiP1dPN68Z9GzWJA49TUbE = str3;
        return str2;
    }
    ...
    public AdMobInterstitial(com.google.appinventor.components.runtime.ComponentContainer r9) {
        /*
            ...
            r4.<init>(r5, r6)
            r2.f43hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            com.google.appinventor.components.runtime.util.MakeroidDataProtection r2 = r2.f43hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
            r3 = r0
            ...
            android.content.Context r5 = r5.context
            r4.<init>(r5)
            r2.f44hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            com.google.appinventor.components.runtime.util.ads.KodularInterstitial r2 = r2.f44hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
    ...
    public void AdUnitID(String str) {
        String str2 = str;
        if (this.adUnitId == null || this.adUnitId.equals(KodularAdsUtil.ADMOB_INTERSTITIAL_TEST_ID)) {
            this.adUnitId = str2;
        }
    }
    ...
    public void TargetGender(String str) {
        String str2 = str;
        this.oDikMCstR6tlR2dTNi9SmHhjXnOW8gvVc7RVCpamOJDxjRqCmBMqmRVoMYhtpjS = str2;
    }
    ...
    public void CommissionInterstitialAdsNetwork(String str) {
        this.f44hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.updateNetwork(str);
    }
    ...
    public void ShowInterstitialAd() {
        ...
        } else if (this.f44hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.showAd()) {
            this.qPeHJnCLP0dAOwDPeFIn82vcSIsCMh6KFFn3o4kyIe0RhQKOQXDeyY2LFwPu2GbE = false;
            return;
        }
        this.yKzj3OK1ig8r7pqFZ5OXQyoqJiWnRvwjZPZ1kORJGZPQRb8FuKJuM2qAKu5QCSLT = "Interstitial ad was not ready to be shown. Make sure you have set AdUnitId and you invoke this after LoadAd";
        int d = Log.d("AdMobInterstitial", this.yKzj3OK1ig8r7pqFZ5OXQyoqJiWnRvwjZPZ1kORJGZPQRb8FuKJuM2qAKu5QCSLT);
        AdFailedToShow(this.yKzj3OK1ig8r7pqFZ5OXQyoqJiWnRvwjZPZ1kORJGZPQRb8FuKJuM2qAKu5QCSLT);
    }
    ...
    public void ConsentTitle(String str) {
        this.f43hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setTitle(str);
    }

    @SimpleProperty
    public String ConsentTitle() {
        return this.f43hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getTitle();
    }
    ...
    public void ConsentMessage(String str) {
        this.f43hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setMessage(str);
    }

    @SimpleProperty
    public String ConsentMessage() {
        return this.f43hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getMessage();
    }

    @SimpleFunction(description = "Deletes the user's consent. Useful if you want to test the consent dialog in development.")
    public void RevokeConsent() {
        this.f43hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.RevokeConsent();
    }
    ...
    public boolean PersonalizedResult() {
        return this.f43hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getPersonalizedResult();
    }
    ...
    public void ConsentDevelopmentMode(boolean z) {
        this.f43hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setDevelopmentMode(z);
    }

    @SimpleProperty
    public boolean ConsentDevelopmentMode() {
        return this.f43hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getDevelopmentMode();
    }
}
