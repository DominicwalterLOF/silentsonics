...
public class GoogleSpreadsheet extends AndroidNonvisibleComponent implements Component {
    private final int ESt8lrIffFGR3zRMjd5dWbJ7NZymJSmv5KENFDX7fPBQMwlHzz9dP6Ts0eqkVO5e = 5000;
    private final String LOG_TAG = "GoogleSpreadsheet";
    private final String Qws8UL0KACxj4AFwEq11K2awfkG72XuPUTZHhPLrlGlIXoxeK9stYQCrIWmabWcL = "?dev=true";
    private String TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt = "";
    protected Activity activity;
    private String bM4TidozxzoY9OaFqMiIYPyvnCah6tSdq3o2XMkQik5CKYcFIbxeqf36lqbvGbmH;
    ...
    private final int iLHecwZEZ1qFKybU5FAR3aqOIDdUsGdPPaR0D5I2BkdnPzgzEMwtpOPW3wNOFXm = 200;
    ...
    static /* synthetic */ void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(GoogleSpreadsheet googleSpreadsheet) {
        ...
        googleSpreadsheet3.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt = googleSpreadsheet3.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt.trim();
        if (googleSpreadsheet2.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt.toLowerCase().endsWith("?dev=true")) {
            str = googleSpreadsheet2.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt;
        } else {
            new StringBuilder();
            StringBuilder sb4 = sb;
            GoogleSpreadsheet googleSpreadsheet4 = googleSpreadsheet2;
            GoogleSpreadsheet googleSpreadsheet5 = googleSpreadsheet4;
            String sb5 = sb4.append(googleSpreadsheet4.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt).append("?dev=true").toString();
            str = sb5;
            googleSpreadsheet5.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt = sb5;
        }
        String str2 = str;
        new StringBuilder();
        ...
        try {
            ...
            if (httpURLConnection2.getResponseCode() == 200) {
                ...
                JSONArray jSONArray = (JSONArray) jSONObject.get(googleSpreadsheet2.bM4TidozxzoY9OaFqMiIYPyvnCah6tSdq3o2XMkQik5CKYcFIbxeqf36lqbvGbmH);
    ...
    static /* synthetic */ void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(GoogleSpreadsheet googleSpreadsheet, String str) {
        ...
        GoogleSpreadsheet googleSpreadsheet4 = googleSpreadsheet2;
        GoogleSpreadsheet googleSpreadsheet5 = googleSpreadsheet4;
        googleSpreadsheet3.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt = googleSpreadsheet4.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt.trim();
        if (googleSpreadsheet5.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt.toLowerCase().endsWith("?dev=true")) {
            str2 = googleSpreadsheet5.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt;
        } else {
            new StringBuilder();
            StringBuilder sb3 = sb;
            GoogleSpreadsheet googleSpreadsheet6 = googleSpreadsheet5;
            GoogleSpreadsheet googleSpreadsheet7 = googleSpreadsheet6;
            String sb4 = sb3.append(googleSpreadsheet6.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt).append("?dev=true").toString();
            str2 = sb4;
            googleSpreadsheet7.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt = sb4;
        }
        String str4 = str2;
        try {
            new StringBuilder();
            new URL(sb2.append(str4).append("/").append(googleSpreadsheet5.bM4TidozxzoY9OaFqMiIYPyvnCah6tSdq3o2XMkQik5CKYcFIbxeqf36lqbvGbmH).toString());
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            HttpURLConnection httpURLConnection2 = httpURLConnection;
    ...
    public void SheetName(String str) {
        String str2 = str;
        this.bM4TidozxzoY9OaFqMiIYPyvnCah6tSdq3o2XMkQik5CKYcFIbxeqf36lqbvGbmH = str2;
    }
