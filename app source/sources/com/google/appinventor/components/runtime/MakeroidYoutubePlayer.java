...
public class MakeroidYoutubePlayer extends AndroidViewComponent {
    ...
    private YouTubePlayerView f212hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private PlayerUIController f213hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private YouTubePlayerTracker f214hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    static /* synthetic */ PlayerUIController hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(MakeroidYoutubePlayer makeroidYoutubePlayer, PlayerUIController playerUIController) {
        ...
        makeroidYoutubePlayer.f213hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = playerUIController3;
    ...
    public MakeroidYoutubePlayer(com.google.appinventor.components.runtime.ComponentContainer r8) {
        /*
            ...
            r4.<init>(r5)
            r2.f212hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            ...
            r4 = r6
            r4.<init>()
            r2.f214hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            com.pierfrancescosoffritti.androidyoutubeplayer.player.YouTubePlayerView r2 = r2.f212hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
            ...
            java.lang.String r2 = "Kodular Youtube Player"
    ...
    public YouTubePlayerView getView() {
        return this.f212hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    }
    ...
    public void StartSecond(float f) {
        ...
        this.q8iygSjgpTZ52A5K8GXhnvUs2CX4iXd4uIVtwvououVquIzlzfVOfWIR3CjSHG4 = String.valueOf(f2);
    }
    ...
    public void SeekTo(float f) {
        ...
        if (this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            try {
                ...
                int e2 = Log.e("Kodular Youtube Player", String.valueOf(e));
    ...
    public void Volume(int i) {
        ...
        if (i2 > 100 || i2 < 0) {
            ...
            new StringBuilder();
            this.q8iygSjgpTZ52A5K8GXhnvUs2CX4iXd4uIVtwvououVquIzlzfVOfWIR3CjSHG4 = sb.append(this.YP4juQGK8ZTsNMOy2BKg810SeLJ3amlj2BQC8tc7uqP2LdhyRsu8lUHvdJ0v9u).toString();
    ...
    public boolean IsFullscreen() {
        return this.f212hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isFullScreen();
    }

    @SimpleFunction(description = "Toggle the state of the video player.")
    public void ToggleFullscreen() {
        this.f212hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.toggleFullScreen();
    }

    @SimpleFunction(description = "Enter the video in fullscreen mode.")
    public void EnterFullscreen() {
        this.f212hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.enterFullScreen();
    }

    @SimpleFunction(description = "Exit the video from fullscreen mode.")
    public void ExitFullscreen() {
        this.f212hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.exitFullScreen();
    }

    @SimpleProperty(description = "Returns the current second.")
    public float GetCurrentSecond() {
        if (this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            return this.f214hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getCurrentSecond();
        }
        return 0.0f;
    }
    ...
    public float GetVideoDuration() {
        if (this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            return this.f214hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getVideoDuration();
        }
        return 0.0f;
    }
    ...
    public void EnableLiveVideoUI(boolean z) {
        ...
        if (this.f213hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            this.f213hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.enableLiveVideoUI(z2);
        }
    }
