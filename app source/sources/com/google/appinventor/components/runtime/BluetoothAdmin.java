...
public class BluetoothAdmin extends AndroidNonvisibleComponent implements Component, OnDestroyListener, OnResumeListener, OnStopListener {
    ...
    private List<String> f51wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou;
    ...
    static /* synthetic */ List B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T(BluetoothAdmin bluetoothAdmin, List list) {
        List list2 = list;
        List list3 = list2;
        bluetoothAdmin.f51wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou = list3;
        return list2;
    }
    ...
    class b extends BroadcastReceiver {
        ...
        b(BluetoothAdmin bluetoothAdmin) {
    ...
    class a extends BroadcastReceiver {
        ...
        a(BluetoothAdmin bluetoothAdmin) {
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = bluetoothAdmin;
        }
    ...
    public BluetoothAdmin(com.google.appinventor.components.runtime.ComponentContainer r8) {
        /*
            ...
            r4 = r6
            r4.<init>()
            r2.f51wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou = r3
            r2 = r0
            java.util.ArrayList r3 = new java.util.ArrayList
            r6 = r3
            r3 = r6
    ...
    public void Pair(String str) {
        this.sLSXXiYjDERyx7CKvO5GstTCcI8HiXXLiPYrugcXt2517h4ADL52v0RLLmUd9xMb = str;
    ...
    private void m0hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(String str) {
        ...
        String str2 = str;
        try {
            BluetoothDevice remoteDevice = this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getRemoteDevice(hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(this.sLSXXiYjDERyx7CKvO5GstTCcI8HiXXLiPYrugcXt2517h4ADL52v0RLLmUd9xMb));
