...
public class AccelerometerSensor extends AndroidNonvisibleComponent implements SensorEventListener, Deleteable, OnPauseListener, OnResumeListener, SensorComponent {
    ...
    public AccelerometerSensor(com.google.appinventor.components.runtime.ComponentContainer r7) {
        /*
            ...
            r2 = r0
            com.google.appinventor.components.common.Sensitivity r3 = com.google.appinventor.components.common.Sensitivity.Moderate
            r2.SensitivityAbstract(r3)
            return
        */
    ...
    public void Sensitivity(@Options(Sensitivity.class) int i) {
        int i2 = i;
        Sensitivity fromUnderlyingValue = Sensitivity.fromUnderlyingValue(Integer.valueOf(i2));
        Sensitivity sensitivity2 = fromUnderlyingValue;
        ...
        SensitivityAbstract(sensitivity2);
    }
    ...
    private boolean isShaking(Queue<Float> queue, float f) {
        ...
        float abs = Math.abs((f3 / ((float) queue2.size())) - f2);
        switch (this.sensitivity) {
            case Weak:
                return ((double) abs) > strongShakeThreshold;
            case Moderate:
                return ((double) abs) > moderateShakeThreshold && ((double) abs) < strongShakeThreshold;
            case Strong:
                return ((double) abs) > weakShakeThreshold && ((double) abs) < moderateShakeThreshold;
            default:
                return false;
        }
    }
