...
@UsesQueries(intents = {@IntentFilterElement(actionElements = {@ActionElement(name = "com.google.zxing.client.android.SCAN")})})
@SimpleObject
...
public class BarcodeScanner extends AndroidNonvisibleComponent implements ActivityResultListener, Component {
    ...
    public void DoScan() {
        ...
        if (!this.F0SK4gPRNmAI2jCyU6DpJpRxlfo5Y8j9ZujjeLuDeDzReJBeSNN2RZtCnkXv1dho) {
    ...
    public void resultReturned(int i, int i2, Intent intent) {
        ...
        if (i == this.requestCode && i3 == -1) {
            if (intent2.hasExtra("SCAN_RESULT")) {
                this.KbzcIEn6WDqjdY1QBot1TMrBwhEYy4xAUKG2cbzQ22VNohlOtuBGKUJsEeMNZyEH = intent2.getStringExtra("SCAN_RESULT");
            } else {
