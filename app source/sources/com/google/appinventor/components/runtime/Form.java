...
public class Form extends AppCompatActivity implements ViewTreeObserver.OnGlobalLayoutListener, Component, ComponentContainer, HandlesEventDispatching {
                ...
                public final void run() {
                    ...
                    if (z) {
                        ...
                        new Runnable(this) {
                            ...
                            private /* synthetic */ AnonymousClass12 f109hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

                            {
                                this.f109hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r6;
                            }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        Set set = this.activityResultMultiMap.get(Integer.valueOf(i3));
        Set set2 = set;
        if (set != null) {
            ActivityResultListener[] activityResultListenerArr = (ActivityResultListener[]) set2.toArray(new ActivityResultListener[0]);
            ActivityResultListener[] activityResultListenerArr2 = activityResultListenerArr;
            int length = activityResultListenerArr.length;
            for (int i6 = 0; i6 < length; i6++) {
                activityResultListenerArr2[i6].resultReturned(i3, i4, intent2);
            }
        }
    }
    ...
    public void registerForActivityResult(ActivityResultListener activityResultListener, int i) {
        ActivityResultListener activityResultListener2 = activityResultListener;
        int i2 = i;
        Set set = this.activityResultMultiMap.get(Integer.valueOf(i2));
        HashSet hashSet = set;
        if (set == null) {
            hashSet = Sets.newHashSet();
            Set<ActivityResultListener> put = this.activityResultMultiMap.put(Integer.valueOf(i2), hashSet);
        }
        boolean add = hashSet.add(activityResultListener2);
    }
    ...
    public void unregisterForActivityResult(ActivityResultListener activityResultListener) {
        ...
        while (it.hasNext()) {
            ...
            boolean remove3 = ((Set) next2.getValue()).remove(activityResultListener2);
    ...
    public void ReplayFormOrientation() {
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            ...
            if (percentStorageRecord.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME == PercentStorageRecord.Dim.HEIGHT) {
                percentStorageRecord2.B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.Height(percentStorageRecord2.DmQGLROFyZ9Eo0RSsJcpZNxJZjgcsPDfYPi3awNwmyyErT71sGU5mvgG4PDW3yL);
            } else {
                percentStorageRecord2.B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.Width(percentStorageRecord2.DmQGLROFyZ9Eo0RSsJcpZNxJZjgcsPDfYPi3awNwmyyErT71sGU5mvgG4PDW3yL);
            }
        }
    }
            ...
            public final void run() {
                ...
                if (Form.activeForm instanceof ReplForm) {
                    ...
                    if (replForm.sSQuIBUVrx5rcdxHqHgqC6bPLuuDnxnBF7e7BJeOxmxr54l6ArzFZvC3SGBTuUdt != null) {
                        ...
                        replForm2.OtherScreenClosed(replForm2.roiS8tAeAqybL08NoxfqzQ1mPU3hAwiV5i3h5unWOaW17ApoVrdrKjoB0Q8IrS8T, replForm.sSQuIBUVrx5rcdxHqHgqC6bPLuuDnxnBF7e7BJeOxmxr54l6ArzFZvC3SGBTuUdt);
                ...
                if (this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.formName.equals("Screen1")) {
                    KodularAnalyticsUtil.init(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getApplication(), this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.$context(), this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME);
                    this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.billing.update();
                    return;
                }
                KodularAnalyticsUtil.screenOpen(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.formName, this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME);
            }
        };
        boolean post = this.androidUIHandler.post(runnable);
    }
    ...
    public void ErrorOccurred(Component component, String str, int i, String str2) {
        ...
        new StringBuilder("Form ");
        int e = Log.e(LOG_TAG, sb.append(this.formName).append(" ErrorOccurred, errorNumber = ").append(i2).append(", componentType = ").append(substring).append(", functionName = ").append(str3).append(", messages = ").append(str4).toString());
        KodularAnalyticsUtil.logError(substring, str3, i2, str4, this);
    ...
    public void dispatchErrorOccurredEvent(Component component, String str, int i, Object... objArr) {
        ...
        new Runnable(this) {
            ...
            /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
            private /* synthetic */ Form f114hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

            {
                this.f114hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r9;
            }

            public final void run() {
                this.f114hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.ErrorOccurred(component2, str2, i2, ErrorMessages.formatMessage(i2, objArr2));
            }
        };
    ...
    public void dispatchErrorOccurredEventDialog(Component component, String str, int i, Object... objArr) {
        ...
        new Runnable(this) {
            ...
            /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
            private /* synthetic */ Form f115hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

            {
                this.f115hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r9;
            }
            ...
            public final void run() {
                ...
                this.f115hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.ErrorOccurredDialog(component2, str2, i2, formatMessage, sb.append(str2).toString(), "Dismiss");
            }
        };
        runOnUiThread(runnable);
    }
    ...
    public void ScreenOrientationAbstract(ScreenOrientation screenOrientation) {
        ...
        int orientationConstant = screenOrientation2.getOrientationConstant();
        int i = orientationConstant;
        if (orientationConstant > 5) {
            dispatchErrorOccurredEvent(this, "ScreenOrientation", ErrorMessages.ERROR_INVALID_SCREEN_ORIENTATION, screenOrientation2);
            return;
        }
    ...
    public void ScreenOrientation(@Options(ScreenOrientation.class) String str) {
        String str2 = str;
        ScreenOrientation fromUnderlyingValue = ScreenOrientation.fromUnderlyingValue(str2);
        ScreenOrientation screenOrientation = fromUnderlyingValue;
        ...
        ScreenOrientationAbstract(screenOrientation);
    }
    ...
    public void OpenScreenAnimation(@Options(ScreenAnimation.class) String str) {
        String str2 = str;
        ScreenAnimation fromUnderlyingValue = ScreenAnimation.fromUnderlyingValue(str2);
        ScreenAnimation screenAnimation = fromUnderlyingValue;
        if (fromUnderlyingValue == null) {
    ...
    public void OpenScreenAnimationAbstract(ScreenAnimation screenAnimation) {
        ScreenAnimation screenAnimation2 = screenAnimation;
        this.openAnimType = screenAnimation2;
    }
    ...
    public void CloseScreenAnimationAbstract(ScreenAnimation screenAnimation) {
        ScreenAnimation screenAnimation2 = screenAnimation;
        this.closeAnimType = screenAnimation2;
    }
    ...
    public void setChildWidth(AndroidViewComponent androidViewComponent, int i) {
        ...
        if (Width == 0) {
            ...
            new Runnable(this) {
                ...
                /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
                private /* synthetic */ Form f117hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

                {
                    this.f117hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r7;
                }

                public final void run() {
                    System.err.println("(Form)Width not stable yet... trying again");
                    this.f117hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setChildWidth(androidViewComponent3, i4);
                }
            };
    ...
    public void setChildHeight(AndroidViewComponent androidViewComponent, int i) {
        ...
        if (Height() == 0) {
            ...
            new Runnable(this) {
                ...
                /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
                private /* synthetic */ Form f116hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

                {
                    this.f116hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r7;
                }

                public final void run() {
                    System.err.println("(Form)Height not stable yet... trying again");
                    this.f116hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setChildHeight(androidViewComponent3, i3);
                }
            };
            boolean postDelayed = this.androidUIHandler.postDelayed(runnable, 100);
        }
    ...
    public void ShowNavBar(boolean z) {
        ...
        new View.OnSystemUiVisibilityChangeListener(this) {
            ...
            /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
            private /* synthetic */ Form f118hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

            {
                this.f118hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r7;
            }

            public final void onSystemUiVisibilityChange(int i) {
                int i2 = i;
                view2.setSystemUiVisibility(this.f118hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.VisibilityHelper(z3));
            }
        };
    ...
    public void dispatchPermissionDeniedEvent(Component component, String str, String str2) {
        ...
        new Runnable(this) {
            ...
            /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
            private /* synthetic */ Form f113hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

            {
                this.f113hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r8;
            }

            public final void run() {
                this.f113hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.PermissionDenied(component2, str3, str4);
            }
        };
        runOnUiThread(runnable);
    }
    ...
    public InputStream openAssetInternal(String str) throws IOException {
        ...
        if (str2.startsWith("file:")) {
            return FileUtil.openFile(this, URI.create(str2));
        }
        return FileUtil.openFile(this, str2);
    }
