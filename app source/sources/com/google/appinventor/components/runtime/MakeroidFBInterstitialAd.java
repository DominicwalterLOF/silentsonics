...
public class MakeroidFBInterstitialAd extends AndroidNonvisibleComponent implements InterstitialAdListener, Component, OnDestroyListener {
    ...
    private KodularInterstitial f194hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public MakeroidFBInterstitialAd(com.google.appinventor.components.runtime.ComponentContainer r9) {
        /*
            ...
            android.content.Context r5 = r5.context
            r4.<init>(r5)
            r2.f194hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            com.google.appinventor.components.runtime.util.ads.KodularInterstitial r2 = r2.f194hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
    ...
    public void ShowAd() {
        ...
        } else if (!this.f194hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.showAd()) {
            Error("The ad is already expired or invalidated. Please load a new ad.");
            return;
        } else {
    ...
    public void CommissionInterstitialAdsNetwork(String str) {
        this.f194hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.updateNetwork(str);
    }
    ...
    public void onError(Ad ad, AdError adError) {
        ...
        Error(adError2.getErrorMessage());
    }
    ...
    static /* synthetic */ void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(MakeroidFBInterstitialAd makeroidFBInterstitialAd) {
        ...
        if (random.nextFloat() <= makeroidFBInterstitialAd2.kodularAdsCommission.getCommision("facebook", "interstitial")) {
            ...
            makeroidFBInterstitialAd2.f194hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.loadAd(false);
        } else {
            makeroidFBInterstitialAd2.qPeHJnCLP0dAOwDPeFIn82vcSIsCMh6KFFn3o4kyIe0RhQKOQXDeyY2LFwPu2GbE = false;
            new InterstitialAd(makeroidFBInterstitialAd2.context, makeroidFBInterstitialAd2.bEgrYPbd5peKqyXwAOBm3whGEG8qvODU2pBvqaxE9h7HUpHdWqfLhYhcIZ9UxgZV);
            makeroidFBInterstitialAd2.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = interstitialAd;
            makeroidFBInterstitialAd2.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.loadAd(makeroidFBInterstitialAd2.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.buildLoadAdConfig().withAdListener(makeroidFBInterstitialAd2).build());
        }
