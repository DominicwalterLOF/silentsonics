...
public class KodularContentProtection {
    ...
    public KodularContentProtection(Activity activity) {
        ...
        strArr10[1] = "Your app has not been approved to serve ads. Please go to my.kodular.io and request approval for your app.";
    ...
    public void startContentValidation(String str) {
        ...
        if (!this.canStartValidation) {
            int w = Log.w(LOG_TAG, "Can not load a new ad until the old requested one has finished loading or was shown.");
            ...
            try {
                if (((Form) this.kActivity).IsCompanion()) {
                    int i2 = Log.i(LOG_TAG, "Application is Companion");
                    setInterfaceHelper(true, true, "");
                    return;
                }
            } catch (Exception e) {
            ...
            if (isConnected()) {
                int i3 = Log.i(LOG_TAG, "Start now application content check.");
                new a(this, (byte) 0);
                AsyncTask execute = aVar.execute(new String[0]);
                return;
            }
            int w2 = Log.w(LOG_TAG, "There was an internal error while loading the ad. No internet connection.");
    ...
    class a extends AsyncTask<String, String, Boolean> {
        ...
        private a(KodularContentProtection kodularContentProtection) {
    ...
    public void setInterfaceHelper(boolean z, boolean z2, String str) {
        ...
        if (str2.equals("Your app has not been approved to serve ads. Please go to my.kodular.io and request approval for your app.")) {
            showWarningDialog();
        }
        ...
        try {
            ...
            if (httpURLConnection.getResponseCode() == 200) {
                ...
                if (jSONObject2.getBoolean("success") && jSONObject3.getBoolean("approved")) {
                    ...
                    this.failReason = "Your app has not been approved to serve ads. Please go to my.kodular.io and request approval for your app.";
                ...
                this.failReason = "No response got from validation System. Please try again.";
