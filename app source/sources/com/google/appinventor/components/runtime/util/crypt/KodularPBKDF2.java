...
public class KodularPBKDF2 {
    ...
    public static String createHash(char[] cArr, int i, int i2, int i3) throws CannotPerformOperationException {
        ...
        return sb.append(i4).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(length).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(DatatypeConverter.printBase64Binary(bArr)).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(DatatypeConverter.printBase64Binary(bArr2)).toString();
    }
