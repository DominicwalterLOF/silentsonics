...
public class KodularGDPRUtil {
    private static final String[] qPeHJnCLP0dAOwDPeFIn82vcSIsCMh6KFFn3o4kyIe0RhQKOQXDeyY2LFwPu2GbE;
    ...
    static {
        ...
        strArr28[27] = "sk";
        qPeHJnCLP0dAOwDPeFIn82vcSIsCMh6KFFn3o4kyIe0RhQKOQXDeyY2LFwPu2GbE = strArr28;
    }
    ...
    public static boolean isRequestLocationInEurope(Context context) {
        ...
        if (telephonyManager.getNetworkCountryIso() == null) {
            int e = Log.e("Kodular GDPR Util", "It was not possible to get the country code. We returned the value true as default to cover the EU privacy policy.");
            return true;
        }
        String networkCountryIso = telephonyManager2.getNetworkCountryIso();
        int i = Log.i("Kodular GDPR Util", "Current user country is: ".concat(String.valueOf(networkCountryIso)));
        if (networkCountryIso == null) {
            int w = Log.w("Kodular GDPR Util", "There was a error to retrieve the current user location.");
            return true;
        }
        ...
        int i2 = Log.i("Kodular GDPR Util", "Current user is in EUROPE: ".concat(String.valueOf(contains)));
        return contains;
    }
}
