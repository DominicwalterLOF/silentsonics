...
public class PolyUtil {
    ...
    private final RectF f289hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public PolyUtil() {
        ...
        new RectF();
        this.f289hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = rectF;
    }
    ...
    public void constructPolygonPath(@NonNull Path path, @IntRange(from = 3) int i, float f, float f2, @FloatRange(from = 0.0d, fromInclusive = false) float f3, @FloatRange(from = 0.0d) float f4, float f5) {
        ...
        if (((double) Math.abs(f9)) < 0.01d) {
            ...
            for (int i6 = 0; i6 < i5; i6++) {
                ...
                this.f289hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.set(cos3 - f13, sin3 - f13, cos3 + f13, sin3 + f13);
                path4.arcTo(this.f289hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, (float) (d3 - ((double) f14)), f14 * 2.0f);
            }
            path4.close();
        }
        new Matrix();
