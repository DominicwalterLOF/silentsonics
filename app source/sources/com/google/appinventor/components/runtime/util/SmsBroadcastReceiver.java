...
public class SmsBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (isReceivingEnabled == 1) {
            ...
            int i8 = Log.i(TAG, sb3.append(str3).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(str2).toString());
            ...
            if (intent2.getAction().equals("com.google.android.apps.googlevoice.SMS_RECEIVED")) {
                ...
                for (SmsMessage next : KitkatUtil.getMessagesFromIntent(intent2)) {
                    ...
                    if (next != null) {
                        ...
                        str = PhoneNumberUtils.formatNumber(originatingAddress, Locale.getDefault().getCountry());
                    }
                }
            }
        ...
        try {
            if (intent2.getAction().equals("com.google.android.apps.googlevoice.SMS_RECEIVED")) {
                ...
                for (SmsMessage next : KitkatUtil.getMessagesFromIntent(intent2)) {
                    SmsMessage smsMessage = next;
                    if (next != null) {
                        StringBuilder append = sb2.append(smsMessage.getMessageBody());
                    }
                }
                str = sb2.toString();
            }
