...
public class InternalTextToSpeech implements ITextToSpeech {
    ...
    public void speak(String str, Locale locale, int i) {
        ...
        if (this.isTtsInitialized) {
            ...
            new UtteranceProgressListener(this) {
            ...
            int onUtteranceProgressListener = this.tts.setOnUtteranceProgressListener(utteranceProgressListener);
            int i3 = this.nextUtteranceId;
            int i4 = i3 + 1;
            this.nextUtteranceId = i4;
            if (this.tts.speak(str2, 0, (Bundle) null, Integer.toString(i3)) == -1) {
