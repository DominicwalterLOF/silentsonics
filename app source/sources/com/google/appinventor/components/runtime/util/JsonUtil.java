...
public class JsonUtil {
    ...
    public static String getJsonRepresentationIfValueFileName(Object obj) {
        ...
        int w = Log.w(LOG_TAG, "Calling deprecated function getJsonRepresentationIfValueFileName", th);
        return getJsonRepresentationIfValueFileName(Form.getActiveForm(), obj);
    }

    public static String getJsonRepresentationIfValueFileName(Context context, Object obj) {
        Throwable th;
        List<String> list;
        JSONArray jSONArray;
        ...
        try {
            ...
            String writeFile = writeFile(context2, list.get(1), list.get(0).substring(1));
    ...
    private static java.lang.String writeFile(android.content.Context r9, java.lang.String r10, java.lang.String r11) {
        /*
            r0 = r9
            r1 = r10
            r2 = r11
            ...
            r3 = r4
            r4 = r2
            int r4 = r4.length()     // Catch:{ Exception -> 0x0024 }
            r5 = 3
            ...
            r5 = 4
            if (r4 == r5) goto L_0x0051
            com.google.appinventor.components.runtime.errors.YailRuntimeError r4 = new com.google.appinventor.components.runtime.errors.YailRuntimeError     // Catch:{ Exception -> 0x0024 }
            r8 = r4
            r4 = r8
            r5 = r8
            java.lang.String r6 = "File Extension must be three or four characters"
            java.lang.String r7 = "Write Error"
            r5.<init>(r6, r7)     // Catch:{ Exception -> 0x0024 }
            throw r4     // Catch:{ Exception -> 0x0024 }
        L_0x0024:
            r4 = move-exception
            r1 = r4
            com.google.appinventor.components.runtime.errors.YailRuntimeError r4 = new com.google.appinventor.components.runtime.errors.YailRuntimeError     // Catch:{ all -> 0x0047 }
            r8 = r4
            r4 = r8
            r5 = r8
            ...
            java.lang.String r6 = r6.toString()     // Catch:{ all -> 0x0047 }
            java.lang.String r7 = "Write"
            r5.<init>(r6, r7)     // Catch:{ all -> 0x0047 }
        ...
        L_0x0051:
            r4 = r1
            r5 = 0
            byte[] r4 = android.util.Base64.decode(r4, r5)     // Catch:{ Exception -> 0x0024 }
            r1 = r4
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x0024 }
            r8 = r4
            r4 = r8
            r5 = r8
            r5.<init>()     // Catch:{ Exception -> 0x0024 }
            r5 = r0
            java.lang.String r5 = com.google.appinventor.components.runtime.util.QUtil.getExternalStoragePath(r5)     // Catch:{ Exception -> 0x0024 }
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ Exception -> 0x0024 }
            java.lang.String r5 = "/AppInventorBinaries"
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ Exception -> 0x0024 }
            java.lang.String r4 = r4.toString()     // Catch:{ Exception -> 0x0024 }
            r0 = r4
            java.io.File r4 = new java.io.File     // Catch:{ Exception -> 0x0024 }
            r8 = r4
            r4 = r8
            r5 = r8
            r6 = r0
            ...
            r5 = r8
            r0 = r5
            boolean r4 = r4.mkdirs()     // Catch:{ Exception -> 0x0024 }
            java.lang.String r4 = "BinFile"
            java.lang.String r5 = "."
            r6 = r2
            java.lang.String r6 = java.lang.String.valueOf(r6)     // Catch:{ Exception -> 0x0024 }
            java.lang.String r5 = r5.concat(r6)     // Catch:{ Exception -> 0x0024 }
            r6 = r0
            java.io.File r4 = java.io.File.createTempFile(r4, r5, r6)     // Catch:{ Exception -> 0x0024 }
            r2 = r4
            java.io.FileOutputStream r4 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x0024 }
            r8 = r4
            r4 = r8
            r5 = r8
            r6 = r2
            ...
            r3 = r5
            r5 = r1
            r4.write(r5)     // Catch:{ Exception -> 0x0024 }
            r4 = r2
            java.net.URI r4 = r4.toURI()     // Catch:{ Exception -> 0x0024 }
            java.lang.String r4 = r4.toASCIIString()     // Catch:{ Exception -> 0x0024 }
            r1 = r4
            r4 = 20
            r5 = r0
            trimDirectory(r4, r5)     // Catch:{ Exception -> 0x0024 }
            r4 = r1
            r0 = r4
            java.lang.String r4 = LOG_TAG
            r5 = r3
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.appinventor.components.runtime.util.JsonUtil.writeFile(android.content.Context, java.lang.String, java.lang.String):java.lang.String");
    }
