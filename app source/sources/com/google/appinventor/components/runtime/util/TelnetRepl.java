...
public class TelnetRepl extends Procedure0 {
    ...
    private Socket f290B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T;
    ...
    public TelnetRepl(Language language, Socket socket) {
        ...
        this.f290B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T = socket;
    }
    ...
    public Object apply0() {
        ...
        try {
            ...
            try {
                this.f290B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.close();
            } catch (IOException e) {
            }
            return values;
    ...
    public static Thread serve(Language language, Socket socket) throws IOException {
        ...
        new BiggerFuture(procedure, inPort2, outPort3, outPort3, "Telnet Repl Thread", 262144);
