...
public class TextViewUtil {
    private static Context hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO;

    private TextViewUtil() {
    }

    public static void setContext(Context context) {
        hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO = context;
    }
    ...
    private static Typeface hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(int i) {
        ...
        switch (i) {
            ...
            case 3:
                ...
                break;
            case 4:
                createFromAsset = Typeface.createFromAsset(hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO.getAssets(), "Roboto-Thin.ttf");
                break;
            case 5:
                createFromAsset = Typeface.createFromAsset(hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO.getAssets(), "Roboto-Regular.ttf");
                break;
            case 6:
                createFromAsset = Typeface.createFromAsset(hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO.getAssets(), "fontawesome-webfont.ttf");
                break;
            case 7:
                createFromAsset = Typeface.createFromAsset(hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO.getAssets(), "MaterialIcons-Regular.ttf");
                break;
            case 8:
                createFromAsset = Typeface.createFromAsset(hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO.getAssets(), "fa-regular-400.ttf");
                break;
            case 9:
                createFromAsset = Typeface.createFromAsset(hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO.getAssets(), "fa-solid-900.ttf");
                break;
            case 10:
                createFromAsset = Typeface.createFromAsset(hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO.getAssets(), "fa-brands-400.ttf");
                break;
            default:
                Throwable th2 = th;
                new IllegalArgumentException();
    ...
    private static Typeface hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(Form form, String str) {
        ...
        Form form2 = form;
        try {
            String assetFilePath = MediaUtil.getAssetFilePath(form2, str);
            String str2 = assetFilePath;
            if (assetFilePath.startsWith(QUtil.getExternalStoragePath(form2))) {
                typeface = Typeface.createFromFile(str2);
            } else {
                typeface = Typeface.createFromAsset(hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO.getAssets(), str2);
            }
        } catch (Exception e) {
            new StringBuilder();
            int d = Log.d("TextViewUtil", sb.append(e.getMessage()).toString());
