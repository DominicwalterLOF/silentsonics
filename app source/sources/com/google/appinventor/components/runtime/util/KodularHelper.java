...
public class KodularHelper {
    ...
    public static void setStatusBarColor(Activity activity, int i) {
        ...
        try {
            ...
            int i3 = Log.i("KodularHelper", "Set new statusBarColor successfully executed");
        } catch (Exception e) {
            int e2 = Log.e("KodularHelper", String.valueOf(e));
        }
    }
    ...
    public static void setNavigationBarColor(Activity activity, int i) {
        try {
            ...
            int i2 = Log.i("KodularHelper", "Set new navigationBarColor successfully executed");
        } catch (Exception e) {
            int e2 = Log.e("KodularHelper", String.valueOf(e));
        }
    }
    ...
    public static void setAppBackgroundTaskInfo(Activity activity, String str, int i) {
        ...
        try {
            ...
            int w = Log.w("KodularHelper", "wrong icon or icon was empty or null or not found. setAppBackgroundTaskInfo");
        }
        if (drawable != null) {
    ...
    public static void prepareRippleDrawable(View view, MotionEvent motionEvent, int i) {
        ...
        try {
            ...
            int i3 = Log.i("KodularHelper", "Prepare new RippleDrawable successfully executed");
        } catch (Exception e) {
            int e2 = Log.e("KodularHelper", String.valueOf(e));
        }
    }
    ...
    public static void setRippleDrawable(View view, Drawable drawable, int i) {
        ...
        try {
            ...
            int i3 = Log.i("KodularHelper", "Set new RippleDrawable successfully executed");
        } catch (Exception e) {
            int e2 = Log.e("KodularHelper", String.valueOf(e));
        }
    }
    ...
    public static void setButtonTintList(CompoundButton compoundButton, int i) {
        ...
        try {
            ...
            int i2 = Log.i("KodularHelper", "Set new buttonTintList successfully executed");
        } catch (Exception e) {
            int e2 = Log.e("KodularHelper", String.valueOf(e));
        }
    }
    ...
    public static void setMarginToBtn(Button button, Context context, String str) {
        ...
        if (!trim.isEmpty()) {
            ...
            for (int i = 0; i < split.length; i++) {
                boolean add = list2.add(Integer.valueOf(KodularUnitUtil.DpToPixels(context2, Integer.parseInt(split[i].trim()))));
            }
            if (split.length == 1) {
                try {
                ...
                try {
                    ...
                    int e4 = Log.e("KodularHelper", String.valueOf(e3));
                }
                ...
                try {
                    ...
                    int e6 = Log.e("KodularHelper", String.valueOf(e5));
                }
            }
        }
    }
