...
public final class MapFactory {
    ...
    public interface MapCircle extends HasFill, HasStroke, MapFeature {
        double Latitude();
    ...
    public interface MapLineString extends HasStroke, MapFeature {
        YailList Points();
    ...
    public interface MapMarker extends HasFill, HasStroke, MapFeature {
    ...
    public interface MapPolygon extends HasFill, HasStroke, MapFeature {
        YailList HolePoints();
    ...
    public interface MapRectangle extends HasFill, HasStroke, MapFeature {
        YailList Bounds();
