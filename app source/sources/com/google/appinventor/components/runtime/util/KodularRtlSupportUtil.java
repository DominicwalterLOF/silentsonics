...
public class KodularRtlSupportUtil {
    ...
    public static void setSupportTextDirection(TextView textView) {
        ...
        if (textView2 != null && textView2.getTextDirection() != 2 && isLayoutDirectionRTL()) {
    ...
    public static boolean isLayoutDirectionRTL() {
        return wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou != null && wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.getResources().getConfiguration().getLayoutDirection() == 1;
    }
}
