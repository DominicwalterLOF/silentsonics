...
public class KodularRSA {
    ...
    private static PublicKey f322hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public static KeyPair buildKeyPair() throws NoSuchAlgorithmException {
        ...
        f322hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = buildKeyPair.getPublic();
    ...
    public static String decrypt(String str) throws Exception {
        ...
        try {
            String str3 = str2;
            new String(decrypt(f322hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, str.getBytes()));
            return str3;
        } catch (Exception e) {
            new StringBuilder();
            int e2 = Log.e("MakeroidCrypt", sb.append(e.getMessage()).toString());
