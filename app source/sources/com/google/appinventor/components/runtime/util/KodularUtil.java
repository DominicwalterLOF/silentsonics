...
public class KodularUtil {
    ...
    public static String GET_REQUEST(String str) {
        ...
        try {
            ...
            Exception exc = e;
            int e2 = Log.e("KodularUtil", String.valueOf(exc));
            REQUEST_SUCCESS = false;
            new StringBuilder();
            REQUEST_ERROR_MESSAGE = sb2.append(exc.getMessage()).toString();
            new StringBuilder(REQUEST_ERROR_MESSAGE);
            return sb3.toString();
        }
    }
    ...
    public static void LoadPicture(Context context, String str, AppCompatImageView appCompatImageView, boolean z) {
        ...
        try {
            if (str2.startsWith("http://") || str2.startsWith("https://")) {
                ...
                new StringBuilder();
                new File(sb.append(QUtil.getReplAssetPath(context2)).append(str2).toString());
            ...
            int e2 = Log.e("KodularUtil", String.valueOf(e));
        }
    }
    ...
    public static BitmapDrawable getBitmap(Form form, String str) {
        ...
        if (str2.startsWith("http://") || str2.startsWith("https://")) {
            ...
            new StringBuilder();
            new File(sb.append(QUtil.getReplAssetPath(form2)).append(str2).toString());
            new SimpleTarget<Bitmap>() {
                public final /* synthetic */ void onResourceReady(Object obj, GlideAnimation glideAnimation) {
                    BitmapDrawable bitmapDrawable;
                    GlideAnimation glideAnimation2 = glideAnimation;
