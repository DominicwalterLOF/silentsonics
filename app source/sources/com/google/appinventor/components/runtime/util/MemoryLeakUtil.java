...
public class MemoryLeakUtil {
    ...
    private static final Map<String, WeakReference<Object>> tee1T53LBirhPaiZzuBv7do2U2eC3n16AtczACNW2pKYEGgDhkkMv1hGUupyoKZE = Maps.newTreeMap();
    ...
    public static String trackObject(String str, Object obj) {
        ...
        WeakReference<Object> put = tee1T53LBirhPaiZzuBv7do2U2eC3n16AtczACNW2pKYEGgDhkkMv1hGUupyoKZE.put(str3, obj2);
        return str3;
    }
    ...
    public static boolean isTrackedObjectCollected(String str, boolean z) {
        ...
        boolean z2 = z;
        System.gc();
        WeakReference weakReference = tee1T53LBirhPaiZzuBv7do2U2eC3n16AtczACNW2pKYEGgDhkkMv1hGUupyoKZE.get(str2);
        ...
        if (weakReference != null) {
            ...
            if (z2 && obj == null) {
                WeakReference<Object> remove = tee1T53LBirhPaiZzuBv7do2U2eC3n16AtczACNW2pKYEGgDhkkMv1hGUupyoKZE.remove(str2);
            }
            if (obj == null) {
                return true;
            }
    ...
    public static void checkAllTrackedObjects(boolean z, boolean z2) {
        ...
        int i2 = 0;
        int i3 = 0;
        Iterator<Map.Entry<String, WeakReference<Object>>> it = tee1T53LBirhPaiZzuBv7do2U2eC3n16AtczACNW2pKYEGgDhkkMv1hGUupyoKZE.entrySet().iterator();
        while (it.hasNext()) {
