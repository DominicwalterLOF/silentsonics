...
public class KodularKeyguardManager extends AndroidNonvisibleComponent implements ActivityResultListener, Component {
    ...
    private String YP4juQGK8ZTsNMOy2BKg810SeLJ3amlj2BQC8tc7uqP2LdhyRsu8lUHvdJ0v9u = "Unlock";
    private Activity activity;
    /* access modifiers changed from: private */
    public final Handler androidUIHandler;
    private Context context;
    private Form form;
    private String gti6bIqu0aXgALoDtkq1foMnPcdzXO0EAPAgw4lcaEF132GirFLns82VqwKc8x6R = "Confirm your screen lock.";
    ...
    public void Title(String str) {
        String str2 = str;
        this.YP4juQGK8ZTsNMOy2BKg810SeLJ3amlj2BQC8tc7uqP2LdhyRsu8lUHvdJ0v9u = str2;
    }
    ...
    public void ShowAuthenticationScreen() {
        Intent createConfirmDeviceCredentialIntent = this.B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.createConfirmDeviceCredentialIntent(Title().isEmpty() ? null : Title(), Description().isEmpty() ? null : Description());
        Intent intent = createConfirmDeviceCredentialIntent;
