...
@UsesLibraries({"app-lovin.aar", "app-lovin.jar", "browser.jar", "browser.aar", "play-services-ads-base.jar", "play-services-ads-base.aar", "play-services-ads-identifier.jar", "play-services-ads-identifier.aar", "play-services-ads-lite.jar", "play-services-ads-lite.aar", "play-services-basement.jar", "play-services-basement.aar", "play-services-gass.jar", "play-services-gass.aar"})
@SimpleObject
...
public class KodularAppLovin extends AndroidNonvisibleComponent {
    ...
    private AppLovinAd f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private AppLovinSdk f166hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private AppLovinSdkSettings f167hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    static /* synthetic */ AppLovinAd hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(KodularAppLovin kodularAppLovin, AppLovinAd appLovinAd) {
        ...
        kodularAppLovin.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = appLovinAd3;
        return appLovinAd2;
    }
    ...
    static /* synthetic */ AppLovinSdk hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(KodularAppLovin kodularAppLovin, AppLovinSdk appLovinSdk) {
        ...
        kodularAppLovin.f166hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = appLovinSdk3;
        return appLovinSdk2;
    }
    ...
    public KodularAppLovin(com.google.appinventor.components.runtime.ComponentContainer r9) {
        /*
            ...
            r4.<init>(r5)
            r2.f167hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
    ...
    public void ShowAd() {
        ...
        if (this.f166hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = AppLovinInterstitialAd.create(this.f166hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, this.container.$context());
            new AppLovinAdClickListener(this) {
                ...
                public final void adClicked(AppLovinAd appLovinAd) {
                    ...
                    int i = Log.i(KodularAnalyticsUtil.Ads.NETWORK_APPLOVIN, "AppLovin: ad opened");
                }
            };
            ...
            new AppLovinAdDisplayListener(this) {
                ...
                public final void adDisplayed(AppLovinAd appLovinAd) {
                    ...
                    int i = Log.i(KodularAnalyticsUtil.Ads.NETWORK_APPLOVIN, "Unity Ads: ad started");
                }

                public final void adHidden(AppLovinAd appLovinAd) {
                    AppLovinAd appLovinAd2 = appLovinAd;
                    this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.AdClosed();
                    int i = Log.i(KodularAnalyticsUtil.Ads.NETWORK_APPLOVIN, "Unity Ads: ad closed");
                }
            };
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setAdDisplayListener(appLovinAdDisplayListener);
            if (this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
                this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.showAndRender(this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME);
            }
        }
    }
    ...
    public void TestMode(boolean z) {
        boolean z2 = z;
        if (this.f167hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            this.f167hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setTestAdsEnabled(z2);
        }
    }
    ...
    public boolean TestMode() {
        if (this.f167hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            return this.f167hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isTestAdsEnabled();
        }
        return false;
    }
