...
public class Map extends MapFeatureContainerBase implements MapFactory.MapEventListener {
    ...
    public Map(com.google.appinventor.components.runtime.ComponentContainer r9) {
        /*
            ...
            r2.EnablePan(r3)
            r2 = r0
            com.google.appinventor.components.common.MapType r3 = com.google.appinventor.components.common.MapType.Road
            r2.MapTypeAbstract(r3)
            r2 = r0
            r3 = 0
            r2.ShowCompass(r3)
            r2 = r0
    ...
    public void MapType(@Options(MapType.class) int i) {
        ...
        MapType mapType = fromUnderlyingValue;
    ...
    public void ScaleUnits(@Options(ScaleUnits.class) int i) {
        int i2 = i;
        ScaleUnits fromUnderlyingValue = ScaleUnits.fromUnderlyingValue(Integer.valueOf(i2));
        ScaleUnits scaleUnits = fromUnderlyingValue;
        if (fromUnderlyingValue == null) {
