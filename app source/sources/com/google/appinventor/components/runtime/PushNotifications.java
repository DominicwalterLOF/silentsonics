...
public final class PushNotifications extends AndroidNonvisibleComponent implements Component {
    ...
    public PushNotifications(com.google.appinventor.components.runtime.Form r9) {
        /*
            r8 = this;
            r0 = r8
            r1 = r9
            ...
            java.lang.String r3 = "OneSignal Initialized"
            int r2 = android.util.Log.d(r2, r3)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.appinventor.components.runtime.PushNotifications.<init>(com.google.appinventor.components.runtime.Form):void");
    }
    ...
    class b implements OneSignal.NotificationReceivedHandler {
        ...
        private b(PushNotifications pushNotifications) {
    ...
    class a implements OneSignal.NotificationOpenedHandler {
        ...
        private a(PushNotifications pushNotifications) {
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = pushNotifications;
        }
    ...
    public boolean B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T(String str, String str2, String str3) {
        ...
        try {
            ...
            httpURLConnection.setRequestProperty("Authorization", "Basic ".concat(String.valueOf(str6)));
            httpURLConnection.setRequestMethod("POST");
            new StringBuilder("{\"app_id\": \"");
            byte[] bytes = sb.append(this.appId).append("\",\"included_segments\": [\"All\"],\"headings\": {\"en\": \"").append(str4).append("\"},\"contents\": {\"en\": \"").append(str5).append("\"}}").toString().getBytes(StandardCharsets.UTF_8);
