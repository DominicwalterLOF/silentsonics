...
public class OrientationSensor extends AndroidNonvisibleComponent implements SensorEventListener, Deleteable, OnPauseListener, OnResumeListener {
    ...
    private final float[] f230hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO = new float[9];
    ...
    public OrientationSensor(com.google.appinventor.components.runtime.ComponentContainer r7) {
        /*
            ...
            r3 = 9
            float[] r3 = new float[r3]
            r2.f230hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO = r3
            r2 = r0
            r3 = 3
            float[] r3 = new float[r3]
        ...
        if (this.enabled) {
            ...
            switch (type) {
                ...
                case 2:
                    ...
                    this.haiIuOdmUoc5XQFvR9GJKGOwB3ZezhsWV0MdG7MgpkerzHclvrTRoGLrsRSHUTL5 = true;
                    break;
                default:
                    int e = Log.e("OrientationSensor", "Unexpected sensor type: ".concat(String.valueOf(i)));
                    return;
            }
            if (this.bjRTr59rlfMAk3NoImwosXnapn2cygGkKCeZagS1kgI5blNKx2IlW2vUboyQWmzb && this.haiIuOdmUoc5XQFvR9GJKGOwB3ZezhsWV0MdG7MgpkerzHclvrTRoGLrsRSHUTL5) {
                boolean rotationMatrix = SensorManager.getRotationMatrix(this.vSp02fkBXgM8EI0gm0rKWXHQ6wdQINJBQuAtCR15YU8g4XNqVKV8r32SYxkQYxkq, this.f230hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO, this.B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T, this.wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou);
                float[] orientation = SensorManager.getOrientation(this.vSp02fkBXgM8EI0gm0rKWXHQ6wdQINJBQuAtCR15YU8g4XNqVKV8r32SYxkQYxkq, this.vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R);
                ...
                switch (rotation) {
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        int e2 = Log.e("OrientationSensor", "Illegal value for getScreenRotation(): ".concat(String.valueOf(i2)));
                        break;
                }
