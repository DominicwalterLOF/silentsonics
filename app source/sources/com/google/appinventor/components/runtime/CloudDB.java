...
public final class CloudDB extends AndroidNonvisibleComponent implements Component, OnClearListener, OnDestroyListener {
    ...
    /* access modifiers changed from: private */
    public final List<a> storeQueue;
    ...
    static class a {
        ...
        String n86Bi3TT8lkq4OIAY6TQzz40yEQcROLeML3EOzGKfDOtlcMXWXcB7P2XOFzT0DDv;
                                    ...
                                    try {
                                        ...
                                        synchronized (access$600) {
                                            if (this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.storeQueue.size() == 0) {
                                                ...
                                                aVar = (a) this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.storeQueue.remove(0);
                                            }
                                            if (aVar == null) {
                                                break;
                                            }
                                            String str3 = aVar.n86Bi3TT8lkq4OIAY6TQzz40yEQcROLeML3EOzGKfDOtlcMXWXcB7P2XOFzT0DDv;
        ...
        if (activeNetworkInfo != null && activeNetworkInfo.isConnected()) {
            ...
            new Runnable(this) {
                ...
                public final void run() {
                    ...
                    try {
                        new StringBuilder();
                        String str = jedis.get(sb4.append(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.projectID).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(str3).toString());
                        String str2 = str;
                        if (str != null) {
                            String jsonRepresentationIfValueFileName = JsonUtil.getJsonRepresentationIfValueFileName(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.form, str2);
        ...
        new Runnable(this) {
            ...
            public final void run() {
                ...
                try {
                    Jedis jedis = this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getJedis();
                    new StringBuilder();
                    Long del = jedis.del(sb2.append(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.projectID).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(str2).toString());
                } catch (Exception e) {
                    Exception exc = e;
                    CloudDB cloudDB = this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
                    new StringBuilder();
                ...
                public final void run() {
                    ...
                    try {
                        ...
                        for (int i = 0; i < list2.size(); i++) {
                            new StringBuilder();
                            Object obj = list2.set(i, ((String) list2.get(i)).substring(sb3.append(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.projectID).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).toString().length()));
                        }
    ...
    private YailList readFile(String str) {
        ...
        try {
            ...
            String encodeToString = Base64.encodeToString(FileUtil.readFile(this.form, str2), 0);
            Object[] objArr = new Object[2];
            Object[] objArr2 = objArr;
