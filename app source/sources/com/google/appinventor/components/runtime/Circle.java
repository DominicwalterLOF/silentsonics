...
public class Circle extends PolygonBase implements MapFactory.MapCircle {
    ...
    private double f69hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private GeoPoint f70hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public Circle(com.google.appinventor.components.runtime.util.MapFactory.MapFeatureContainer r12) {
        /*
            ...
            r8 = 0
            r5.<init>(r6, r8)
            r3.f70hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r4
            r3 = r2
            r4 = r1
            r3.addFeature(r4)
            return
    ...
    public void Latitude(double d) {
        ...
        if (GeometryUtil.isValidLatitude(d2)) {
            this.f69hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = d2;
            this.f70hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setLatitude(d2);
            clearGeometry();
            this.map.getController().updateFeaturePosition((MapFactory.MapCircle) this);
            return;
        }
    ...
    public double Latitude() {
        return this.f69hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    }
    ...
    public void Longitude(double d) {
        ...
        if (GeometryUtil.isValidLongitude(d2)) {
            ...
            this.f70hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setLongitude(d2);
            clearGeometry();
            this.map.getController().updateFeaturePosition((MapFactory.MapCircle) this);
            return;
        }
    ...
    public void SetLocation(double d, double d2) {
        ...
        if (!GeometryUtil.isValidLatitude(d3)) {
            ...
            this.f69hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = d3;
            this.B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T = d4;
            this.f70hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setLatitude(d3);
            this.f70hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setLongitude(d4);
            clearGeometry();
            this.map.getController().updateFeaturePosition((MapFactory.MapCircle) this);
        }
    }
    ...
    public Geometry computeGeometry() {
        return GeometryUtil.createGeometry(this.f70hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME);
    }

    public void updateCenter(double d, double d2) {
        this.f69hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = d;
        this.B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T = d2;
        clearGeometry();
    }
}
