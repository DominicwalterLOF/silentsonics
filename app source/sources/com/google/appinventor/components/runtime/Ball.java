...
public final class Ball extends Sprite {
    ...
    public Ball(ComponentContainer componentContainer) {
        ...
        Paint paint;
        new Paint();
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = paint;
        PaintColor(-16777216);
        Radius(5);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.visible) {
            ...
            float deviceDensity3 = ((float) this.vSp02fkBXgM8EI0gm0rKWXHQ6wdQINJBQuAtCR15YU8g4XNqVKV8r32SYxkQYxkq) * this.form.deviceDensity();
            canvas2.drawCircle(deviceDensity + deviceDensity3, deviceDensity2 + deviceDensity3, deviceDensity3, this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME);
        }
    }

    public final int Height() {
        return 2 * this.vSp02fkBXgM8EI0gm0rKWXHQ6wdQINJBQuAtCR15YU8g4XNqVKV8r32SYxkQYxkq;
    }
    ...
    public final boolean containsPoint(double d, double d2) {
        double d3 = d;
        double d4 = d2;
        return ((d3 - this.xCenter) * (d3 - this.xCenter)) + ((d4 - this.yCenter) * (d4 - this.yCenter)) <= ((double) (this.vSp02fkBXgM8EI0gm0rKWXHQ6wdQINJBQuAtCR15YU8g4XNqVKV8r32SYxkQYxkq * this.vSp02fkBXgM8EI0gm0rKWXHQ6wdQINJBQuAtCR15YU8g4XNqVKV8r32SYxkQYxkq));
    }
    ...
    public final void Radius(int i) {
        int i2 = i;
        int i3 = i2 - this.vSp02fkBXgM8EI0gm0rKWXHQ6wdQINJBQuAtCR15YU8g4XNqVKV8r32SYxkQYxkq;
        if (this.originAtCenter) {
            this.xLeft -= (double) i3;
            this.yTop -= (double) i3;
        }
        this.vSp02fkBXgM8EI0gm0rKWXHQ6wdQINJBQuAtCR15YU8g4XNqVKV8r32SYxkQYxkq = i2;
        registerChange();
    }
    ...
    public final void PaintColor(int i) {
        ...
        if (i2 != 0) {
            PaintUtil.changePaint(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, i2);
        } else {
