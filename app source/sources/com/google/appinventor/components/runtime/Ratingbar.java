...
public final class Ratingbar extends AndroidViewComponent implements RatingBar.OnRatingBarChangeListener {
    private int IQizCoownq3QMuqjiN3SEtpvqAzYOMGAuQhX0ytYpmBBjgggyq4HRoSxolTbNj90 = Component.COLOR_RED;
    private LayerDrawable hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private final RatingBar f233hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    private int vQeIU3Nt6lISgDcgPcgMyfTsPOzVWtilFVqv3Ws2SOY6jXuMnX7gL1LFHvLOLuoZ = Component.COLOR_GRAY;
    ...
    public Ratingbar(com.google.appinventor.components.runtime.ComponentContainer r8) {
        /*
            ...
            r4.<init>(r5)
            r2.f233hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            android.widget.RatingBar r2 = r2.f233hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
            r3 = r0
            ...
            r2 = r6
            r3 = r6
            android.widget.RatingBar r3 = r3.f233hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
    ...
    public final RatingBar getView() {
        return this.f233hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    }
    ...
    public final void SetNumberOfStars(int i) {
        this.f233hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setNumStars(i);
    }

    @SimpleProperty(description = "Returns the number of stars shown.")
    public final int GetNumberOfStars() {
        return this.f233hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getNumStars();
    }
    ...
    public final void IsIndicator(boolean z) {
        this.f233hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setIsIndicator(z);
    }

    @SimpleProperty(description = "Sets the rating (the number of stars filled).")
    public final void SetRating(float f) {
        this.f233hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setRating(f);
    }

    @SimpleProperty(description = "Gets the current rating (number of stars filled).")
    public final float GetRating() {
        return this.f233hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getRating();
    }
    ...
    public final void StarColor(int i) {
        int i2 = i;
        this.IQizCoownq3QMuqjiN3SEtpvqAzYOMGAuQhX0ytYpmBBjgggyq4HRoSxolTbNj90 = i2;
    ...
    public final void BackgroundColor(int i) {
        int i2 = i;
        this.vQeIU3Nt6lISgDcgPcgMyfTsPOzVWtilFVqv3Ws2SOY6jXuMnX7gL1LFHvLOLuoZ = i2;
    ...
    public final void SetStepSize(float f) {
        this.f233hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setStepSize(f);
    }

    @SimpleProperty(description = "Gets the step size (granularity) of this rating bar.")
    public final float GetStepSize() {
        return this.f233hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getStepSize();
    }
