...
public class Camera extends AndroidNonvisibleComponent implements ActivityResultListener, Component {
    ...
    private android.hardware.Camera f59hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = null;
    private int requestCode;
    private boolean sLSXXiYjDERyx7CKvO5GstTCcI8HiXXLiPYrugcXt2517h4ADL52v0RLLmUd9xMb;
    private String zWdiPvy9THbs14kS37O202JH95jn5GzRAXQdLdM0hhw5e6hZSAshBMBb0bJkJXW5 = "";
    ...
    public Camera(com.google.appinventor.components.runtime.ComponentContainer r7) {
        /*
            ...
            r2 = r0
            r3 = 0
            r2.f59hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            java.lang.String r3 = ""
    ...
    public void TakePicture() {
        ...
        if ("mounted".equals(externalStorageState)) {
            ...
            new File(QUtil.getExternalStorageDir(this.form), "/Pictures");
            File file3 = file;
            File file4 = file3;
            if (!file3.exists()) {
                boolean mkdir = file4.mkdir();
            }
            File externalStorageDir = QUtil.getExternalStorageDir(this.form);
            new StringBuilder("/Pictures/kodular_");
            new Date();
            new File(externalStorageDir, sb.append(date.getTime()).append(".jpg").toString());
            File file5 = file2;
            this.zWdiPvy9THbs14kS37O202JH95jn5GzRAXQdLdM0hhw5e6hZSAshBMBb0bJkJXW5 = file5.getAbsolutePath();
    ...
    public void resultReturned(int i, int i2, Intent intent) {
        ...
        if (!this.zWdiPvy9THbs14kS37O202JH95jn5GzRAXQdLdM0hhw5e6hZSAshBMBb0bJkJXW5.isEmpty()) {
            new File(this.zWdiPvy9THbs14kS37O202JH95jn5GzRAXQdLdM0hhw5e6hZSAshBMBb0bJkJXW5);
            File file2 = file;
            File file3 = file2;
            if (file2.exists()) {
                ...
                int i6 = Log.i("Camera", sb2.append(this.zWdiPvy9THbs14kS37O202JH95jn5GzRAXQdLdM0hhw5e6hZSAshBMBb0bJkJXW5).toString());
                AfterPicture(this.zWdiPvy9THbs14kS37O202JH95jn5GzRAXQdLdM0hhw5e6hZSAshBMBb0bJkJXW5);
            } else {
            ...
            this.zWdiPvy9THbs14kS37O202JH95jn5GzRAXQdLdM0hhw5e6hZSAshBMBb0bJkJXW5 = "";
            return;
        }
    ...
    public void ToggleLight() {
        ...
        } else if (this.sLSXXiYjDERyx7CKvO5GstTCcI8HiXXLiPYrugcXt2517h4ADL52v0RLLmUd9xMb) {
            if (this.f59hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
                this.f59hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.stopPreview();
                this.f59hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.release();
                this.f59hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = null;
            }
            this.sLSXXiYjDERyx7CKvO5GstTCcI8HiXXLiPYrugcXt2517h4ADL52v0RLLmUd9xMb = false;
        } else {
            try {
                this.f59hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = android.hardware.Camera.open();
                Camera.Parameters parameters = this.f59hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getParameters();
                parameters.setFlashMode("torch");
                this.f59hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setParameters(parameters);
                new SurfaceTexture(0);
                this.f59hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setPreviewTexture(surfaceTexture);
                this.f59hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.startPreview();
                this.sLSXXiYjDERyx7CKvO5GstTCcI8HiXXLiPYrugcXt2517h4ADL52v0RLLmUd9xMb = true;
