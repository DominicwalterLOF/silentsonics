...
public class MakeroidAirtable extends AndroidNonvisibleComponent {
    private String Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW;
    ...
    private String WT81i4At6dHne14KPL5TcdNiShzKisif1ehRA81016Xex9QKtWws9m2RXtqd3wpA = "Grid view";
    ...
    public MakeroidAirtable(com.google.appinventor.components.runtime.ComponentContainer r5) {
        /*
            ...
            r2.WT81i4At6dHne14KPL5TcdNiShzKisif1ehRA81016Xex9QKtWws9m2RXtqd3wpA = r3
            r2 = r0
            r3 = r1
    ...
    public void BaseId(String str) {
        String str2 = str;
        this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt = str2;
    }
    ...
    public void TableName(String str) {
        String str2 = str;
        this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW = str2;
    }
    ...
    public void GetAllData() throws Exception {
        ...
        String sb5 = sb.append(this.qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM).toString();
        try {
            new StringBuilder("https://api.airtable.com/v0/");
            new URL(sb3.append(this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt).append("/").append(this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW).append("?&view=").append(this.WT81i4At6dHne14KPL5TcdNiShzKisif1ehRA81016Xex9QKtWws9m2RXtqd3wpA).toString().replaceAll(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, "%20"));
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            HttpURLConnection httpURLConnection2 = httpURLConnection;
            httpURLConnection.setRequestProperty("Authorization", sb5);
            ...
            this.NqI9fRlBp15rsxXeNmRjOrUuQwDxdaDY0xSQj1B7T50sMWnnasnmhTtbykVZmafW = jSONArray.toString();
            this.jfz4esSp2gG8GcabwIhRTwYj9V6OBMxneQTmg596S0YedndAxvJdoaPHqPTMCjiO = httpURLConnection2.getResponseCode();
    ...
    public void GetAllWithOffset(String str, JSONArray jSONArray) {
        ...
        try {
            new StringBuilder("https://api.airtable.com/v0/");
            new URL(sb3.append(this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt).append("/").append(this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW).append("?&view=").append(this.WT81i4At6dHne14KPL5TcdNiShzKisif1ehRA81016Xex9QKtWws9m2RXtqd3wpA).append("&offset=").append(str2).toString().replaceAll(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, "%20"));
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            HttpURLConnection httpURLConnection2 = httpURLConnection;
            httpURLConnection.setRequestProperty("Authorization", sb5);
            httpURLConnection2.setRequestProperty("Content-Type", "application/json");
            ...
            this.NqI9fRlBp15rsxXeNmRjOrUuQwDxdaDY0xSQj1B7T50sMWnnasnmhTtbykVZmafW = jSONArray2.toString();
            this.jfz4esSp2gG8GcabwIhRTwYj9V6OBMxneQTmg596S0YedndAxvJdoaPHqPTMCjiO = httpURLConnection2.getResponseCode();
    ...
    public void Cell(int i, String str) throws Exception {
        ...
        String str2 = str;
        new StringBuilder(FusiontablesControl.AUTHORIZATION_HEADER_PREFIX);
        String sb4 = sb.append(this.qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM).toString();
        new StringBuilder("https://api.airtable.com/v0/");
        new URL(sb2.append(this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt).append("/").append(this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW).append("?fields[]=").append(str2).append("&view=").append(this.WT81i4At6dHne14KPL5TcdNiShzKisif1ehRA81016Xex9QKtWws9m2RXtqd3wpA).toString().replaceAll(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, "%20"));
        HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
        HttpURLConnection httpURLConnection2 = httpURLConnection;
        ...
        String string = jSONObject4.getString(CommonProperties.ID);
    ...
    public void GetCellWithOffset(String str, JSONArray jSONArray, String str2, int i) {
        ...
        try {
            new StringBuilder("https://api.airtable.com/v0/");
            new URL(sb3.append(this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt).append("/").append(this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW).append("?fields[]=").append(str4).append("&view=").append(this.WT81i4At6dHne14KPL5TcdNiShzKisif1ehRA81016Xex9QKtWws9m2RXtqd3wpA).append("&offset=").append(str3).toString().replaceAll(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, "%20"));
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            HttpURLConnection httpURLConnection2 = httpURLConnection;
            httpURLConnection.setRequestProperty("Authorization", sb5);
            httpURLConnection2.setRequestProperty("Content-Type", "application/json");
    ...
    public void setCell(int i, String str, String str2) throws Exception {
        ...
        new StringBuilder(FusiontablesControl.AUTHORIZATION_HEADER_PREFIX);
        String sb5 = sb.append(this.qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM).toString();
        new JSONArray(this.NqI9fRlBp15rsxXeNmRjOrUuQwDxdaDY0xSQj1B7T50sMWnnasnmhTtbykVZmafW);
        String string = jSONArray.getJSONObject(i - 1).getString(CommonProperties.ID);
        DataOutputStream dataOutputStream2 = null;
        try {
            new StringBuilder("https://api.airtable.com/v0/");
            new URL(sb2.append(this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt).append("/").append(this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW).append("/").append(string).toString().replaceAll(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, "%20"));
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
    ...
    public void createRow(YailList yailList, YailList yailList2) throws Exception {
        ...
        try {
            new StringBuilder("https://api.airtable.com/v0/");
            new URL(sb2.append(this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt).append("/").append(this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW).toString().replaceAll(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, "%20"));
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            new StringBuilder("{\"fields\":");
