...
public class KodularGooglePlayGames extends AndroidNonvisibleComponent implements ActivityResultListener, OnResumeListener {
            ...
            new OnCompleteListener<Player>(this) {
                ...
                public final void onComplete(Task<Player> task) {
                    ...
                    if (task2.isSuccessful()) {
                        Player player = (Player) task2.getResult();
                        int i = 0;
                        long j = 0;
                        try {
                        ...
                        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.GotPlayer(player.getDisplayName(), player.getPlayerId(), i, j);
                    }
                }
            };
            Task addOnCompleteListener = this.playersClient.getCurrentPlayer().addOnCompleteListener(this.form, onCompleteListener);
        }
    }
    ...
    private void signInSilently(boolean z) {
        ...
        new OnCompleteListener<GoogleSignInAccount>(this) {
            ...
            public final void onComplete(Task<GoogleSignInAccount> task) {
                ...
                if (task2.isSuccessful()) {
                    this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.onConnected((GoogleSignInAccount) task2.getResult());
        ...
        Task addOnCompleteListener = this.googleSignInClient.silentSignIn().addOnCompleteListener(this.form, onCompleteListener);
    }
    ...
    private void signOut() {
        ...
        Task addOnCompleteListener = this.googleSignInClient.signOut().addOnCompleteListener(this.form, onCompleteListener);
        onDisconnected();
    }
