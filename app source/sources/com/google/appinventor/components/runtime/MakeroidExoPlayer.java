...
public class MakeroidExoPlayer extends AndroidNonvisibleComponent implements AudioManager.OnAudioFocusChangeListener, Component, OnDestroyListener {
    private int MquXNtZWbdf4047WbYlKutT53l31krf70C8DMUB6GwZPFECVbiJ9LgmrYHlSNQF0 = 50;
    /* access modifiers changed from: private */
    public boolean O8YFlD3Safgd5vkxHRoLznZm2if21MG0IxIn5jepRi6FBTeulibRFlvEXsnDANgS = false;
    private String PnDqXmvCFreSiRVUA0g9XAstwDhIMcbRjkGmb4HpU47gHx12PSApiyWiV1UWvlkR = "";
    ...
    private SimpleExoPlayer f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    static /* synthetic */ String hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(MakeroidExoPlayer makeroidExoPlayer, String str) {
        String str2 = str;
        String str3 = str2;
        makeroidExoPlayer.PnDqXmvCFreSiRVUA0g9XAstwDhIMcbRjkGmb4HpU47gHx12PSApiyWiV1UWvlkR = str3;
        return str2;
    }
    ...
    public MakeroidExoPlayer(com.google.appinventor.components.runtime.ComponentContainer r12) {
        /*
            ...
            r2 = r0
            r3 = 0
            r2.O8YFlD3Safgd5vkxHRoLznZm2if21MG0IxIn5jepRi6FBTeulibRFlvEXsnDANgS = r3
            r2 = r0
            r3 = 0
            r2.isCompanion = r3
            r2 = r0
        ...
        L_0x0059:
            ...
            r2.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            r10 = r2
            r2 = r10
            r3 = r10
            r1 = r3
            com.google.android.exoplayer2.SimpleExoPlayer r2 = r2.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
    ...
    public void onDestroy() {
        try {
            if (this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
                this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.stop();
                this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.release();
                this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = null;
            }
        } catch (Exception e) {
    ...
    public void Stop() {
        try {
            ...
            if (this.isPlaying || this.isPause) {
                this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setPlayWhenReady(false);
                this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.seekTo(0);
                this.cOmDbOC978RubVhXjun4VkHg9OxeO5ZzRCTQEv8rZa8E7YdcVv7aSE4TjAXwfuwN = true;
    ...
    public void Pause() {
        try {
            if (this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null && this.isPlaying) {
                this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setPlayWhenReady(false);
                this.isPause = true;
                this.isPlaying = false;
                this.cOmDbOC978RubVhXjun4VkHg9OxeO5ZzRCTQEv8rZa8E7YdcVv7aSE4TjAXwfuwN = false;
                StatusChanged(false, true, false, this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isLoading());
            }
        } catch (Exception e) {
            int e2 = Log.e("ExoPlayer", String.valueOf(e));
        }
    ...
    public void Start() {
        try {
            if (this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
                if (this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getPlaybackState() == 4) {
                    this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.seekTo(0);
                }
                this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setPlayWhenReady(true);
                this.isPlaying = true;
                this.isPause = false;
                this.cOmDbOC978RubVhXjun4VkHg9OxeO5ZzRCTQEv8rZa8E7YdcVv7aSE4TjAXwfuwN = false;
                StatusChanged(true, false, false, this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isLoading());
                Volume(this.MquXNtZWbdf4047WbYlKutT53l31krf70C8DMUB6GwZPFECVbiJ9LgmrYHlSNQF0);
                Loop(this.O8YFlD3Safgd5vkxHRoLznZm2if21MG0IxIn5jepRi6FBTeulibRFlvEXsnDANgS);
            }
        } catch (Exception e) {
            int e2 = Log.e("ExoPlayer", String.valueOf(e));
        }
    ...
    public void Volume(int i) {
        ...
        if (this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setVolume((float) (1.0d - (Math.log((double) (100 - i2)) / Math.log(100.0d))));
        }
        this.MquXNtZWbdf4047WbYlKutT53l31krf70C8DMUB6GwZPFECVbiJ9LgmrYHlSNQF0 = i2;
    }

    @SimpleProperty(description = "Return the player volume.")
    public float Volume() {
        return (float) this.MquXNtZWbdf4047WbYlKutT53l31krf70C8DMUB6GwZPFECVbiJ9LgmrYHlSNQF0;
    }
    ...
    public boolean isLoading() {
        return this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isLoading();
    }

    @SimpleProperty(description = "Returns the duration of the source file.")
    public int Duration() {
        if (this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            return (int) this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getDuration();
        }
        return 0;
    }
    ...
    public int CurrentPosition() {
        if (this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            return (int) this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getCurrentPosition();
        }
        return 0;
    }
    ...
    public void SeekTo(int i) {
        int i2 = i;
        if (this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            int currentPosition = (int) this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getCurrentPosition();
            if (currentPosition + i2 <= ((int) this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getDuration())) {
                this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.seekTo((long) (currentPosition + i2));
            } else {
                this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.seekTo((long) currentPosition);
            }
        }
    }
    ...
    public void Source(String str) {
        ...
        String str2;
        String str3 = str;
        this.PnDqXmvCFreSiRVUA0g9XAstwDhIMcbRjkGmb4HpU47gHx12PSApiyWiV1UWvlkR = str3;
        if (str3.isEmpty()) {
            this.form.dispatchErrorOccurredEvent(this, "Source", ErrorMessages.ERROR_UNABLE_TO_LOAD_MEDIA, str3);
        } else if (this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            String str4 = this.PnDqXmvCFreSiRVUA0g9XAstwDhIMcbRjkGmb4HpU47gHx12PSApiyWiV1UWvlkR;
            String str5 = str4;
            ...
            if (z) {
                SimpleExoPlayer simpleExoPlayer = this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
                new DefaultBandwidthMeter();
                new DefaultDataSourceFactory(this.context, Util.getUserAgent(this.context, this.bg8qLM0P8YgZYqRlUjDxWnoKnWRYKRDQeEjqrx0ja4Cy7jLWl3M1lZwjImM82eG), transferListener);
                ...
                String str6 = this.PnDqXmvCFreSiRVUA0g9XAstwDhIMcbRjkGmb4HpU47gHx12PSApiyWiV1UWvlkR;
                String str7 = str6;
            ...
            String str8 = this.PnDqXmvCFreSiRVUA0g9XAstwDhIMcbRjkGmb4HpU47gHx12PSApiyWiV1UWvlkR;
            new StringBuilder();
            if (str8.contains(sb.append(this.context.getExternalFilesDir("")).toString())) {
                try {
                    new File(this.PnDqXmvCFreSiRVUA0g9XAstwDhIMcbRjkGmb4HpU47gHx12PSApiyWiV1UWvlkR);
    ...
    public void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(File file) {
        ...
        int i = Log.i("ExoPlayer", sb.append(this.PnDqXmvCFreSiRVUA0g9XAstwDhIMcbRjkGmb4HpU47gHx12PSApiyWiV1UWvlkR).toString());
        if (file2.exists()) {
        ...
        this.form.dispatchErrorOccurredEvent(this, "Source", ErrorMessages.ERROR_CANNOT_FIND_FILE, this.PnDqXmvCFreSiRVUA0g9XAstwDhIMcbRjkGmb4HpU47gHx12PSApiyWiV1UWvlkR);
    }
    ...
    public void Loop(boolean z) {
        ...
        if (this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            if (z2) {
                this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setRepeatMode(1);
            } else {
                this.f193hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setRepeatMode(0);
            }
        }
        this.O8YFlD3Safgd5vkxHRoLznZm2if21MG0IxIn5jepRi6FBTeulibRFlvEXsnDANgS = z2;
    }
