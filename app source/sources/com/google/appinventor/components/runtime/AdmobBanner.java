...
@UsesLibraries({"browser.jar", "browser.aar", "play-services-ads.jar", "play-services-ads.aar", "play-services-ads-base.jar", "play-services-ads-base.aar", "play-services-ads-identifier.jar", "play-services-ads-identifier.aar", "play-services-ads-lite.jar", "play-services-ads-lite.aar", "play-services-basement.jar", "play-services-basement.aar", "play-services-gass.jar", "play-services-gass.aar", "unity-ads.jar", "unity-ads.aar", "startapp-ads.jar"})
@SimpleObject
...
public final class AdmobBanner extends AndroidViewComponent implements OnDestroyListener, OnPauseListener, OnResumeListener {
    ...
    private MakeroidDataProtection f45hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private KodularBanner f46hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public AdmobBanner(com.google.appinventor.components.runtime.ComponentContainer r10) {
        /*
            ...
            r5 = r8
            r5.<init>()
            r3.f46hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r4
            r3 = r0
            com.google.appinventor.components.runtime.util.ads.KodularBanner r3 = r3.f46hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
            ...
            r5.<init>(r6, r7)
            r3.f45hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r4
            r3 = r0
            com.google.appinventor.components.runtime.util.MakeroidDataProtection r3 = r3.f45hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
        ...
        L_0x00c8:
            ...
            r4 = r1
            com.google.android.gms.ads.AdView r4 = r4.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
            hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(r3, r4)
            r3 = r1
    ...
    /* access modifiers changed from: private */
    public static void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(LinearLayout linearLayout2, AdView adView) {
    ...
    public final void LoadAd() {
        ...
        new Random();
        this.qPeHJnCLP0dAOwDPeFIn82vcSIsCMh6KFFn3o4kyIe0RhQKOQXDeyY2LFwPu2GbE = random.nextFloat() <= this.kodularAdsCommission.getCommision("admob", "banner");
    ...
    public final void AdUnitId(String str) {
        String str2 = str;
        if (this.adUnitId == null || this.adUnitId.equals(KodularAdsUtil.ADMOB_BANNER_TEST_ID)) {
            this.adUnitId = str2;
        }
    }
    ...
    public final void ConsentTitle(String str) {
        this.f45hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setTitle(str);
    }

    @SimpleProperty
    public final String ConsentTitle() {
        return this.f45hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getTitle();
    }
    ...
    public final void ConsentMessage(String str) {
        this.f45hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setMessage(str);
    }

    @SimpleProperty
    public final String ConsentMessage() {
        return this.f45hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getMessage();
    }
    ...
    public final void RevokeConsent() {
        this.f45hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.RevokeConsent();
    }
    ...
    public final boolean PersonalizedResult() {
        return this.f45hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getPersonalizedResult();
    }
    ...
    public final void ConsentDevelopmentMode(boolean z) {
        this.f45hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setDevelopmentMode(z);
    }

    @SimpleProperty
    public final boolean ConsentDevelopmentMode() {
        return this.f45hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getDevelopmentMode();
    }
}
