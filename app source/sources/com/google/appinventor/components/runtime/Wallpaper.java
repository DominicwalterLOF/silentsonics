...
public class Wallpaper extends AndroidNonvisibleComponent implements Component {
    ...
    class b extends AsyncTask<String, String, String> {
        private boolean WrlQqhIKmKuB9b4JVzpHXmCJrSlbkHSNA5ubvsLC9K31KYZzZrethddcAVSmF8Zp = false;
        ...
        b(Wallpaper wallpaper, boolean z) {
            ...
            this.WrlQqhIKmKuB9b4JVzpHXmCJrSlbkHSNA5ubvsLC9K31KYZzZrethddcAVSmF8Zp = z;
        }
        ...
        public String doInBackground(String... strArr) {
            try {
                ...
                if (!this.WrlQqhIKmKuB9b4JVzpHXmCJrSlbkHSNA5ubvsLC9K31KYZzZrethddcAVSmF8Zp) {
