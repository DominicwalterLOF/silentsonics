...
public final class KodularPollfish extends AndroidNonvisibleComponent implements Component, OnResumeListener, PollfishClosedListener, PollfishCompletedSurveyListener, PollfishOpenedListener, PollfishReceivedSurveyListener, PollfishSurveyNotAvailableListener, PollfishUserNotEligibleListener, PollfishUserRejectedSurveyListener {
    ...
    private String o4oEL8NAO5pXZcOSBAknA2NvsNjJJvehWW0lJ74yBWMu5XdCwoMznIBTr1ZGCAX = ComponentConstants.DEFAULT_POLLFISH_MODE;
    ...
    public KodularPollfish(com.google.appinventor.components.runtime.ComponentContainer r6) {
        /*
            ...
            java.lang.String r2 = hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME((android.content.Context) r2)
            r1 = r2
            r2 = r0
            r3 = 1
            r2.TestMode(r3)
            ...
            r2 = r4
            r3 = r4
            java.lang.String r3 = r3.o4oEL8NAO5pXZcOSBAknA2NvsNjJJvehWW0lJ74yBWMu5XdCwoMznIBTr1ZGCAX
            r2.SurveyMode(r3)
            r2 = r0
            r3 = r1
            r2.RequestUUID(r3)
    ...
    public final void APIKey(String str) {
        ...
        Runnable runnable;
        String str2 = str;
        if (!this.qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM.equals(str2)) {
                    ...
                    new Runnable(this) {
                        ...
                        public final void run() {
                            ...
                            try {
                                ...
                                Exception exc = e;
                                new StringBuilder();
                                int e2 = Log.e(KodularAnalyticsUtil.Ads.NETWORK_POLLFISH, sb.append(exc.getMessage()).toString());
                                if (0 != 0) {
    ...
    public final void SurveyMode(String str) {
        String str2 = str;
        if (!this.o4oEL8NAO5pXZcOSBAknA2NvsNjJJvehWW0lJ74yBWMu5XdCwoMznIBTr1ZGCAX.equals(str2)) {
    ...
    public final void RequestUUID(String str) {
        String str2 = str;
        if (!this.xaven5ecM0Ll2H1GHPRV82tONpToW8URGRDgxbH0b2M0q5wAsNNBDrpsKvL0qvHt.equals(str2)) {
