...
public class KodularEncrypt extends AndroidNonvisibleComponent {
    private int HBxetIRrPp5wFSU0fYFDhqCxdFt0fBh3kY2YtziyusOgRcjzKRD45EhStHcUhuz0 = 24;
    private int KmWMzrb8pAMl652ZF8qeuTq7pG7ZDLw36UnzkrmNxV5DvooPwgtf6GDSAEiAO9jG = 18;
    private String MquXNtZWbdf4047WbYlKutT53l31krf70C8DMUB6GwZPFECVbiJ9LgmrYHlSNQF0 = "";
    private int SzducuiMqWJn2qdHTwu7wT0uVCkk0nPPJy3Na6C8gzyeOLBidRCWmYhIkQdo5gq3 = 64000;
    ...
    private int xaqHe1zmXpFIxCQ2Rqyod5yEaSTeb7CYPqkTrZecvYFjGogfgX23htIKbmu7xARG = 10;
    ...
    public void PBKDF2SaltByteSize(int i) {
        int i2 = i;
        this.HBxetIRrPp5wFSU0fYFDhqCxdFt0fBh3kY2YtziyusOgRcjzKRD45EhStHcUhuz0 = i2;
    }
    ...
    public void PBKDF2HashByteSize(int i) {
        int i2 = i;
        this.KmWMzrb8pAMl652ZF8qeuTq7pG7ZDLw36UnzkrmNxV5DvooPwgtf6GDSAEiAO9jG = i2;
    }
    ...
    public void AES256Key(String str) {
        String str2 = str;
        this.ht6M5vNRogDvRYCDAZw5zQxzUwImwEpGaHRJyoKVPYuZoKA1X0CMwOko8kVy3tgl = str2;
    }
    ...
    public String PBKDF2CreateHash(String str) {
        try {
            return KodularPBKDF2.createHash(str, this.SzducuiMqWJn2qdHTwu7wT0uVCkk0nPPJy3Na6C8gzyeOLBidRCWmYhIkQdo5gq3, this.HBxetIRrPp5wFSU0fYFDhqCxdFt0fBh3kY2YtziyusOgRcjzKRD45EhStHcUhuz0, this.KmWMzrb8pAMl652ZF8qeuTq7pG7ZDLw36UnzkrmNxV5DvooPwgtf6GDSAEiAO9jG);
        } catch (Exception e) {
            int e2 = Log.e("Kodular Encrypt", String.valueOf(e));
            return "";
        }
    ...
    public String TripleDESDecode(String str) {
        try {
            return KodularTripleDES.decode(str, this.MquXNtZWbdf4047WbYlKutT53l31krf70C8DMUB6GwZPFECVbiJ9LgmrYHlSNQF0);
        } catch (Exception e) {
            int e2 = Log.e("Kodular Encrypt", String.valueOf(e));
            return "";
        }
    ...
    public String TripleDESEncode(String str) {
        try {
            return KodularTripleDES.encode(str, this.MquXNtZWbdf4047WbYlKutT53l31krf70C8DMUB6GwZPFECVbiJ9LgmrYHlSNQF0);
        } catch (Exception e) {
            int e2 = Log.e("Kodular Encrypt", String.valueOf(e));
            return "";
        }
    ...
    public String BCryptGenerateSalt() {
        try {
            return KodularBCrypt.gensalt(this.xaqHe1zmXpFIxCQ2Rqyod5yEaSTeb7CYPqkTrZecvYFjGogfgX23htIKbmu7xARG);
        } catch (Exception e) {
            int e2 = Log.e("Kodular Encrypt", String.valueOf(e));
            return "";
        }
    ...
    public String AES128Decode(String str) {
        return KodularAES128.decode(str, this.e1IHYfRNckEvpOWbFvMtuN7w9PEpZtVYShhIlzbQR8mwSxiOizA6OYtX7vMfGCUT);
    }
    ...
    public String AES128Encode(String str) {
        return KodularAES128.encode(str, this.e1IHYfRNckEvpOWbFvMtuN7w9PEpZtVYShhIlzbQR8mwSxiOizA6OYtX7vMfGCUT);
    }
    ...
    public String AES256Decode(String str) {
        return KodularAES256.decode(str, this.ht6M5vNRogDvRYCDAZw5zQxzUwImwEpGaHRJyoKVPYuZoKA1X0CMwOko8kVy3tgl, this.context);
    }
    ...
    public String AES256Encode(String str) {
        return KodularAES256.encode(str, this.ht6M5vNRogDvRYCDAZw5zQxzUwImwEpGaHRJyoKVPYuZoKA1X0CMwOko8kVy3tgl, this.context);
    }
