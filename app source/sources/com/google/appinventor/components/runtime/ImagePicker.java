...
public class ImagePicker extends Picker implements ActivityResultListener {
    ...
    public void resultReturned(int i, int i2, Intent intent) {
        ...
        if (i == this.requestCode && i3 == -1) {
            this.poblgm1P6mADk8QKAia8LTNTlp3hP9LK4vL2LyACRyn6OaTobhLhKjphCbjAETmg = B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T(intent2.getData());
            AfterPicking(this.poblgm1P6mADk8QKAia8LTNTlp3hP9LK4vL2LyACRyn6OaTobhLhKjphCbjAETmg);
        }
    }
