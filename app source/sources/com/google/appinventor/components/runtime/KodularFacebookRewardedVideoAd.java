...
public class KodularFacebookRewardedVideoAd extends AndroidNonvisibleComponent implements RewardedVideoAdListener, OnDestroyListener {
    ...
    private KodularRewardedVideo f170hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public KodularFacebookRewardedVideoAd(com.google.appinventor.components.runtime.ComponentContainer r9) {
        /*
            ...
            r4.<init>(r5)
            r2.f170hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            com.google.appinventor.components.runtime.util.ads.KodularRewardedVideo r2 = r2.f170hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
    ...
    public void ShowAd() {
        if (this.qPeHJnCLP0dAOwDPeFIn82vcSIsCMh6KFFn3o4kyIe0RhQKOQXDeyY2LFwPu2GbE) {
            if (!this.f170hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.showAd()) {
    ...
    public void PlacementID(String str) {
        String str2 = str;
        this.bEgrYPbd5peKqyXwAOBm3whGEG8qvODU2pBvqaxE9h7HUpHdWqfLhYhcIZ9UxgZV = str2;
    }
    ...
    public void CommissionRewardedAdsNetwork(String str) {
        this.f170hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.updateNetwork(str);
    }
    ...
    public void onError(Ad ad, AdError adError) {
        ...
        new StringBuilder("Facebook Rewarded Video: Video ad failed to load: ");
        int e = Log.e("Facebook Rewarded Video Ad", sb.append(adError2.getErrorMessage()).toString());
        new StringBuilder();
        Error(sb2.append(adError2.getErrorMessage()).toString());
    }
    ...
    public void onAdLoaded(Ad ad) {
        ...
        AdLoaded();
        int i = Log.i("Facebook Rewarded Video Ad", "Facebook Rewarded Video: Video ad loaded");
    }

    public void onAdClicked(Ad ad) {
        Ad ad2 = ad;
        AdOpened();
        int i = Log.i("Facebook Rewarded Video Ad", "Facebook Rewarded Video: Video ad opened");
    }

    public void onLoggingImpression(Ad ad) {
        Ad ad2 = ad;
        AdVideoStarted();
        int i = Log.i("Facebook Rewarded Video Ad", "Facebook Rewarded Video: Video started");
    }

    public void onRewardedVideoCompleted() {
        AdVideoCompleted();
        int i = Log.i("Facebook Rewarded Video Ad", "Facebook Rewarded Video: Video completed");
    }

    public void onRewardedVideoClosed() {
        AdClosed();
        int i = Log.i("Facebook Rewarded Video Ad", "Facebook Rewarded Video: Video ad closed");
    }
}
