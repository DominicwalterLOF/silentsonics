...
public class BatteryManager extends AndroidNonvisibleComponent implements Component, OnDestroyListener, OnResumeListener, OnStopListener {
    ...
    private BroadcastReceiver f48hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    static /* synthetic */ int B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T(BatteryManager batteryManager, int i) {
        int i2 = i;
        int i3 = i2;
        batteryManager.qPeHJnCLP0dAOwDPeFIn82vcSIsCMh6KFFn3o4kyIe0RhQKOQXDeyY2LFwPu2GbE = i3;
        return i2;
    }
    ...
    static /* synthetic */ int hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(BatteryManager batteryManager, int i) {
        int i2 = i;
        int i3 = i2;
        batteryManager.vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R = i3;
        return i2;
    }
    ...
    static /* synthetic */ String vSp02fkBXgM8EI0gm0rKWXHQ6wdQINJBQuAtCR15YU8g4XNqVKV8r32SYxkQYxkq(BatteryManager batteryManager, String str) {
        String str2 = str;
        String str3 = str2;
        batteryManager.wGMjbGuJ9Yk6s2LaEm8v1pEJlXt36TYBWZSsia0LUgb1yMdHNGB7uRz3VqnF79D0 = str3;
        return str2;
    }
    ...
    public BatteryManager(com.google.appinventor.components.runtime.ComponentContainer r8) {
        /*
            ...
            r5 = r0
            r4.<init>(r5)
            r2.f48hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
    ...
    public YailList GetBatteryInfo(String str) {
        ...
        if (str2.equals("all") || str2.equals("health")) {
            ...
            boolean add = list2.add(sb9.append(this.tee1T53LBirhPaiZzuBv7do2U2eC3n16AtczACNW2pKYEGgDhkkMv1hGUupyoKZE).toString());
        }
        if (str2.equals("all") || str2.equals("level")) {
            new StringBuilder("LEVEL=");
            boolean add2 = list2.add(sb8.append(this.vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R).toString());
        }
        if (str2.equals("all") || str2.equals("plugged")) {
            new StringBuilder("PLUGGED=");
            boolean add3 = list2.add(sb7.append(this.ANz72NxTeEmYo9CF87MXRUuH7WvE4u0mpZwxffTnyiMdygEQRKvmdTCHaXqAvud).toString());
        }
        ...
        if (str2.equals("all") || str2.equals(NotificationCompat.CATEGORY_STATUS)) {
            ...
            boolean add5 = list2.add(sb5.append(this.qPeHJnCLP0dAOwDPeFIn82vcSIsCMh6KFFn3o4kyIe0RhQKOQXDeyY2LFwPu2GbE).toString());
        }
        if (str2.equals("all") || str2.equals("charge_status")) {
            new StringBuilder("CHARGE_STATUS=");
            boolean add6 = list2.add(sb4.append(this.moH2L3ThNq0Qhevz3oD0wpnUoXefdMi3gJ5JHfEbjrtgsvRvpM1e34BZQYI4s5i0).toString());
        }
        if (str2.equals("all") || str2.equals("technology")) {
            new StringBuilder("TECHNOLOGY=");
            boolean add7 = list2.add(sb3.append(this.wGMjbGuJ9Yk6s2LaEm8v1pEJlXt36TYBWZSsia0LUgb1yMdHNGB7uRz3VqnF79D0).toString());
        }
    ...
    public void StartMonitoring(boolean z) {
        ...
        if (this.vOibdtOfNxMVixWab9VDGgvD9L4Kqb2ZDQBius3PMdhiP1dPN68Z9GzWJA49TUbE) {
            ...
            Intent registerReceiver = this.container.$context().registerReceiver(this.f48hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, intentFilter);
            return;
        }
    ...
    private void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME() {
        ...
        if (this.f48hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            try {
                this.container.$context().unregisterReceiver(this.f48hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME);
            } catch (Exception e) {
            }
        }
    }
