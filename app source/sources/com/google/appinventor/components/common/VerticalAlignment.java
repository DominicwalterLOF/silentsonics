...
public enum VerticalAlignment implements OptionList<Integer> {
    ...
    static {
        Map<Integer, VerticalAlignment> map;
        new HashMap();
        hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = map;
        VerticalAlignment[] values = values();
        VerticalAlignment[] verticalAlignmentArr = values;
        int length = values.length;
        for (int i = 0; i < length; i++) {
            VerticalAlignment verticalAlignment = verticalAlignmentArr[i];
            VerticalAlignment put = hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.put(verticalAlignment.toUnderlyingValue(), verticalAlignment);
        }
    }
