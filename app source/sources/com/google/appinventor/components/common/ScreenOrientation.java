...
public enum ScreenOrientation implements OptionList<String> {
    ...
    static {
        Map<String, ScreenOrientation> map;
        new HashMap();
        hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = map;
        ScreenOrientation[] values = values();
        ScreenOrientation[] screenOrientationArr = values;
        int length = values.length;
        for (int i = 0; i < length; i++) {
            ScreenOrientation screenOrientation = screenOrientationArr[i];
            ScreenOrientation put = hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.put(screenOrientation.toUnderlyingValue().toLowerCase(), screenOrientation);
        }
    }
