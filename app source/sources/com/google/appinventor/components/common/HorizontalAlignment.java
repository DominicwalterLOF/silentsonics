...
public enum HorizontalAlignment implements OptionList<Integer> {
    ...
    private static final Map<Integer, HorizontalAlignment> hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = null;
    private final int B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T;

    static {
        Map<Integer, HorizontalAlignment> map;
        new HashMap();
        hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = map;
        HorizontalAlignment[] values = values();
        HorizontalAlignment[] horizontalAlignmentArr = values;
        int length = values.length;
        for (int i = 0; i < length; i++) {
            HorizontalAlignment horizontalAlignment = horizontalAlignmentArr[i];
            HorizontalAlignment put = hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.put(horizontalAlignment.toUnderlyingValue(), horizontalAlignment);
        }
    }
