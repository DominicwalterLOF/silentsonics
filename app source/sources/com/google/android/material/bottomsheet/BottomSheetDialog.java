...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public BottomSheetDialog(@androidx.annotation.NonNull android.content.Context r9, @androidx.annotation.StyleRes int r10) {
        /*
            r8 = this;
            r0 = r8
            r1 = r9
    ...
    /* JADX WARNING: Illegal instructions before constructor call */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    protected BottomSheetDialog(@androidx.annotation.NonNull android.content.Context r10, boolean r11, android.content.DialogInterface.OnCancelListener r12) {
        /*
            r9 = this;
            r0 = r9
            r1 = r10
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.bottomsheet.BottomSheetDialog.<init>(android.content.Context, boolean, android.content.DialogInterface$OnCancelListener):void");
    }
    ...
    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        ...
        coordinator.findViewById(R.id.touch_outside).setOnClickListener(onClickListener);
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        if (themeId == 0) {
            ...
            if (context2.getTheme().resolveAttribute(R.attr.bottomSheetDialogTheme, outValue, true)) {
