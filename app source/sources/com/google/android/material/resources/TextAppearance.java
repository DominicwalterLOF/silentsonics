...
public class TextAppearance {
    ...
    public TextAppearance(Context context, @StyleRes int id) {
        ...
        TypedArray a = context2.obtainStyledAttributes(id, R.styleable.TextAppearance);
        this.textSize = a.getDimension(R.styleable.TextAppearance_android_textSize, 0.0f);
        this.textColor = MaterialResources.getColorStateList(context2, a, R.styleable.TextAppearance_android_textColor);
        this.textColorHint = MaterialResources.getColorStateList(context2, a, R.styleable.TextAppearance_android_textColorHint);
        this.textColorLink = MaterialResources.getColorStateList(context2, a, R.styleable.TextAppearance_android_textColorLink);
        ...
        this.shadowColor = MaterialResources.getColorStateList(context2, a, R.styleable.TextAppearance_android_shadowColor);
