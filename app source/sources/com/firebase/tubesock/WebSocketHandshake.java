...
class WebSocketHandshake {
    ...
    public byte[] getHandshake() {
        ...
        if (this.url.getPort() != -1) {
            new StringBuilder();
            host = sb7.append(host).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(this.url.getPort()).toString();
        }
        new LinkedHashMap();
        ...
        new StringBuilder();
        String handshake3 = sb6.append(handshake2).append("\r\n").toString();
    ...
    private String generateHeader(LinkedHashMap<String, String> linkedHashMap) {
        ...
        for (String fieldName : headers.keySet()) {
            new StringBuilder();
            header = sb.append(header).append(fieldName).append(": ").append(headers.get(fieldName)).append("\r\n").toString();
        }
        return header;
    }
