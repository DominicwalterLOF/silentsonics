...
public class ChildrenNode implements Node {
    ...
    public String getHashRepresentation(Node.HashVersion version) {
        ...
        if (!this.priority.isEmpty()) {
            ...
            StringBuilder append2 = toHash.append(this.priority.getHashRepresentation(Node.HashVersion.V1));
            StringBuilder append3 = toHash.append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR);
        }
        new ArrayList<>();
        ...
        for (NamedNode node2 : nodes) {
            ...
            if (!hashString.equals("")) {
                StringBuilder append4 = toHash.append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR);
                StringBuilder append5 = toHash.append(node2.getName().asString());
                StringBuilder append6 = toHash.append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR);
