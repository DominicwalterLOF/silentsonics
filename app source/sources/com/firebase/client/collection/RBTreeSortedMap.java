...
public class RBTreeSortedMap<K, V> extends ImmutableSortedMap<K, V> {
    ...
    /* synthetic */ RBTreeSortedMap(LLRBNode x0, Comparator x1, AnonymousClass1 r10) {
        this(x0, x1);
    ...
    private static class Builder<A, B, C> {
        ...
        public static <A, B, C> RBTreeSortedMap<A, C> buildFrom(List<A> list, Map<B, C> values2, ImmutableSortedMap.Builder.KeyTranslator<A, B> translator, Comparator<A> comparator) {
            ...
            RBTreeSortedMap<A, C> rBTreeSortedMap2 = new RBTreeSortedMap<>(builder2.root == null ? LLRBEmptyNode.getInstance() : builder2.root, comparator2, (AnonymousClass1) null);
