        ...
        new Callable<List<? extends Event>>(this) {
            ...
            public java.util.List<? extends com.firebase.client.core.view.Event> call() {
                ...
                L_0x0232:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.firebase.client.core.SyncTree.AnonymousClass11.call():java.util.List");
            }
        };
        return (List) this.persistenceManager.runInTransaction(callable);
    }
        ...
        new Callable<List<Event>>(this) {
            ...
            public java.util.List<com.firebase.client.core.view.Event> call() {
                ...
                L_0x029c:
                    ...
                    goto L_0x0266
                */
                throw new UnsupportedOperationException("Method not decompiled: com.firebase.client.core.SyncTree.AnonymousClass12.call():java.util.List");
            }
        };
        return (List) this.persistenceManager.runInTransaction(callable);
    }
