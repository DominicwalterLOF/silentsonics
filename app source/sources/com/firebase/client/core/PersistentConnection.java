...
public class PersistentConnection implements Connection.Delegate {
    ...
    static class OutstandingListen {
        ...
        /* synthetic */ OutstandingListen(RequestResultListener x0, QuerySpec x1, Tag x2, SyncTree.SyncTreeHash x3, AnonymousClass1 r16) {
            this(x0, x1, x2, x3);
            AnonymousClass1 r5 = r16;
        }
    ...
    private static class OutstandingPut {
        ...
        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        /* synthetic */ OutstandingPut(String x0, Map x1, Firebase.CompletionListener x2, AnonymousClass1 r13) {
            this(x0, x1, x2);
    ...
    private static class OutstandingDisconnect {
        ...
        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        /* synthetic */ OutstandingDisconnect(String x0, Path x1, Object x2, Firebase.CompletionListener x3, AnonymousClass1 r16) {
            this(x0, x1, x2, x3);
            AnonymousClass1 r5 = r16;
        }
    ...
    public void listen(QuerySpec querySpec, SyncTree.SyncTreeHash syncTreeHash, Tag tag, RequestResultListener requestResultListener) {
        ...
        new OutstandingListen(listener, query, tag2, currentHashFn, (AnonymousClass1) null);
    ...
    public void put(String pathString, Object data, String hash, Firebase.CompletionListener onComplete) {
        putInternal(RsaJsonWebKey.FIRST_PRIME_FACTOR_MEMBER_NAME, pathString, data, hash, onComplete);
    }
    ...
    public void onDataMessage(Map<String, Object> map) {
        ...
        if (message.containsKey("r")) {
            ResponseListener responseListener = this.requestCBHash.remove(Long.valueOf((long) ((Integer) message.get("r")).intValue()));
    ...
    public void onDisconnectPut(Path path, Object obj, Firebase.CompletionListener completionListener) {
        ...
        new OutstandingDisconnect(REQUEST_ACTION_ONDISCONNECT_PUT, path2, data, onComplete, (AnonymousClass1) null);
    ...
    public void onDisconnectMerge(Path path, Map<String, Object> map, Firebase.CompletionListener completionListener) {
        ...
        new OutstandingDisconnect(REQUEST_ACTION_ONDISCONNECT_MERGE, path2, updates, onComplete, (AnonymousClass1) null);
    ...
    public void onDisconnectCancel(Path path, Firebase.CompletionListener completionListener) {
        ...
        new OutstandingDisconnect(REQUEST_ACTION_ONDISCONNECT_CANCEL, path2, (Object) null, onComplete, (AnonymousClass1) null);
        boolean add = this.onDisconnectRequestQueue.add(obj);
    }
    ...
    private void sendOnDisconnect(String str, Path path, Object data, Firebase.CompletionListener completionListener) {
        ...
        Object put = request.put(RsaJsonWebKey.FIRST_PRIME_FACTOR_MEMBER_NAME, path.toString());
    ...
    private void sendUnlisten(OutstandingListen outstandingListen) {
        ...
        new HashMap<>();
        Map<String, Object> request = map;
        Object put = request.put(RsaJsonWebKey.FIRST_PRIME_FACTOR_MEMBER_NAME, listen.query.getPath().toString());
        Tag tag = listen.getTag();
        if (tag != null) {
            Object put2 = request.put(RsaJsonWebKey.SECOND_PRIME_FACTOR_MEMBER_NAME, listen.getQuery().getParams().getWireProtocolParams());
            Object put3 = request.put(RsaJsonWebKey.FACTOR_CRT_COEFFICIENT, Long.valueOf(tag.getTagNumber()));
        }
        sendAction("n", request, (ResponseListener) null);
    }
    ...
    private void onDataPush(String str, Map<String, Object> map) {
        ...
        if (action.equals("d") || action.equals("m")) {
            ...
            String pathString = (String) body.get(RsaJsonWebKey.FIRST_PRIME_FACTOR_MEMBER_NAME);
            Object payloadData = body.get("d");
            Long tagNumber = Utilities.longFromObject(body.get(RsaJsonWebKey.FACTOR_CRT_COEFFICIENT));
            if (tagNumber != null) {
                tag = tag2;
            ...
            String pathString2 = (String) body.get(RsaJsonWebKey.FIRST_PRIME_FACTOR_MEMBER_NAME);
            Object payloadData2 = body.get("d");
            Long tagNumber2 = Utilities.longFromObject(body.get(RsaJsonWebKey.FACTOR_CRT_COEFFICIENT));
            if (tagNumber2 != null) {
                tag3 = tag4;
            ...
            for (Map<String, Object> range : (List) payloadData2) {
                ...
                String endString = (String) range.get("e");
                if (startString != null) {
                    path3 = path5;
            ...
            new Path((String) body.get(RsaJsonWebKey.FIRST_PRIME_FACTOR_MEMBER_NAME));
    ...
    private Map<String, Object> getPutObject(String pathString, Object data, String str) {
        ...
        new HashMap();
        Map<String, Object> request = map;
        Object put = request.put(RsaJsonWebKey.FIRST_PRIME_FACTOR_MEMBER_NAME, pathString);
        Object put2 = request.put("d", data);
        if (hash != null) {
    ...
    private void putInternal(String action, String pathString, Object data, String hash, Firebase.CompletionListener onComplete) {
        ...
        long writeId = j;
        new OutstandingPut(action, request, onComplete, (AnonymousClass1) null);
    ...
    private void sendListen(OutstandingListen outstandingListen) {
        ...
        new HashMap<>();
        Map<String, Object> request = map;
        Object put = request.put(RsaJsonWebKey.FIRST_PRIME_FACTOR_MEMBER_NAME, listen.getQuery().getPath().toString());
        Tag tag = listen.getTag();
        if (tag != null) {
            Object put2 = request.put(RsaJsonWebKey.SECOND_PRIME_FACTOR_MEMBER_NAME, listen.getQuery().getParams().getWireProtocolParams());
            Object put3 = request.put(RsaJsonWebKey.FACTOR_CRT_COEFFICIENT, Long.valueOf(tag.getTagNumber()));
        ...
        sendAction(RsaJsonWebKey.SECOND_PRIME_FACTOR_MEMBER_NAME, request, responseListener);
    }
    ...
    private void sendAction(String action, Map<String, Object> message, ResponseListener onResponse) {
        ...
        new HashMap<>();
        Map<String, Object> request = map;
        Object put = request.put("r", Long.valueOf(rn));
