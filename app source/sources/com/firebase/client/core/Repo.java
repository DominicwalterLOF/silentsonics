...
public class Repo implements PersistentConnection.Delegate {
    ...
    private static class TransactionData implements Comparable<TransactionData> {
        ...
        /* synthetic */ TransactionData(Path x0, Transaction.Handler x1, ValueEventListener x2, TransactionStatus x3, boolean x4, long x5, AnonymousClass1 r26) {
            this(x0, x1, x2, x3, x4, x5);
            AnonymousClass1 r8 = r26;
        }
    ...
    public void startTransaction(Path path, Transaction.Handler handler, boolean z) {
        ...
        new TransactionData(path2, handler2, listener, TransactionStatus.INITIALIZING, applyLocally, nextTransactionOrder(), (AnonymousClass1) null);
