...
public class Utilities {
    ...
    public static ParsedUrl parseUrl(String url) throws FirebaseException {
        ...
        try {
            ...
            new URI(original);
            URI uri2 = uri;
            String pathString = uri2.getPath().replace(Marker.ANY_NON_NULL_MARKER, MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR);
            ...
            if (port != -1) {
                ...
                repoInfo3.host = sb.append(repoInfo3.host).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(port).toString();
            } else {
