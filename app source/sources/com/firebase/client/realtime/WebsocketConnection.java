...
public class WebsocketConnection {
    ...
    private class WSClientTubesock implements WSClient, WebSocketEventHandler {
        ...
        /* synthetic */ WSClientTubesock(WebsocketConnection x0, WebSocket x1, AnonymousClass1 r10) {
            this(x0, x1);
            AnonymousClass1 r3 = r10;
        }

        private WSClientTubesock(WebsocketConnection websocketConnection, WebSocket ws2) {
    ...
    private WSClient createConnection(RepoInfo repoInfo, String optLastSessionId) {
        ...
        new WSClientTubesock(this, ws, (AnonymousClass1) null);
        return client;
    }
