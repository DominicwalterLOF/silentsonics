...
public class Connection implements WebsocketConnection.Delegate {
    ...
    public void sendRequest(Map<String, Object> message) {
        ...
        Object put = request.put(RsaJsonWebKey.FACTOR_CRT_COEFFICIENT, "d");
    ...
    public void onMessage(Map<String, Object> map) {
        ...
        try {
            String messageType = (String) message.get(RsaJsonWebKey.FACTOR_CRT_COEFFICIENT);
            if (messageType == null) {
                if (this.logger.logsDebug()) {
    ...
    private void onControlMessage(Map<String, Object> map) {
        ...
        try {
            String messageType = (String) data.get(RsaJsonWebKey.FACTOR_CRT_COEFFICIENT);
            if (messageType == null) {
                if (this.logger.logsDebug()) {
                    LogWrapper logWrapper2 = this.logger;
                    new StringBuilder();
