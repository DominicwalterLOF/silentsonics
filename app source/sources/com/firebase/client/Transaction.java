...
public class Transaction {
    ...
    public static class Result {
        ...
        /* synthetic */ Result(boolean x0, Node x1, AnonymousClass1 r10) {
            this(x0, x1);
    ...
    public static Result abort() {
        ...
        new Result(false, (Node) null, (AnonymousClass1) null);
        return result2;
    }

    public static Result success(MutableData resultData) {
        Result result;
        new Result(true, resultData.getNode(), (AnonymousClass1) null);
        return result;
    }
}
