...
public final class Base64Variants {
    ...
    static {
        ...
        MIME = base64Variant;
        new Base64Variant(MIME, "MIME-NO-LINEFEEDS", ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
        MIME_NO_LINEFEEDS = base64Variant2;
        new Base64Variant(MIME, "PEM", true, '=', 64);
        PEM = base64Variant3;
        new StringBuffer(STD_BASE64_ALPHABET);
        StringBuffer stringBuffer2 = stringBuffer;
        stringBuffer2.setCharAt(stringBuffer2.indexOf(Marker.ANY_NON_NULL_MARKER), '-');
        stringBuffer2.setCharAt(stringBuffer2.indexOf("/"), '_');
        new Base64Variant("MODIFIED-FOR-URL", stringBuffer2.toString(), false, 0, (int) ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
