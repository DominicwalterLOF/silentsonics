...
public abstract class ParserBase extends ParserMinimalBase {
    ...
    public void reportOverflowInt() throws IOException, JsonParseException {
        StringBuilder sb;
        new StringBuilder();
        _reportError(sb.append("Numeric value (").append(getText()).append(") out of range of int (").append(Integer.MIN_VALUE).append(" - ").append(ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED).append(")").toString());
    }
