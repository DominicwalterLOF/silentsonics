...
public class ObjectMapper extends ObjectCodec implements Versioned, Serializable {
    ...
    public static class DefaultTypeResolverBuilder extends StdTypeResolverBuilder implements Serializable {
        ...
        public boolean useForType(com.shaded.fasterxml.jackson.databind.JavaType r5) {
            /*
                ...
                r0 = r4
                r1 = r5
                int[] r2 = com.shaded.fasterxml.jackson.databind.ObjectMapper.AnonymousClass2.$SwitchMap$com$fasterxml$jackson$databind$ObjectMapper$DefaultTyping
                r3 = r0
    ...
    public ObjectMapper enableDefaultTyping(DefaultTyping defaultTyping, JsonTypeInfo.As as) {
        ...
        return setDefaultTyping(typeResolverBuilder.init(JsonTypeInfo.Id.CLASS, (TypeIdResolver) null).inclusion(as));
    }

    public ObjectMapper enableDefaultTypingAsProperty(DefaultTyping defaultTyping, String str) {
        TypeResolverBuilder typeResolverBuilder;
        new DefaultTypeResolverBuilder(defaultTyping);
        return setDefaultTyping(typeResolverBuilder.init(JsonTypeInfo.Id.CLASS, (TypeIdResolver) null).inclusion(JsonTypeInfo.As.PROPERTY).typeProperty(str));
    }
