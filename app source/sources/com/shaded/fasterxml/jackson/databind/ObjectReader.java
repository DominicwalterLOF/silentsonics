...
public class ObjectReader extends ObjectCodec implements Versioned, Serializable {
    ...
    public void _reportUnkownFormat(DataFormatReaders dataFormatReaders, DataFormatReaders.Match match) throws JsonProcessingException {
        ...
        Throwable th2 = th;
        new StringBuilder();
        new JsonParseException(sb.append("Can not detect format from input, does not look like any of detectable formats ").append(dataFormatReaders.toString()).toString(), JsonLocation.NA);
        throw th2;
    }
    ...
    public void _reportUndetectableSource(Object obj) throws JsonProcessingException {
        ...
        Throwable th2 = th;
        new StringBuilder();
        new JsonParseException(sb.append("Can not use source of type ").append(obj.getClass().getName()).append(" with format auto-detection: must be byte- not char-based").toString(), JsonLocation.NA);
        throw th2;
    }
