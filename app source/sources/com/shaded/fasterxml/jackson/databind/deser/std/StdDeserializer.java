        ...
        if (currentToken == JsonToken.VALUE_STRING) {
            ...
            try {
                ...
                if (length > 9) {
                    ...
                    new StringBuilder();
                    throw deserializationContext2.weirdStringException(trim, cls, sb.append("Overflow: numeric value (").append(trim).append(") out of range of int (").append(Integer.MIN_VALUE).append(" - ").append(ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED).append(")").toString());
                } else if (length == 0) {
                    return 0;
                } else {
        ...
        if (currentToken == JsonToken.VALUE_STRING) {
            ...
            try {
                ...
                if (length > 9) {
                    ...
                    Class<?> cls = this._valueClass;
                    new StringBuilder();
                    throw deserializationContext2.weirdStringException(trim, cls, sb.append("Overflow: numeric value (").append(trim).append(") out of range of Integer (").append(Integer.MIN_VALUE).append(" - ").append(ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED).append(")").toString());
                } else if (length == 0) {
