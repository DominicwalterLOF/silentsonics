...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    RequestManagerRetriever() {
        ...
        Map<androidx.fragment.app.FragmentManager, SupportRequestManagerFragment> map2;
        Handler handler2;
        new HashMap();
    ...
    public SupportRequestManagerFragment getSupportRequestManagerFragment(androidx.fragment.app.FragmentManager fragmentManager) {
        ...
        androidx.fragment.app.FragmentManager fm = fragmentManager;
    ...
    /* access modifiers changed from: package-private */
    public RequestManager supportFragmentGet(Context context, androidx.fragment.app.FragmentManager fm) {
        RequestManager requestManager;
        Context context2 = context;
    ...
    public boolean handleMessage(Message message) {
        ...
        switch (message2.what) {
            case 1:
                ...
                break;
            case 2:
                Object supportFm = (androidx.fragment.app.FragmentManager) message2.obj;
                key = supportFm;
