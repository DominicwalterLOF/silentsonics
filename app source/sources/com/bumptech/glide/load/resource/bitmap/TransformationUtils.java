...
public final class TransformationUtils {
    ...
    public static Bitmap fitCenter(Bitmap bitmap, BitmapPool bitmapPool, int i, int i2) {
        ...
        if (Log.isLoggable(TAG, 2)) {
            new StringBuilder();
            int v3 = Log.v(TAG, sb.append("request: ").append(width).append(EllipticCurveJsonWebKey.X_MEMBER_NAME).append(height).toString());
            new StringBuilder();
            int v4 = Log.v(TAG, sb2.append("toFit:   ").append(toFit.getWidth()).append(EllipticCurveJsonWebKey.X_MEMBER_NAME).append(toFit.getHeight()).toString());
            new StringBuilder();
            int v5 = Log.v(TAG, sb3.append("toReuse: ").append(toReuse.getWidth()).append(EllipticCurveJsonWebKey.X_MEMBER_NAME).append(toReuse.getHeight()).toString());
            new StringBuilder();
