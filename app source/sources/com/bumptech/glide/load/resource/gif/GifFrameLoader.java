...
class GifFrameLoader {
    ...
    GifFrameLoader(FrameCallback frameCallback, GifDecoder gifDecoder2, Handler handler2, GenericRequestBuilder<GifDecoder, GifDecoder, Bitmap, Bitmap> genericRequestBuilder) {
        ...
        if (handler4 == null) {
            new FrameLoaderCallback(this, (AnonymousClass1) null);
    ...
    private class FrameLoaderCallback implements Handler.Callback {
        ...
        /* synthetic */ FrameLoaderCallback(GifFrameLoader x0, AnonymousClass1 r7) {
            this(x0);
    ...
    private static GenericRequestBuilder<GifDecoder, GifDecoder, Bitmap, Bitmap> getRequestBuilder(Context context, GifDecoder gifDecoder2, int width, int height, BitmapPool bitmapPool) {
        ...
        return Glide.with(context).using(modelLoader2, GifDecoder.class).load(gifDecoder2).as(Bitmap.class).sourceEncoder(NullEncoder.get()).decoder(resourceDecoder2).skipMemoryCache(true).diskCacheStrategy(DiskCacheStrategy.NONE).override(width, height);
    }
