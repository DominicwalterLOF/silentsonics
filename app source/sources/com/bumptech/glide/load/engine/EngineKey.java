...
class EngineKey implements Key {
    ...
    public EngineKey(String id2, Key signature2, int width2, int height2, ResourceDecoder cacheDecoder2, ResourceDecoder decoder2, Transformation transformation2, ResourceEncoder encoder2, ResourceTranscoder transcoder2, Encoder sourceEncoder2) {
        this.id = id2;
    ...
    public Key getOriginalKey() {
        ...
        if (this.originalKey == null) {
            new OriginalKey(this.id, this.signature);
    ...
    public String toString() {
        ...
        if (this.stringKey == null) {
            new StringBuilder();
            StringBuilder append = sb.append("EngineKey{").append(this.id).append('+').append(this.signature).append("+[").append(this.width).append('x').append(this.height).append("]+").append('\'');
