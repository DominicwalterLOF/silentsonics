...
final class DiskCacheWriteLocker {
    ...
    DiskCacheWriteLocker() {
        ...
        new HashMap();
        this.locks = map;
        new WriteLockPool((AnonymousClass1) null);
    ...
    private static class WriteLock {
        ...
        /* synthetic */ WriteLock(AnonymousClass1 r4) {
            this();
    ...
    private static class WriteLockPool {
        ...
        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        /* synthetic */ WriteLockPool(AnonymousClass1 r4) {
            this();
            AnonymousClass1 r1 = r4;
        }
        ...
        public WriteLock obtain() {
            ...
            synchronized (queue) {
                try {
                    ...
                    if (result == null) {
                        new WriteLock((AnonymousClass1) null);
                        result = writeLock;
                    }
                    return result;
                } catch (Throwable th) {
