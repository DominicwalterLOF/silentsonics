...
public class LruBitmapPool implements BitmapPool {
    ...
    LruBitmapPool(int i, LruPoolStrategy strategy2, Set<Bitmap.Config> allowedConfigs2) {
        ...
        new NullBitmapTracker((AnonymousClass1) null);
    ...
    private static class ThrowingBitmapTracker implements BitmapTracker {
        ...
        public void add(Bitmap bitmap) {
            ...
            if (this.bitmaps.contains(bitmap2)) {
                Throwable th2 = th;
                new StringBuilder();
                new IllegalStateException(sb.append("Can't add already added bitmap: ").append(bitmap2).append(" [").append(bitmap2.getWidth()).append(EllipticCurveJsonWebKey.X_MEMBER_NAME).append(bitmap2.getHeight()).append("]").toString());
                throw th2;
            }
    ...
    private static class NullBitmapTracker implements BitmapTracker {
        ...
        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        /* synthetic */ NullBitmapTracker(AnonymousClass1 r4) {
            this();
