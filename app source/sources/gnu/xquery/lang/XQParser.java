...
public class XQParser extends Lexer {
    ...
    static {
        ...
        new NamespaceBinding("local", XQuery.LOCAL_NAMESPACE, ns7);
    ...
    public Expression makeBinary(int i, Expression expression, Expression expression2) throws IOException, SyntaxException {
        ...
        switch (op) {
            ...
            case 412:
                ...
                break;
            case 413:
                func = makeFunctionExp("gnu.xquery.util.ArithOp", Component.DEFAULT_VALUE_FAB_ICON_NAME, Marker.ANY_NON_NULL_MARKER);
                break;
            case 414:
                func = makeFunctionExp("gnu.xquery.util.ArithOp", ReservedClaimNames.SUBJECT, "-");
                break;
            case 415:
                func = makeFunctionExp("gnu.xquery.util.ArithOp", "mul", Marker.ANY_MARKER);
                break;
            case 416:
    ...
    public Expression parseUnaryExpr() throws IOException, SyntaxException {
        ...
        if (this.curToken == 414 || this.curToken == 413) {
            ...
            int rawToken = getRawToken();
            new ApplyExp(makeFunctionExp("gnu.xquery.util.ArithOp", op == 413 ? "plus" : "minus", op == 413 ? Marker.ANY_NON_NULL_MARKER : "-"), parseUnaryExpr());
            exp = expression;
        } else {
            exp = parseUnionExpr();
        }
    ...
    public Expression parseFLWRExpression(boolean z) throws IOException, SyntaxException {
        ...
        if (match("order")) {
            ...
            for (int i3 = 0; i3 < nspecs; i3++) {
                args[2 + i3] = (Expression) specs.elementAt(i3);
            }
