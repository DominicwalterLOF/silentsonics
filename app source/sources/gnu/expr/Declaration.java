...
public class Declaration implements SourceLocator {
    ...
    public void printInfo(StringBuffer stringBuffer) {
        ...
        StringBuffer append3 = sbuf.append(this.id);
        ...
        if (this.base != null) {
            ...
            StringBuffer append12 = sbuf.append(this.base.id);
    ...
    public String toString() {
        StringBuilder sb;
        new StringBuilder();
        return sb.append("Declaration[").append(this.symbol).append('/').append(this.id).append(']').toString();
    }
