                ...
                while (true) {
                    ...
                    if (i2 < 5) {
                        ...
                        for (int k2 = 1; k2 <= i2; k2++) {
                            ...
                            new StringBuilder();
                            code.emitPutField(classType.getField(sb.append(CommonProperties.VALUE).append(k2).toString()));
                            var = var.nextDecl();
                        }
                    } else {
                        code.emitLoad(ctxVar);
                ...
                while (i2 < numMethods) {
                    ...
                    for (int k = 0; k < singleArgs; k++) {
                        ...
                        if (k > 4 || varArgs || source.max_args > 4) {
                            ...
                            new StringBuilder();
                            code.emitGetField(classType2.getDeclaredField(sb2.append(CommonProperties.VALUE).append(k + 1).toString()));
                        }
                        Type ptype = var.getType();
                        if (ptype != Type.objectType) {
