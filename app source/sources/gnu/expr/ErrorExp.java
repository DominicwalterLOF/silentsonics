...
public class ErrorExp extends Expression {
    ...
    public void compile(Compilation compilation, Target target) {
        ...
        Throwable th2 = th;
        new StringBuilder();
        new Error(sb.append(comp.getFileName()).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(comp.getLineNumber()).append(": internal error: compiling error expression: ").append(this.message).toString());
        throw th2;
    }
}
