...
public class genwrite extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public static Object lambda1isReadMacro(Object obj) {
            ...
            Object x2;
            Object l = obj;
            Object apply1 = lists.car.apply1(l);
            ...
            if (x3 == Boolean.FALSE ? (x = Scheme.isEqv.apply2(head, genwrite.Lit31)) == Boolean.FALSE ? (x2 = Scheme.isEqv.apply2(head, genwrite.Lit32)) == Boolean.FALSE ? Scheme.isEqv.apply2(head, genwrite.Lit33) == Boolean.FALSE : x2 == Boolean.FALSE : x == Boolean.FALSE : x3 == Boolean.FALSE) {
                ...
                bool = x4 ? lists.isNull(lists.cdr.apply1(l2)) ? Boolean.TRUE : Boolean.FALSE : x4 ? Boolean.TRUE : Boolean.FALSE;
            }
            return bool;
        }
        ...
        public static Object lambda3readMacroPrefix(Object obj) {
            String l;
            Object l2 = obj;
            Object apply1 = lists.car.apply1(l2);
            Object apply12 = lists.cdr.apply1(l2);
            Object head = apply1;
        ...
        public java.lang.Object lambda5wr(java.lang.Object r23, java.lang.Object r24) {
            /*
                ...
                r4 = r24
                r13 = r3
                boolean r13 = kawa.lib.lists.isPair(r13)
            ...
            L_0x0039:
                ...
                r14 = r2
                gnu.expr.GenericProc r15 = kawa.lib.lists.car
                r16 = r8
            ...
            L_0x009a:
                r13 = r11
                boolean r13 = kawa.lib.lists.isNull(r13)
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda9ppCall(Object obj, Object obj2, Object obj3, Object obj4) {
            ...
            if (col != Boolean.FALSE) {
                obj5 = lambda11ppDown(lists.cdr.apply1(expr), col$St, AddOp.$Pl.apply2(col$St, genwrite.Lit17), extra, pp$Mnitem);
            } else {
                obj5 = col;
            }
            return obj5;
        ...
        public Object lambda11ppDown(Object l, Object col1, Object obj, Object obj2, Object obj3) {
            ...
            while (true) {
                ...
                if (obj8 == Boolean.FALSE) {
                    ...
                    obj6 = rest;
                    obj7 = lambda7pr(lists.car.apply1(l2), lambda6indent(col2, obj8), lists.isNull(rest) ? AddOp.$Pl.apply2(obj5, genwrite.Lit17) : genwrite.Lit1, pp$Mnitem);
                } else {
                    obj4 = lists.isNull(l2) ? this.staticLink.lambda4out(")", obj8) : this.staticLink.lambda4out(")", lambda7pr(l2, lambda6indent(col2, this.staticLink.lambda4out(".", lambda6indent(col2, obj8))), AddOp.$Pl.apply2(obj5, genwrite.Lit17), pp$Mnitem));
                }
            }
            return obj4;
        }
        ...
        public Object lambda12ppGeneral(Object obj, Object obj2, Object obj3, Object obj4, Object obj5, Object obj6, Object obj7) {
            ...
            if (pp$Mn1 == Boolean.FALSE ? pp$Mn1 == Boolean.FALSE : !lists.isPair(obj10)) {
                obj11 = apply2;
                obj12 = obj8;
                obj13 = obj9;
                obj14 = obj10;
            } else {
                Object val1 = lists.car.apply1(obj10);
                Object rest3 = lists.cdr.apply1(obj10);
                obj11 = apply2;
                obj12 = lambda7pr(val1, lambda6indent(apply2, obj8), lists.isNull(rest3) ? AddOp.$Pl.apply2(extra, genwrite.Lit17) : genwrite.Lit1, pp$Mn1);
                obj13 = obj9;
                obj14 = rest3;
            }
            if (pp$Mn2 == Boolean.FALSE ? pp$Mn2 == Boolean.FALSE : !lists.isPair(obj14)) {
                obj15 = obj12;
                obj16 = obj13;
                obj17 = obj14;
            } else {
                Object val12 = lists.car.apply1(obj14);
                Object rest4 = lists.cdr.apply1(obj14);
                obj15 = lambda7pr(val12, lambda6indent(obj11, obj12), lists.isNull(rest4) ? AddOp.$Pl.apply2(extra, genwrite.Lit17) : genwrite.Lit1, pp$Mn2);
                obj16 = obj13;
                obj17 = rest4;
            }
        ...
        public Object lambda19pp$MnLET(Object obj, Object obj2, Object obj3) {
            ...
            return lambda12ppGeneral(expr, col, extra, x ? misc.isSymbol(lists.car.apply1(rest)) : x ? Boolean.TRUE : Boolean.FALSE, this.pp$Mnexpr$Mnlist, Boolean.FALSE, this.pp$Mnexpr);
        }
