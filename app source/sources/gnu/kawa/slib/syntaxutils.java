...
public class syntaxutils extends ModuleBody {
    ...
    static {
        ...
        Lit14 = syntaxRules4;
        new SimpleSymbol(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR);
    ...
    static Object unrewrite(Expression expression) {
        ...
        if (exp instanceof LetExp) {
            ...
            try {
                ...
                ClassCastException classCastException = e;
                Throwable th9 = th8;
                new WrongType(classCastException, ReservedClaimNames.EXPIRATION_TIME, -2, (Object) expression3);
                throw th9;
            }
            ...
            try {
                ...
                ClassCastException classCastException2 = e2;
                Throwable th10 = th7;
                new WrongType(classCastException2, ReservedClaimNames.EXPIRATION_TIME, -2, (Object) expression5);
                throw th10;
            }
            ...
            try {
                ...
                ClassCastException classCastException3 = e3;
                Throwable th11 = th6;
                new WrongType(classCastException3, ReservedClaimNames.EXPIRATION_TIME, -2, (Object) expression7);
                throw th11;
            }
            ...
            try {
                ...
                while (true) {
                    ...
                    frame3.pack = lists.cons(decl.getSymbol(), frame3.pack);
                    firstDecl = decl.nextDecl();
                }
                objArr17[0] = lists.reverse$Ex(frame3.pack);
                ...
                Throwable th12 = th5;
                new WrongType(classCastException4, ReservedClaimNames.EXPIRATION_TIME, -2, (Object) expression9);
                throw th12;
            }
            ...
            try {
                ...
                Throwable th13 = th4;
                new WrongType(classCastException5, ReservedClaimNames.EXPIRATION_TIME, -2, (Object) expression11);
                throw th13;
            }
            ...
            try {
                ...
                Throwable th14 = th3;
                new WrongType(classCastException6, ReservedClaimNames.EXPIRATION_TIME, -2, (Object) expression13);
                throw th14;
            }
            ...
            try {
                ...
                Throwable th15 = th2;
                new WrongType(classCastException7, ReservedClaimNames.EXPIRATION_TIME, -2, (Object) expression15);
                throw th15;
            }
            ...
            try {
                ...
                Throwable th16 = th;
                new WrongType(classCastException8, ReservedClaimNames.EXPIRATION_TIME, -2, (Object) expression17);
                throw th16;
            }
        } else {
            obj = exp;
    ...
    static Object unrewrite$St(Expression[] expressionArr) {
        ...
        while (true) {
            ...
            if (Scheme.numEqu.apply2(obj2, len) != Boolean.FALSE) {
                return lists.reverse$Ex(frame03.pack);
            }
            frame03.pack = lists.cons(unrewrite(exps[((Number) obj2).intValue()]), frame03.pack);
            valueOf = len;
    ...
    static Object unrewriteLet(LetExp letExp) {
        ...
        while (true) {
            ...
            if (decl != null) {
                frame13.pack = lists.cons(LList.list2(decl.getSymbol(), unrewrite(exp.inits[((Number) obj2).intValue()])), frame13.pack);
                firstDecl = decl.nextDecl();
                obj = AddOp.$Pl.apply2(obj2, Lit8);
            } else {
                objArr7[0] = lists.reverse$Ex(frame13.pack);
                Object[] objArr8 = objArr6;
