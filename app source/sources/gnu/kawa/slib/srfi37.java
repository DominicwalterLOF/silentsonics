...
public class srfi37 extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public static Object lambda1find(Object obj, Object obj2) {
            ...
            if (lists.isNull(l2)) {
                l = Boolean.FALSE;
            } else if (Scheme.applyToArgs.apply2($Qu, lists.car.apply1(l2)) != Boolean.FALSE) {
                l = lists.car.apply1(l2);
            } else {
                l = lambda1find(lists.cdr.apply1(l2), $Qu);
            }
            return l;
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:47:0x012e, code lost:
            if (kawa.lib.lists.isPair(r5.args) == false) goto L_0x0142;
         */
        ...
        public Object lambda4scanOperands(Object operands, Object seeds) {
            ...
            frame23.seeds = seeds;
            if (lists.isNull(frame23.operands)) {
    ...
    public class frame1 extends ModuleBody {
        ...
        public Object lambda10() {
            ...
            try {
                ...
                objArr5[2] = Char.make(this.name);
                Object[] objArr6 = objArr5;
                objArr6[3] = lists.car.apply1(this.args);
                Object[] objArr7 = objArr6;
    ...
    public class frame6 extends ModuleBody {
        ...
        public Object lambda23$V(Object[] argsArray) {
            LList x2 = LList.makeList(argsArray, 0);
            LList lList = x2;
            return this.staticLink.staticLink.staticLink.staticLink.lambda5scanArgs(this.staticLink.staticLink.staticLink.args, x2);
        }
        ...
        public Object lambda22() {
            ...
            try {
                ...
                objArr4[1] = this.x;
                Object[] objArr5 = objArr4;
                objArr5[2] = this.staticLink.staticLink.x;
                Object[] objArr6 = objArr5;
                objArr6[3] = this.staticLink.x;
                Object[] objArr7 = objArr6;
