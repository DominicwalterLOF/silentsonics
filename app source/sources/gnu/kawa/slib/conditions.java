...
public class conditions extends ModuleBody {
    ...
    static Object conditionTypeFieldSupertype(condition.Mntype condition$Mntype, Object obj) {
        ...
        while (true) {
            ...
            if (condition$Mntype2 == Boolean.FALSE) {
                obj2 = Boolean.FALSE;
                break;
            } else if (lists.memq(field, condition$Mntype2.fields) != Boolean.FALSE) {
    ...
    public static condition makeCondition$V(condition.Mntype mntype, Object[] argsArray) {
        ...
        while (true) {
            ...
            try {
                ...
                obj2 = arg02.getCdr();
                obj3 = Pair.make(lists.car.apply1(arg02.getCar()), obj);
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
        ...
        new condition(LList.list1(lists.cons(type, alist)));
        return condition2;
    }
    ...
    public static Object lambda1label(Object obj) {
        Object plist;
        Object plist2 = obj;
        if (lists.isNull(plist2)) {
            plist = LList.Empty;
        } else {
            plist = lists.cons(lists.cons(lists.car.apply1(plist2), lists.cadr.apply1(plist2)), lambda1label(lists.cddr.apply1(plist2)));
        }
        return plist;
    }
    ...
    public static boolean isConditionHasType(Object condition2, condition.Mntype mntype) {
        ...
        while (true) {
            ...
            try {
                ...
                conditionTypes = lists.cdr.apply1(types);
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
    ...
    static Object typeFieldAlistRef(Object type$Mnfield$Mnalist, Object obj) {
        ...
        while (true) {
            ...
            if (lists.isNull(type$Mnfield$Mnalist2)) {
                Object[] objArr = new Object[2];
            ...
            if (temp != Boolean.FALSE) {
                error$V = lists.cdr.apply1(temp);
                break;
            }
            obj2 = lists.cdr.apply1(type$Mnfield$Mnalist2);
        }
        return error$V;
    }
    ...
    public static condition extractCondition(condition condition2, condition.Mntype type) {
        ...
        while (true) {
            ...
            Object arg0 = obj;
            if (arg0 == LList.Empty) {
                new condition(LList.list1(lists.cons(mntype, LList.reverseInPlace(obj3))));
                return condition3;
            }
            Object obj4 = arg0;
            Object obj5 = obj4;
            try {
                Pair arg02 = (Pair) obj4;
                obj = arg02.getCdr();
                obj2 = Pair.make(lists.assq(arg02.getCar(), lists.cdr.apply1(entry)), obj3);
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
                new WrongType(classCastException, "arg0", -2, obj5);
    ...
    public static condition typeFieldAlist$To$Condition(Object obj) {
        ...
        while (true) {
            ...
            try {
                ...
                Object apply1 = lists.car.apply1(entry);
                Object obj8 = ((condition.Mntype) lists.car.apply1(entry)).all$Mnfields;
                ...
                while (true) {
                    ...
                    try {
                        ...
                        obj9 = Pair.make(x != Boolean.FALSE ? x : lists.cons(field, typeFieldAlistRef(type$Mnfield$Mnalist, field)), obj2);
                    } catch (ClassCastException e) {
                        ClassCastException classCastException = e;
                        Throwable th3 = th2;
    ...
    static Object checkConditionTypeFieldAlist(Object obj) {
        ...
        while (true) {
            ...
            if (lists.isNull(type$Mnfield$Mnalist)) {
                return Values.empty;
            }
            ...
            try {
                ...
                Object apply12 = lists.cdr.apply1(entry);
                ...
                while (true) {
                    ...
                    try {
                        ...
                        obj5 = Pair.make(lists.car.apply1(arg02.getCar()), obj2);
                    } catch (ClassCastException e) {
                        ClassCastException classCastException = e;
                        Throwable th6 = th5;
                ...
                while (true) {
                    ...
                    try {
                        ...
                        while (true) {
                            Object alist = obj10;
                            Object apply13 = lists.car.apply1(lists.car.apply1(alist));
                ...
                obj3 = lists.cdr.apply1(type$Mnfield$Mnalist);
            } catch (ClassCastException e5) {
                ClassCastException classCastException5 = e5;
                Throwable th10 = th;
                new WrongType(classCastException5, CommonProperties.TYPE, -2, obj4);
                throw th10;
            }
        }
    }
