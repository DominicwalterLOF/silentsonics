...
public class srfi1 extends ModuleBody {
    ...
    public static final ModuleMethod f324break;
    ...
    static {
        ...
        new SimpleSymbol(HeaderParameterNames.ZIP);
        ...
        new ModuleMethod(srfi12, ErrorLogHelper.MAX_PROPERTY_ITEM_LENGTH, Lit47, -4092);
    ...
    public static Object makeList$V(Object obj, Object[] argsArray) {
        ...
        if (lists.isNull(maybe$Mnelt)) {
            ...
            error$V = lists.car.apply1(maybe$Mnelt);
        } else {
            error$V = misc.error$V("Too many arguments to MAKE-LIST", new Object[]{lists.cons(len, maybe$Mnelt)});
        }
        Object elt = error$V;
        Object obj2 = len;
    ...
    public static Object listTabulate(Object obj, Procedure procedure) {
        ...
        while (true) {
            ...
            obj2 = lists.cons(proc.apply1(i), len2);
        }
    }
    ...
    public static LList listCopy(LList lis) {
        ...
        while (true) {
            ...
            LList p = lists.cons(lists.car.apply1(lis2), LList.Empty);
            if (prev == LList.Empty) {
                result = p;
            } else {
                LList lList2 = prev;
            ...
            prev = p;
            lList = (LList) lists.cdr.apply1(lis2);
        }
    }
        ...
        while (true) {
            ...
            if (lists.isPair(x2)) {
                ...
                if (lists.isPair(x3)) {
                    ...
                    Object lag = lists.cdr.apply1(obj4);
                    Object x4 = apply1;
                    ...
                    bool = lists.isNull(x3) ? Boolean.TRUE : Boolean.FALSE;
                }
            } else {
                bool = lists.isNull(x2) ? Boolean.TRUE : Boolean.FALSE;
            }
        }
        return bool;
    }
        ...
        while (true) {
            ...
            if (lists.isPair(x2)) {
                ...
                if (lists.isPair(x3)) {
                    ...
                    bool = lists.isNull(x3) ? Boolean.FALSE : Boolean.TRUE;
                }
            } else {
                bool = lists.isNull(x2) ? Boolean.FALSE : Boolean.TRUE;
            }
        }
        return bool;
    }
    ...
    public static Object list$Eq$V(Object obj, Object[] argsArray) {
        ...
        if (x) {
            ...
            Object apply1 = lists.car.apply1(lists);
            Object apply12 = lists.cdr.apply1(lists);
            loop0:
            while (true) {
                Object obj2 = apply12;
                Object list$Mna = apply1;
                boolean x2 = lists.isNull(obj2);
                if (x2) {
                    $Eq = x2 ? Boolean.TRUE : Boolean.FALSE;
                } else {
                    Object apply13 = lists.car.apply1(obj2);
                    Object others = lists.cdr.apply1(obj2);
                        ...
                        while (true) {
                            ...
                            if (isNullList(list$Mna2) != Boolean.FALSE) {
                                ...
                                try {
                                    ...
                                    if (x4) {
                                        Object x5 = Scheme.applyToArgs.apply3($Eq2, lists.car.apply1(list$Mna2), lists.car.apply1(obj5));
                                        if (x5 == Boolean.FALSE) {
                                            $Eq = x5;
                                            break loop0;
                                        }
                                        obj3 = lists.cdr.apply1(list$Mna2);
                                    ...
                                    ClassCastException classCastException = e;
                                    Throwable th2 = th;
                                    new WrongType(classCastException, EllipticCurveJsonWebKey.X_MEMBER_NAME, -2, obj6);
                                    throw th2;
                                }
                            }
                        }
    ...
    public static Object car$PlCdr(Object obj) {
        Object pair = obj;
        Object[] objArr = new Object[2];
        objArr[0] = lists.car.apply1(pair);
        Object[] objArr2 = objArr;
        objArr2[1] = lists.cdr.apply1(pair);
        ...
        while (true) {
            ...
            try {
                if (numbers.isZero((Number) obj4)) {
                    ...
                    obj = lists.cdr.apply1(lis2);
                    obj2 = AddOp.$Mn.apply2(obj3, Lit1);
                    lList = lists.cons(lists.car.apply1(lis2), lList2);
                }
    ...
    public static Object dropRight$Ex(Object obj, IntNum k) {
        ...
        if (lists.isPair(lead)) {
            Object obj2 = lis2;
            Object apply1 = lists.cdr.apply1(lead);
            while (true) {
                Object obj3 = apply1;
                lag = obj2;
                if (!lists.isPair(obj3)) {
            ...
            Object obj5 = obj4;
            try {
                lists.setCdr$Ex((Pair) obj4, LList.Empty);
                lis = lis2;
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
        ...
        while (true) {
            ...
            try {
                if (numbers.isZero((Number) obj5)) {
                    ...
                    LList lList4 = lList3;
                    try {
                        objArr3[0] = lists.reverse$Ex(lList3);
    ...
    public static java.lang.Object lastPair(gnu.lists.Pair r5) {
        ...
        L_0x0003:
            ...
            r2 = r3
            r3 = r2
            boolean r3 = kawa.lib.lists.isPair(r3)
    ...
    public static LList unzip1(Object lis) {
        ...
        while (true) {
            ...
            try {
                ...
                obj = arg02.getCdr();
                obj2 = Pair.make(lists.car.apply1(arg02.getCar()), obj3);
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
    ...
    public class frame extends ModuleBody {
        ...
        public static Object lambda2recur(Object lis) {
            ...
            if (srfi1.isNullList(frame02.lis) != Boolean.FALSE) {
                ...
                frame02.elt = lists.car.apply1(frame02.lis);
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda4(Object a, Object b) {
            Object[] objArr = new Object[2];
            objArr[0] = lists.cons(lists.car.apply1(this.elt), a);
            Object[] objArr2 = objArr;
            objArr2[1] = lists.cons(lists.cadr.apply1(this.elt), b);
            return misc.values(objArr2);
        }
    ...
    public class frame1 extends ModuleBody {
        ...
        public static Object lambda5recur(Object lis) {
            ...
            if (srfi1.isNullList(frame22.lis) != Boolean.FALSE) {
                ...
                frame22.elt = lists.car.apply1(frame22.lis);
    ...
    public class frame2 extends ModuleBody {
        ...
        public Object lambda7(Object a, Object b, Object c) {
            ...
            objArr2[1] = lists.cons(lists.cadr.apply1(this.elt), b);
            Object[] objArr3 = objArr2;
            objArr3[2] = lists.cons(lists.caddr.apply1(this.elt), c);
    ...
    public class frame3 extends ModuleBody {
        ...
        public static Object lambda8recur(Object lis) {
            ...
            if (srfi1.isNullList(frame42.lis) != Boolean.FALSE) {
                ...
                frame42.elt = lists.car.apply1(frame42.lis);
    ...
    public class frame4 extends ModuleBody {
        ...
        public Object lambda10(Object a, Object b, Object c, Object d) {
            ...
            objArr3[2] = lists.cons(lists.caddr.apply1(this.elt), c);
            Object[] objArr4 = objArr3;
            objArr4[3] = lists.cons(lists.cadddr.apply1(this.elt), d);
            return misc.values(objArr4);
        }
    ...
    public class frame5 extends ModuleBody {
        ...
        public static Object lambda11recur(Object lis) {
            ...
            if (srfi1.isNullList(frame62.lis) != Boolean.FALSE) {
                ...
                frame62.elt = lists.car.apply1(frame62.lis);
    ...
    public class frame6 extends ModuleBody {
        ...
        public Object lambda13(Object a, Object b, Object c, Object d, Object e) {
            ...
            objArr4[3] = lists.cons(lists.cadddr.apply1(this.elt), d);
            Object[] objArr5 = objArr4;
            objArr5[4] = lists.cons(lists.car.apply1(lists.cddddr.apply1(this.elt)), e);
    ...
    public static java.lang.Object append$Ex$V(java.lang.Object[] r19) {
        ...
        L_0x0015:
            r11 = r2
            boolean r11 = kawa.lib.lists.isPair(r11)
    ...
    public static Object appendReverse(Object rev$Mnhead, Object tail) {
        ...
        while (true) {
            ...
            obj = lists.cdr.apply1(rev$Mnhead2);
            obj2 = lists.cons(lists.car.apply1(rev$Mnhead2), obj3);
        }
    }
    ...
    public class frame55 extends ModuleBody {
        ...
        public Object lambda74recur(Object obj) {
            ...
            if (lists.isPair(lists)) {
                ...
                obj2 = srfi1.isNullList(lis) != Boolean.FALSE ? this.abort.apply1(LList.Empty) : lists.cons(lists.cdr.apply1(lis), lambda74recur(lists.cdr.apply1(lists)));
            } else {
                obj2 = LList.Empty;
            }
            return obj2;
    ...
    public class frame57 extends ModuleBody {
        ...
        public Object lambda76recur(Object lists) {
            ...
            if (lists.isPair(frame583.lists)) {
    ...
    public class frame60 extends ModuleBody {
        ...
        public Object lambda82(Object cars, Object cdrs) {
            Object[] objArr = new Object[2];
            objArr[0] = lists.cons(this.a, cars);
            Object[] objArr2 = objArr;
            objArr2[1] = lists.cons(this.d, cdrs);
            return misc.values(objArr2);
        }
    ...
    public class frame63 extends ModuleBody {
        ...
        public Object lambda85recur(Object lists) {
            ...
            if (lists.isPair(frame643.lists)) {
    ...
    public class frame67 extends ModuleBody {
        ...
        public static Object lambda92recur(Object lists) {
            ...
            if (lists.isPair(frame682.lists)) {
    ...
    public static Object count$V(Procedure procedure, Object obj, Object[] argsArray) {
        ...
        if (lists.isPair(lists)) {
            ...
            while (true) {
                ...
                obj6 = lists.cdr.apply1(lis);
                obj7 = pred.apply1(lists.car.apply1(lis)) != Boolean.FALSE ? AddOp.$Pl.apply2(i, Lit1) : i;
            }
            obj2 = i;
        }
        return obj2;
    ...
    public static Object unfoldRight(Procedure procedure, Procedure procedure2, Procedure procedure3, Object seed, Object maybe$Mntail) {
        ...
        while (true) {
            ...
            obj = g.apply1(seed2);
            obj2 = lists.cons(f.apply1(seed2), obj3);
        }
    }
        ...
        if (lists.isPair(maybe$Mntail$Mngen)) {
            ...
            if (lists.isPair(lists.cdr.apply1(maybe$Mntail$Mngen))) {
                ...
                while (true) {
                    ...
                    obj3 = g.apply1(seed);
                    obj4 = lists.cons(f.apply1(seed), obj2);
                }
            ...
            while (true) {
                ...
                obj5 = g.apply1(seed3);
                lList3 = lists.cons(f.apply1(seed3), lList);
            }
            LList lList4 = lList;
            LList lList5 = lList4;
            try {
                reverse$Ex = lists.reverse$Ex(lList4);
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
    ...
    public static Object fold$V(Procedure kons, Object obj, Object obj2, Object[] argsArray) {
        ...
        LList lists = makeList;
        if (lists.isPair(lists)) {
            obj4 = frame74.lambda14lp(lists.cons(lis1, lists), knil);
        } else {
            Object obj5 = lis1;
            Object obj6 = knil;
            while (true) {
                ...
                obj5 = lists.cdr.apply1(lis);
                obj6 = frame74.kons.apply2(lists.car.apply1(lis), obj3);
            }
            obj4 = obj3;
        }
        return obj4;
    ...
    public static Object foldRight$V(Procedure kons, Object knil, Object obj, Object[] argsArray) {
        ...
        LList lists = makeList;
        if (lists.isPair(lists)) {
            lambda18recur = frame93.lambda17recur(lists.cons(lis1, lists));
        } else {
    ...
    public class frame9 extends ModuleBody {
        ...
        public Object lambda18recur(Object obj) {
            ...
            if (srfi1.isNullList(lis) != Boolean.FALSE) {
                ...
                apply2 = this.kons.apply2(lists.car.apply1(lis), lambda18recur(lists.cdr.apply1(lis)));
            }
            return apply2;
        }
    }
    ...
    public static Object pairFoldRight$V(Procedure f, Object zero, Object obj, Object[] argsArray) {
        ...
        LList lists = makeList;
        if (lists.isPair(lists)) {
            lambda20recur = frame103.lambda19recur(lists.cons(lis1, lists));
        } else {
    ...
    public static java.lang.Object pairFold$V(gnu.mapping.Procedure r16, java.lang.Object r17, java.lang.Object r18, java.lang.Object[] r19) {
        /*
            ...
            r4 = r8
            r8 = r4
            boolean r8 = kawa.lib.lists.isPair(r8)
        ...
        L_0x0023:
            ...
            r7 = r8
            r8 = r7
            boolean r8 = kawa.lib.lists.isNull(r8)
    ...
    public static Object reduce(Procedure procedure, Object obj, Object obj2) {
        ...
        if (isNullList(lis) != Boolean.FALSE) {
            ...
            fold$V = fold$V(f, lists.car.apply1(lis), lists.cdr.apply1(lis), new Object[0]);
        }
        return fold$V;
    }
    ...
    public static Object reduceRight(Procedure f, Object obj, Object obj2) {
        ...
        if (isNullList(lis) != Boolean.FALSE) {
            ...
            lambda21recur = frame113.lambda21recur(lists.car.apply1(lis), lists.cdr.apply1(lis));
        }
    ...
    public class frame11 extends ModuleBody {
        ...
        public Object lambda21recur(Object obj, Object obj2) {
            ...
            Object lis = obj2;
            if (lists.isPair(lis)) {
                obj3 = this.f.apply2(head, lambda21recur(lists.car.apply1(lis), lists.cdr.apply1(lis)));
            } else {
                obj3 = head;
            }
            return obj3;
    ...
    public static java.lang.Object pairForEach$V(gnu.mapping.Procedure r10, java.lang.Object r11, java.lang.Object[] r12) {
        /*
            ...
            r3 = r6
            r6 = r3
            boolean r6 = kawa.lib.lists.isPair(r6)
    ...
    public static Object map$Ex$V(Procedure f, Object obj, Object[] argsArray) {
        ...
        if (lists.isPair(lists)) {
            ...
            while (true) {
                ...
                Object obj5 = obj4;
                try {
                    lists.setCar$Ex((Pair) obj4, Scheme.apply.apply3(frame123.f, lists.car.apply1(lis12), heads));
                    obj2 = lists.cdr.apply1(lis12);
                    lList2 = tails;
                } catch (ClassCastException e) {
                    ClassCastException classCastException = e;
                    Throwable th2 = th;
    ...
    public class frame12 extends ModuleBody {
        ...
        public void lambda22(Object obj) {
            ...
            Object obj3 = obj2;
            try {
                lists.setCar$Ex((Pair) obj2, this.f.apply1(lists.car.apply1(pair)));
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
    ...
    public static Object filterMap$V(Procedure f, Object obj, Object[] argsArray) {
        ...
        LList lists = makeList;
        if (lists.isPair(lists)) {
            reverse$Ex = frame133.lambda23recur(lists.cons(lis1, lists), LList.Empty);
        } else {
            Object obj2 = lis1;
            LList lList3 = LList.Empty;
            while (true) {
                ...
                Object apply1 = frame133.f.apply1(lists.car.apply1(lis));
                Object tail = lists.cdr.apply1(lis);
                Object head = apply1;
                if (head != Boolean.FALSE) {
                    obj2 = tail;
                    lList3 = lists.cons(head, lList);
                } else {
                    obj2 = tail;
                    lList3 = lList;
                }
    ...
    public class frame14 extends ModuleBody {
        ...
        public Object lambda25(Object obj, Object obj2) {
            ...
            if (srfi1.isNotPair(cars)) {
                ...
                Object obj4 = obj3;
                try {
                    lambda23recur = lists.reverse$Ex((LList) obj3);
                } catch (ClassCastException e) {
                    ClassCastException classCastException = e;
                    Throwable th2 = th;
                ...
                if (head != Boolean.FALSE) {
                    lambda23recur = this.staticLink.lambda23recur(cdrs, lists.cons(head, this.res));
                } else {
            ...
            if (isNullList(ans) != Boolean.FALSE) {
                ...
                while (true) {
                    ...
                    if (!lists.isPair(obj4)) {
                        break;
                    } else if (pred.apply1(lists.car.apply1(obj4)) != Boolean.FALSE) {
                        obj3 = obj4;
                        apply1 = lists.cdr.apply1(obj4);
                    } else {
                        Object prev2 = prev;
                        Object apply12 = lists.cdr.apply1(obj4);
                        while (true) {
                            Object lis2 = apply12;
                            if (!lists.isPair(lis2)) {
                                Object obj5 = prev2;
                                Object obj6 = obj5;
                                try {
                                    lists.setCdr$Ex((Pair) obj5, lis2);
                                    break loop1;
                                } catch (ClassCastException e) {
                                    ClassCastException classCastException = e;
                                    Throwable th3 = th;
                                ...
                                Object obj8 = obj7;
                                try {
                                    lists.setCdr$Ex((Pair) obj7, lis2);
                                    obj3 = lis2;
                                    apply1 = lists.cdr.apply1(lis2);
                                    break;
                                } catch (ClassCastException e2) {
                                    ClassCastException classCastException2 = e2;
                                    Throwable th4 = th2;
    ...
    public static Object partition(Procedure procedure, Object lis) {
        ...
        while (true) {
            ...
            if (isNullList(lis2) != Boolean.FALSE) {
                ...
                LList lList6 = lList5;
                try {
                    objArr3[0] = lists.reverse$Ex(lList5);
                    Object[] objArr4 = objArr2;
                    Object[] objArr5 = objArr4;
                    ...
                    LList lList8 = lList7;
                    try {
                        objArr6[1] = lists.reverse$Ex(lList7);
                        return misc.values(objArr5);
                    } catch (ClassCastException e) {
                        ClassCastException classCastException = e;
                        Throwable th3 = th2;
                ...
                if (pred.apply1(head) != Boolean.FALSE) {
                    obj = tail;
                    lList = lists.cons(head, lList4);
                    lList2 = lList3;
                } else {
                    obj = tail;
                    lList = lList4;
                    lList2 = lists.cons(head, lList3);
                }
            }
        }
    }
    ...
    public static Object partition$Ex(Procedure procedure, Object lis) {
        ...
        while (true) {
            ...
            if (isNotPair(obj2)) {
                ...
                try {
                    ...
                    try {
                        ...
                        Object[] objArr = new Object[2];
                        objArr[0] = lists.cdr.apply1(in$Mnhead);
                        Object[] objArr2 = objArr;
                        objArr2[1] = lists.cdr.apply1(out$Mnhead);
                        return misc.values(objArr2);
                    } catch (ClassCastException e) {
                        ClassCastException classCastException = e;
                        Throwable th5 = th2;
            ...
            } else if (pred.apply1(lists.car.apply1(obj2)) != Boolean.FALSE) {
                Pair pair6 = pair3;
                Pair pair7 = pair6;
                try {
                    lists.setCdr$Ex(pair6, obj2);
                    pair = obj2;
                    pair2 = out;
                ...
                Object obj6 = obj5;
                try {
                    lists.setCdr$Ex((Pair) obj5, obj2);
                    pair = pair3;
                    pair2 = obj2;
                    obj = lists.cdr.apply1(obj2);
    ...
    public class frame19 extends ModuleBody {
        ...
        public Object lambda30recur(Object obj) {
            ...
            if (srfi1.isNullList(lis) != Boolean.FALSE) {
                ...
                cons = tail == new$Mntail ? lis : lists.cons(x, new$Mntail);
            }
            return cons;
        }
    }
    ...
    public static LList alistCopy(Object alist) {
        ...
        while (true) {
            ...
            try {
                ...
                obj2 = Pair.make(lists.cons(lists.car.apply1(elt), lists.cdr.apply1(elt)), obj3);
            } catch (ClassCastException e) {
                ClassCastException classCastException = e;
                Throwable th2 = th;
                new WrongType(classCastException, "arg0", -2, obj5);
    ...
    public class frame23 extends ModuleBody {
        ...
        public Object lambda34recur(Object obj) {
            ...
            if (srfi1.isNullList(lis) != Boolean.FALSE) {
                ...
                Object x = lists.car.apply1(lis);
                cons = this.pred.apply1(x) != Boolean.FALSE ? lists.cons(x, lambda34recur(lists.cdr.apply1(lis))) : LList.Empty;
            }
            return cons;
        }
    }
    ...
    public static Object takeWhile$Ex(Procedure procedure, Object obj) {
        ...
        if (x == Boolean.FALSE ? pred.apply1(lists.car.apply1(lis)) != Boolean.FALSE : x == Boolean.FALSE) {
            ...
            while (true) {
                ...
                if (pred.apply1(lists.car.apply1(obj4)) != Boolean.FALSE) {
                    obj3 = obj4;
                    apply1 = lists.cdr.apply1(obj4);
                } else {
                    Object obj5 = prev;
                    Object obj6 = obj5;
                    try {
                        lists.setCdr$Ex((Pair) obj5, LList.Empty);
                        break;
                    } catch (ClassCastException e) {
                        ClassCastException classCastException = e;
                        Throwable th2 = th;
        ...
        while (true) {
            ...
            if (isNullList(lis2) != Boolean.FALSE) {
                ...
                if (pred.apply1(head) != Boolean.FALSE) {
                    ...
                    LList lList6 = lList5;
                    try {
                        objArr7[0] = lists.reverse$Ex(lList5);
    ...
    public static Object span$Ex(Procedure procedure, Object obj) {
        ...
        if (x == Boolean.FALSE ? pred.apply1(lists.car.apply1(lis)) != Boolean.FALSE : x == Boolean.FALSE) {
            ...
            while (true) {
                ...
                if (pred.apply1(lists.car.apply1(obj3)) != Boolean.FALSE) {
                    obj2 = obj3;
                    apply1 = lists.cdr.apply1(obj3);
                } else {
                    Object obj4 = prev;
    ...
    /* renamed from: break  reason: not valid java name */
    public static Object m17break(Object pred, Object lis) {
        frame24 frame242;
        new frame24();
    ...
    public static Object any$V(Procedure pred, Object lis1, Object[] argsArray) {
        ...
        if (lists.isPair(frame263.lists)) {
            ...
            try {
                boolean x = ((isNullList != Boolean.FALSE ? 1 : 0) + 1) & true;
                if (x) {
                    Object apply1 = lists.car.apply1(frame263.lis1);
                    Object apply12 = lists.cdr.apply1(frame263.lis1);
                    while (true) {
                        Object obj3 = apply12;
                        Object head = apply1;
                        if (isNullList(obj3) != Boolean.FALSE) {
                        ...
                        apply1 = lists.car.apply1(obj3);
                        apply12 = lists.cdr.apply1(obj3);
                    }
                } else {
                    obj = x ? Boolean.TRUE : Boolean.FALSE;
                }
    ...
    public static Object every$V(Procedure pred, Object lis1, Object[] argsArray) {
        ...
        if (!lists.isPair(frame273.lists)) {
            Object x = isNullList(frame273.lis1);
            if (x == Boolean.FALSE) {
                Object apply12 = lists.car.apply1(frame273.lis1);
                Object apply13 = lists.cdr.apply1(frame273.lis1);
                while (true) {
                    Object obj = apply13;
                    Object head = apply12;
                    if (isNullList(obj) == Boolean.FALSE) {
                        ...
                        apply12 = lists.car.apply1(obj);
                        apply13 = lists.cdr.apply1(obj);
                    } else {
    ...
    public static Object listIndex$V(Procedure pred, Object obj, Object[] argsArray) {
        ...
        LList lists = makeList;
        if (lists.isPair(lists)) {
            obj2 = frame303.lambda44lp(lists.cons(lis1, lists), Lit0);
        } else {
            Object obj3 = lis1;
            Object obj4 = Lit0;
            while (true) {
                ...
                try {
                    ...
                    } else if (frame303.pred.apply1(lists.car.apply1(lis)) != Boolean.FALSE) {
                        obj2 = obj5;
                        break;
                    } else {
                        obj3 = lists.cdr.apply1(lis);
    ...
    public class frame31 extends ModuleBody {
        ...
        public Object lambda46(Object obj, Object obj2) {
            ...
            boolean x = lists.isPair(heads);
            if (x) {
                obj3 = Scheme.apply.apply2(this.staticLink.pred, heads) != Boolean.FALSE ? this.n : this.staticLink.lambda44lp(tails, AddOp.$Pl.apply2(this.n, srfi1.Lit1));
            } else {
                obj3 = x ? Boolean.TRUE : Boolean.FALSE;
            }
            return obj3;
    ...
    public static Object lset$Ls$Eq$V(Procedure procedure, Object[] argsArray) {
        ...
        LList lList = makeList;
        LList lists = makeList;
        boolean x = ((lists.isPair(lists) ? 1 : 0) + true) & true;
        if (!x) {
            Object apply1 = lists.car.apply1(lists);
            Object apply12 = lists.cdr.apply1(lists);
            while (true) {
                Object obj2 = apply12;
                Object s1 = apply1;
                boolean x2 = ((lists.isPair(obj2) ? 1 : 0) + true) & true;
                if (!x2) {
                    Object apply13 = lists.car.apply1(obj2);
                    Object rest = lists.cdr.apply1(obj2);
                    Object s2 = apply13;
                    boolean x3 = s2 == s1;
    ...
    public static Object lset$Eq$V(Procedure procedure, Object[] argsArray) {
        ...
        LList lList = makeList;
        LList lists = makeList;
        boolean x = (lists.isPair(lists) + 1) & true;
        if (!x) {
            Object apply1 = lists.car.apply1(lists);
            Object apply12 = lists.cdr.apply1(lists);
            while (true) {
                Object obj2 = apply12;
                Object s1 = apply1;
                boolean x2 = (lists.isPair(obj2) + 1) & true;
                if (!x2) {
                    Object apply13 = lists.car.apply1(obj2);
                    Object rest = lists.cdr.apply1(obj2);
                    Object s2 = apply13;
    ...
    public class frame33 extends ModuleBody {
        ...
        public Object lambda49(Object elt, Object obj) {
            ...
            if (srfi1.any$V(frame343.lambda$Fn33, ans, new Object[0]) != Boolean.FALSE) {
                ...
                cons = lists.cons(frame343.elt, ans);
            }
            return cons;
        }
    ...
    public class frame35 extends ModuleBody {
        ...
        public Object lambda52(Object obj, Object obj2) {
            ...
            frame363.elt = lists.car.apply1(pair);
    ...
    public static Object lsetIntersection$V(Procedure $Eq, Object obj, Object[] argsArray) {
        ...
        if (any$V(null$Mnlist$Qu, frame373.lists, new Object[0]) != Boolean.FALSE) {
            filter2 = LList.Empty;
        } else if (lists.isNull(frame373.lists)) {
            filter2 = lis1;
        } else {
    ...
    public static Object lsetIntersection$Ex$V(Procedure $Eq, Object obj, Object[] argsArray) {
        ...
        } else if (lists.isNull(frame393.lists)) {
            filter$Ex2 = lis1;
        } else {
    ...
    public static Object lsetDifference$V(Procedure $Eq, Object obj, Object[] argsArray) {
        ...
        LList lists = LList.makeList(argsArray, 0);
        LList lList = lists;
        frame413.lists = filter(lists.pair$Qu, lists);
        return lists.isNull(frame413.lists) ? lis1 : lists.memq(lis1, frame413.lists) != Boolean.FALSE ? LList.Empty : filter(frame413.lambda$Fn41, lis1);
    }
    ...
    public static Object lsetDifference$Ex$V(Procedure $Eq, Object obj, Object[] argsArray) {
        ...
        LList lists = LList.makeList(argsArray, 0);
        LList lList = lists;
        frame433.lists = filter(lists.pair$Qu, lists);
        return lists.isNull(frame433.lists) ? lis1 : lists.memq(lis1, frame433.lists) != Boolean.FALSE ? LList.Empty : filter$Ex(frame433.lambda$Fn43, lis1);
    }
    ...
    public class frame46 extends ModuleBody {
        ...
        public Object lambda64(Object obj, Object aIntB) {
            ...
            if (lists.isNull(a$Mnb)) {
                fold$V = srfi1.lsetDifference$V(this.staticLink.$Eq, this.b, new Object[]{this.a});
            } else if (lists.isNull(frame473.a$Mnint$Mnb)) {
                Object[] objArr = new Object[2];
                objArr[0] = this.b;
                Object[] objArr2 = objArr;
                objArr2[1] = this.a;
                ...
                fold$V = srfi1.fold$V(frame473.lambda$Fn48, a$Mnb, this.b, new Object[0]);
            }
            return fold$V;
        }
    ...
    public class frame49 extends ModuleBody {
        ...
        public Object lambda68(Object obj, Object aIntB) {
            ...
            if (lists.isNull(a$Mnb)) {
                pairFold$V = srfi1.lsetDifference$Ex$V(this.staticLink.$Eq, this.b, new Object[]{this.a});
            } else if (lists.isNull(frame503.a$Mnint$Mnb)) {
                Object[] objArr = new Object[2];
                objArr[0] = this.b;
                Object[] objArr2 = objArr;
                objArr2[1] = this.a;
                ...
                pairFold$V = srfi1.pairFold$V(frame503.lambda$Fn52, a$Mnb, this.b, new Object[0]);
            }
            return pairFold$V;
        }
    ...
    public static Object lsetDiff$PlIntersection$V(Procedure $Eq, Object obj, Object[] argsArray) {
        ...
        } else if (lists.memq(lis1, frame513.lists) != Boolean.FALSE) {
            Object[] objArr3 = new Object[2];
            objArr3[0] = LList.Empty;
            Object[] objArr4 = objArr3;
            objArr4[1] = lis1;
    ...
    public static Object lsetDiff$PlIntersection$Ex$V(Procedure $Eq, Object obj, Object[] argsArray) {
        ...
        } else if (lists.memq(lis1, frame533.lists) != Boolean.FALSE) {
            Object[] objArr3 = new Object[2];
            objArr3[0] = LList.Empty;
            Object[] objArr4 = objArr3;
            objArr4[1] = lis1;
