...
public class XDataType extends Type implements TypeValue {
    ...
    static {
        ...
        new XDataType("string", ClassType.make("java.lang.CharSequence"), 38);
        stringType = xDataType3;
        new XDataType("String", ClassType.make("java.lang.String"), 38);
        stringStringType = xDataType4;
        new XDataType("string", ClassType.make("gnu.kawa.xml.UntypedAtomic"), 37);
        ...
        new XDataType("boolean", Type.booleanType, 31);
        ...
        new XDataType(DoubleTypedProperty.TYPE, ClassType.make("java.lang.Double"), 19);
