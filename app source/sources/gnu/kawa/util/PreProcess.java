                        ...
                        if (buf[firstNonSpace2] == 35) {
                            ...
                            if ("#ifdef".equals(cmd) || "#ifndef".equals(cmd)) {
                                if (obj == null) {
                                    PrintStream printStream = System.err;
                                    new StringBuilder();
                                    printStream.println(sb.append(filename2).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(this.lineno).append(": warning - undefined keyword: ").append(rest).toString());
                                    obj = Boolean.FALSE;
                                }
                                nesting++;
                                if (skipNesting > 0) {
