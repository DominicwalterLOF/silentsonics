...
public class NamedUnit extends Unit implements Externalizable {
    ...
    public void init() {
        ...
        int index = (this.name.hashCode() & ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) % table.length;
    ...
    public static NamedUnit lookup(String name2) {
        ...
        NamedUnit namedUnit = table[(name3.hashCode() & ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) % table.length];
        while (true) {
