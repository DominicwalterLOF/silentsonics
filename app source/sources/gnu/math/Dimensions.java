...
public class Dimensions {
    ...
    private void enterHash(int i) {
        ...
        int index = (hash_code2 & ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) % hashTable.length;
    ...
    public static Dimensions product(Dimensions dimensions, int i, Dimensions dimensions2, int i2) {
        ...
        Dimensions dimensions3 = hashTable[(hash & ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) % hashTable.length];
        while (true) {
