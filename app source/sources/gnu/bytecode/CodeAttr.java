    ...
    public final void emitFi() {
        ...
        if (!this.if_stack.doing_else) {
            if (reachableHere() && this.SP != this.if_stack.start_stack_size) {
                Throwable th3 = th2;
                new StringBuilder();
                new Error(sb2.append("at PC ").append(this.PC).append(" then clause grows stack with no else clause").toString());
                throw th3;
            }
            ...
            if (!reachableHere()) {
                ...
                Throwable th4 = th;
                new StringBuilder();
                new Error(sb.append("at PC ").append(this.PC).append(": SP at end of 'then' was ").append(then_clause_stack_size).append(" while SP at end of 'else' was ").append(this.SP).toString());
                throw th4;
            }
