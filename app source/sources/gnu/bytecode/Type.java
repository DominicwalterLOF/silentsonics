...
public abstract class Type implements java.lang.reflect.Type {
    ...
    static {
        ...
        intType = primType3;
        new PrimType(LongTypedProperty.TYPE, "J", 8, Long.TYPE);
        longType = primType4;
        new PrimType(PropertyTypeConstants.PROPERTY_TYPE_FLOAT, "F", 4, Float.TYPE);
        floatType = primType5;
        new PrimType(DoubleTypedProperty.TYPE, "D", 8, Double.TYPE);
        doubleType = primType6;
        new PrimType("boolean", "Z", 1, Boolean.TYPE);
        ...
        Type put4 = mapNameToType.put(LongTypedProperty.TYPE, longType);
        Type put5 = mapNameToType.put(PropertyTypeConstants.PROPERTY_TYPE_FLOAT, floatType);
        Type put6 = mapNameToType.put(DoubleTypedProperty.TYPE, doubleType);
        Type put7 = mapNameToType.put("boolean", booleanType);
