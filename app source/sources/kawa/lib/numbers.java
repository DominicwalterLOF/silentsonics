    ...
    public static Object divAndMod(RealNum realNum, RealNum realNum2) {
        ...
        try {
            ...
            try {
                ...
                ClassCastException classCastException = e;
                Throwable th3 = th2;
                new WrongType(classCastException, RsaJsonWebKey.PRIME_FACTOR_OTHER_MEMBER_NAME, -2, obj2);
                throw th3;
            }
        } catch (ClassCastException e2) {
            ClassCastException classCastException2 = e2;
            Throwable th4 = th;
            new WrongType(classCastException2, RsaJsonWebKey.SECOND_PRIME_FACTOR_MEMBER_NAME, -2, obj);
            throw th4;
        }
    }
        ...
        switch (moduleMethod2.selector) {
            ...
            case 26:
                try {
                    ...
                    ClassCastException classCastException11 = e11;
                    Throwable th47 = th26;
                    new WrongType(classCastException11, ReservedClaimNames.EXPIRATION_TIME, 1, obj2);
                    throw th47;
                }
            case 27:
                try {
