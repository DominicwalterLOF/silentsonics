...
public class misc_syntax extends ModuleBody {
    ...
    static Object lambda1(Object obj) {
        ...
        if (Lit1.match(form2, allocVars, 0)) {
            ...
            try {
                ...
                form = lists.cons(execute, lists.cons(std_syntax.datum$To$SyntaxObject(obj3, misc.string$To$Symbol(strings.stringAppend(objArr4))), Lit4.execute(allocVars, TemplateScope.make())));
    ...
    static Object lambda3(Object obj) {
        ...
        if (Lit13.match(x2, allocVars, 0)) {
            ...
            Object obj4 = obj3;
            try {
                frame3.p = ports.openInputFile(Path.valueOf(obj3));
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda4f() {
            ...
            if (ports.isEofObject(x)) {
                Object closeInputPort = ports.closeInputPort(this.p);
                lList2 = LList.Empty;
            } else {
                lList2 = lList;
                new Pair(std_syntax.datum$To$SyntaxObject(this.k, x), lambda4f());
            }
            return lList2;
        }
    }
