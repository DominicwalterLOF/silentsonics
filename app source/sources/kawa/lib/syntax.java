...
public class syntax extends ModuleBody {
    ...
    public static final Macro f330import = Macro.make(Lit36, Lit37, $instance);
    ...
    public static final Macro f331synchronized;
    ...
    static {
        ...
        new SimpleSymbol(EllipticCurveJsonWebKey.X_MEMBER_NAME);
        ...
        f331synchronized = Macro.make(Lit25, procedure2, $instance);
    ...
    public static Object importHandleRename(Object obj, Object obj2) {
        ...
        if (!lists.isPair(rename$Mnpairs)) {
            name = name2;
        } else if (name2 == lists.caar.apply1(rename$Mnpairs)) {
            name = lists.cadar.apply1(rename$Mnpairs);
        } else {
            name = importHandleRename(name2, lists.cdr.apply1(rename$Mnpairs));
        }
        return name;
    }
        ...
        public Object lambda1(Object name) {
            ...
            while (true) {
                ...
                if (x) {
                    ...
                    obj3 = Scheme.applyToArgs.apply3(lists.caar.apply1(l), obj, lists.cdar.apply1(l));
    ...
    static Object lambda4(Object obj) {
        ...
        if (Lit39.match(form2, allocVars, 0)) {
            if (isIdentifierPairList(Lit40.execute(allocVars, TemplateScope.make()))) {
                ...
                objArr9[0] = lists.cons(lists.cons(import$Mnhandle$Mnrename, Lit42.execute(allocVars, make)), Lit43.execute(allocVars, make));
                Object[] objArr10 = objArr9;
            ...
            if (isIdentifierList(Lit47.execute(allocVars, TemplateScope.make()))) {
                ...
                objArr16[0] = lists.cons(lists.cons(import$Mnhandle$Mnonly, Lit49.execute(allocVars, make2)), Lit50.execute(allocVars, make2));
                Object[] objArr17 = objArr16;
            ...
            if (isIdentifierList(Lit54.execute(allocVars, TemplateScope.make()))) {
                ...
                objArr23[0] = lists.cons(lists.cons(import$Mnhandle$Mnexcept, Lit56.execute(allocVars, make3)), Lit57.execute(allocVars, make3));
                Object[] objArr24 = objArr23;
            ...
            objArr30[0] = lists.cons(lists.cons(import$Mnhandle$Mnprefix, Lit62.execute(allocVars, make4)), Lit63.execute(allocVars, make4));
            Object[] objArr31 = objArr30;
