...
public class srfi95 extends ModuleBody {
    ...
    public static Object isSorted(Object obj, Object obj2, Object obj3) {
        ...
        } else if (lists.isNull(lists.cdr.apply1(seq2))) {
            seq = Boolean.TRUE;
        } else {
            Object apply22 = Scheme.applyToArgs.apply2(key, lists.car.apply1(seq2));
            Object apply1 = lists.cdr.apply1(seq2);
            while (true) {
                Object obj12 = apply1;
                Object last = apply22;
                boolean x4 = lists.isNull(obj12);
                if (x4) {
                    seq = x4 ? Boolean.TRUE : Boolean.FALSE;
                } else {
                    Object nxt2 = Scheme.applyToArgs.apply2(key, lists.car.apply1(obj12));
                    ...
                    try {
                        ...
                        Throwable th8 = th;
                        new WrongType(classCastException4, EllipticCurveJsonWebKey.X_MEMBER_NAME, -2, obj13);
                        throw th8;
                    }
                }
            }
    ...
    public static Object merge(Object obj, Object obj2, Object isLess, Object key) {
        ...
        if (lists.isNull(a2)) {
            a = b;
        } else if (lists.isNull(b)) {
            a = a2;
        } else {
            a = frame3.lambda1loop(lists.car.apply1(a2), Scheme.applyToArgs.apply2(frame3.key, lists.car.apply1(a2)), lists.cdr.apply1(a2), lists.car.apply1(b), Scheme.applyToArgs.apply2(frame3.key, lists.car.apply1(b)), lists.cdr.apply1(b));
        }
        return a;
    }
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda1loop(Object obj, Object obj2, Object obj3, Object obj4, Object obj5, Object obj6) {
            ...
            if (Scheme.applyToArgs.apply3(this.less$Qu, ky, kx) != Boolean.FALSE) {
                if (lists.isNull(b)) {
                    cons = lists.cons(y, lists.cons(x, a));
                } else {
                    cons = lists.cons(y, lambda1loop(x, kx, a, lists.car.apply1(b), Scheme.applyToArgs.apply2(this.key, lists.car.apply1(b)), lists.cdr.apply1(b)));
                }
            } else if (lists.isNull(a)) {
                cons = lists.cons(x, lists.cons(y, b));
            } else {
                cons = lists.cons(x, lambda1loop(lists.car.apply1(a), Scheme.applyToArgs.apply2(this.key, lists.car.apply1(a)), lists.cdr.apply1(a), y, ky, b));
            }
            return cons;
        }
    }
    ...
    public class frame1 extends ModuleBody {
        ...
        public Object lambda3loop(Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
            ...
            if (Scheme.applyToArgs.apply3(this.less$Qu, kcarb, kcara) != Boolean.FALSE) {
                ...
                Object obj7 = obj6;
                try {
                    lists.setCdr$Ex((Pair) obj6, b);
                    if (lists.isNull(lists.cdr.apply1(b))) {
                        Object obj8 = b;
                        Object obj9 = obj8;
                        try {
                            lists.setCdr$Ex((Pair) obj8, a);
                        ...
                        lambda3loop = lambda3loop(b, a, kcara, lists.cdr.apply1(b), Scheme.applyToArgs.apply2(this.key, lists.cadr.apply1(b)));
                    }
                } catch (ClassCastException e2) {
                    ClassCastException classCastException2 = e2;
                    Throwable th6 = th3;
                ...
                Object obj11 = obj10;
                try {
                    lists.setCdr$Ex((Pair) obj10, a);
                    if (lists.isNull(lists.cdr.apply1(a))) {
                        Object obj12 = a;
                        Object obj13 = obj12;
                        try {
                            lists.setCdr$Ex((Pair) obj12, b);
                            lambda3loop = Values.empty;
                        } catch (ClassCastException e3) {
                            ClassCastException classCastException3 = e3;
                            Throwable th7 = th2;
                        ...
                        lambda3loop = lambda3loop(a, lists.cdr.apply1(a), Scheme.applyToArgs.apply2(this.key, lists.cadr.apply1(a)), b, kcarb);
                    }
                } catch (ClassCastException e4) {
                    ClassCastException classCastException4 = e4;
                    Throwable th8 = th;
    ...
    static Object sort$ClMerge$Ex(Object obj, Object obj2, Object isLess, Object key) {
        ...
        if (lists.isNull(a2)) {
            ...
            Object apply2 = Scheme.applyToArgs.apply2(frame13.key, lists.car.apply1(a2));
            Object kcarb = Scheme.applyToArgs.apply2(frame13.key, lists.car.apply1(b));
            Object kcara = apply2;
            if (Scheme.applyToArgs.apply3(frame13.less$Qu, kcarb, kcara) != Boolean.FALSE) {
                if (lists.isNull(lists.cdr.apply1(b))) {
                    ...
                    Object lambda3loop = frame13.lambda3loop(b, a2, kcara, lists.cdr.apply1(b), Scheme.applyToArgs.apply2(frame13.key, lists.cadr.apply1(b)));
                }
                a = b;
            } else {
                if (lists.isNull(lists.cdr.apply1(a2))) {
                    Object obj5 = a2;
                    Object obj6 = obj5;
                    try {
                        lists.setCdr$Ex((Pair) obj5, b);
                    } catch (ClassCastException e2) {
                        ClassCastException classCastException2 = e2;
                        Throwable th4 = th;
                    ...
                    Object lambda3loop2 = frame13.lambda3loop(a2, lists.cdr.apply1(a2), Scheme.applyToArgs.apply2(frame13.key, lists.cadr.apply1(a2)), b, kcarb);
                }
                a = a2;
            }
        }
    ...
    public static Object $PcSortList(Object seq, Object isLess, Object obj) {
        ...
        if (key != Boolean.FALSE) {
            ...
            while (true) {
                ...
                Object obj5 = obj4;
                try {
                    lists.setCar$Ex((Pair) obj4, lists.cons(Scheme.applyToArgs.apply2(key, lists.car.apply1(lst)), lists.car.apply1(lst)));
                    obj3 = lists.cdr.apply1(lst);
                } catch (ClassCastException e) {
                    ClassCastException classCastException = e;
                    Throwable th5 = th4;
            ...
            Object lst2 = obj6;
            try {
                frame05.seq = frame06.lambda2step(Integer.valueOf(lists.length((LList) obj6)));
                Object obj7 = frame03.seq;
                while (true) {
                    Object lst3 = obj7;
                    if (lists.isNull(lst3)) {
                        break;
                    }
                    Object obj8 = lst3;
                    Object obj9 = obj8;
                    try {
                        lists.setCar$Ex((Pair) obj8, lists.cdar.apply1(lst3));
                        obj7 = lists.cdr.apply1(lst3);
                    } catch (ClassCastException e2) {
                        ClassCastException classCastException2 = e2;
                        Throwable th6 = th3;
            ...
            Object obj11 = obj10;
            try {
                seq2 = frame07.lambda2step(Integer.valueOf(lists.length((LList) obj10)));
            } catch (ClassCastException e4) {
                ClassCastException classCastException4 = e4;
                Throwable th8 = th;
        ...
        public Object lambda2step(Object obj) {
            ...
            if (Scheme.numGrt.apply2(n, srfi95.Lit1) != Boolean.FALSE) {
                ...
                if (Scheme.applyToArgs.apply3(this.less$Qu, Scheme.applyToArgs.apply2(this.keyer, y), Scheme.applyToArgs.apply2(this.keyer, x)) != Boolean.FALSE) {
                    ...
                    Object obj4 = obj3;
                    try {
                        lists.setCar$Ex((Pair) obj3, y);
                        Object apply13 = lists.cdr.apply1(p);
                        Object obj5 = apply13;
                        try {
                            lists.setCar$Ex((Pair) apply13, x);
                        } catch (ClassCastException e) {
                            ClassCastException classCastException = e;
                            Throwable th5 = th4;
                            new WrongType(classCastException, "set-car!", 1, obj5);
                ...
                Object apply14 = lists.cdr.apply1(p);
                Object obj6 = apply14;
                try {
                ...
                Object obj8 = obj7;
                try {
                    lists.setCdr$Ex((Pair) obj7, LList.Empty);
                    obj2 = p2;
                } catch (ClassCastException e4) {
                    ClassCastException classCastException4 = e4;
                    Throwable th8 = th;
    ...
    static Object rank$Mn1Array$To$List(Sequence sequence) {
        ...
        for (int idx = seq.size() - 1; idx >= 0; idx--) {
            seq2 = lists.cons(seq.get(idx), seq2);
        }
        return seq2;
    }
    ...
    public static Object sort$Ex(Sequence sequence, Object obj, Object obj2) {
        ...
        if (lists.isList(seq)) {
            ...
            if (ret != seq) {
                ...
                while (true) {
                    crt = obj3;
                    if (lists.cdr.apply1(crt) == seq) {
                        break;
                    }
                    obj3 = lists.cdr.apply1(crt);
                }
                Object obj4 = crt;
                Object obj5 = obj4;
                try {
                    lists.setCdr$Ex((Pair) obj4, ret);
                    Object apply1 = lists.car.apply1(seq);
                    Object scdr = lists.cdr.apply1(seq);
                    Object scar = apply1;
                    Sequence sequence2 = seq;
                    Sequence sequence3 = sequence2;
                    try {
                        lists.setCar$Ex((Pair) sequence2, lists.car.apply1(ret));
                        Sequence sequence4 = seq;
                        Sequence sequence5 = sequence4;
                        try {
                            lists.setCdr$Ex((Pair) sequence4, lists.cdr.apply1(ret));
                            Object obj6 = ret;
                            Object obj7 = obj6;
                            try {
                                lists.setCar$Ex((Pair) obj6, scar);
                                Object obj8 = ret;
                                Object obj9 = obj8;
                                try {
                                    lists.setCdr$Ex((Pair) obj8, scdr);
                                } catch (ClassCastException e) {
                                    ClassCastException classCastException = e;
                                    Throwable th6 = th5;
                                    new WrongType(classCastException, "set-cdr!", 1, obj9);
    ...
    public static Object $PcVectorSort$Ex(Sequence sequence, Object less$Qu, Object key) {
        ...
        while (true) {
            ...
            Object obj3 = seq.set(((Number) obj2).intValue(), lists.car.apply1(sorted));
            $PcSortList = lists.cdr.apply1(sorted);
    ...
    public static void $PcSortVector(Sequence sequence, Object less$Qu, Object key) {
        ...
        while (true) {
            ...
            if (!lists.isNull(sorted)) {
                ...
                Object obj4 = obj3;
                try {
                    vectors.vectorSet$Ex(newra, ((Number) obj3).intValue(), lists.car.apply1(sorted));
                    $PcSortList = lists.cdr.apply1(sorted);
                    obj = AddOp.$Pl.apply2(obj2, Lit2);
                } catch (ClassCastException e) {
                    ClassCastException classCastException = e;
