    ...
    static synchronized HashMap<String, Type> getTypeMap() {
        ...
        synchronized (Scheme.class) {
            if (types == null) {
                ...
                Type put29 = types.put("string", LangObjType.stringType);
                ...
                Type put37 = types.put(CommonProperties.TYPE, LangObjType.typeType);
