...
@RequiresApi(21)
/* renamed from: androidx.cardview.widget.RoundRectDrawable */
class C0008RoundRectDrawable extends Drawable {
    ...
    C0008RoundRectDrawable(ColorStateList backgroundColor, float radius) {
        Paint paint;
        RectF rectF;
        Rect rect;
        this.mRadius = radius;
    ...
    private void updateBounds(Rect rect) {
        ...
        if (this.mInsetForPadding) {
            float vInset = C0009RoundRectDrawableWithShadow.calculateVerticalPadding(this.mPadding, this.mRadius, this.mInsetForRadius);
            this.mBoundsI.inset((int) Math.ceil((double) C0009RoundRectDrawableWithShadow.calculateHorizontalPadding(this.mPadding, this.mRadius, this.mInsetForRadius)), (int) Math.ceil((double) vInset));
