...
/* renamed from: androidx.cardview.widget.RoundRectDrawableWithShadow */
class C0009RoundRectDrawableWithShadow extends Drawable {
    ...
    /* renamed from: androidx.cardview.widget.RoundRectDrawableWithShadow$RoundRectHelper */
    interface RoundRectHelper {
        void drawRoundRect(Canvas canvas, RectF rectF, float f, Paint paint);
    }

    C0009RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius, float shadowSize, float maxShadowSize) {
        Paint paint;
        Paint paint2;
        RectF rectF;
        Paint paint3;
        Resources resources2 = resources;
        this.mShadowStartColor = resources2.getColor(R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources2.getColor(R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources2.getDimensionPixelSize(R.dimen.cardview_compat_inset_shadow);
        new Paint(5);
        this.mPaint = paint;
    ...
    private void setShadowSize(float f, float f2) {
        ...
        if (shadowSize < 0.0f) {
            ...
            if (this.mRawShadowSize != shadowSize2 || this.mRawMaxShadowSize != maxShadowSize2) {
                ...
                this.mShadowSize = (float) ((int) ((shadowSize2 * 1.5f) + ((float) this.mInsetShadow) + 0.5f));
                this.mDirty = true;
                invalidateSelf();
            }
        }
    ...
    static float calculateVerticalPadding(float f, float f2, boolean addPaddingForCorners) {
        ...
        if (addPaddingForCorners) {
            return (float) (((double) (maxShadowSize * 1.5f)) + ((1.0d - COS_45) * ((double) cornerRadius)));
        }
    ...
    public float getMinHeight() {
        return (2.0f * Math.max(this.mRawMaxShadowSize, this.mCornerRadius + ((float) this.mInsetShadow) + ((this.mRawMaxShadowSize * 1.5f) / 2.0f))) + (((this.mRawMaxShadowSize * 1.5f) + ((float) this.mInsetShadow)) * 2.0f);
    }
