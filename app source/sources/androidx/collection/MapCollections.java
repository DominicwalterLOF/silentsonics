...
abstract class MapCollections<K, V> {
    ...
    final class ArrayIterator<T> implements Iterator<T> {
        ...
        ArrayIterator(MapCollections mapCollections, int offset) {
    ...
    final class MapIterator implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public boolean equals(Object obj) {
            ...
            if (!this.mEntryValid) {
                ...
                return ContainerHelpers.equal(e.getKey(), this.this$0.colGetEntry(this.mIndex, 0)) && ContainerHelpers.equal(e.getValue(), this.this$0.colGetEntry(this.mIndex, 1));
            }
        }
    ...
    final class EntrySet implements Set<Map.Entry<K, V>> {
        ...
        EntrySet(MapCollections this$02) {
            this.this$0 = this$02;
        }
    ...
    final class ValuesCollection implements Collection<V> {
        ...
        ValuesCollection(MapCollections this$02) {
            this.this$0 = this$02;
        }
