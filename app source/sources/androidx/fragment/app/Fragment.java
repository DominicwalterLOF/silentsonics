...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner {
    ...
    public final void setIndex(int index, Fragment fragment) {
        ...
        if (parent != null) {
            new StringBuilder();
            this.mWho = sb2.append(parent.mWho).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(this.mIndex).toString();
            return;
        }
        new StringBuilder();
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (this.mChildFragmentManager != null) {
            writer.print(prefix);
            new StringBuilder();
            writer.println(sb.append("Child ").append(this.mChildFragmentManager).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).toString());
