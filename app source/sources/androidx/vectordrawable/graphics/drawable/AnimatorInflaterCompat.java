...
public class AnimatorInflaterCompat {
    ...
    private static int inferValueTypeOfKeyframe(Resources res, Resources.Theme theme, AttributeSet attrs, XmlPullParser parser) {
        ...
        TypedValue keyframeValue = TypedArrayUtils.peekNamedValue(a, parser, CommonProperties.VALUE, 0);
    ...
    private static Keyframe loadKeyframe(Context context, Resources res, Resources.Theme theme, AttributeSet attrs, int i, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        if (hasValue) {
            switch (valueType) {
                case 0:
                    keyframe = Keyframe.ofFloat(fraction, TypedArrayUtils.getNamedFloat(a, parser, CommonProperties.VALUE, 0, 0.0f));
                    break;
                case 1:
                case 3:
                    keyframe = Keyframe.ofInt(fraction, TypedArrayUtils.getNamedInt(a, parser, CommonProperties.VALUE, 0, 0));
                    break;
            }
        } else {
            if (valueType == 0) {
