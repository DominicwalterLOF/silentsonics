...
public class PathInterpolatorCompat implements Interpolator {
    ...
    public PathInterpolatorCompat(android.content.Context r10, android.util.AttributeSet r11, org.xmlpull.v1.XmlPullParser r12) {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.graphics.drawable.PathInterpolatorCompat.<init>(android.content.Context, android.util.AttributeSet, org.xmlpull.v1.XmlPullParser):void");
    }
    ...
    private void initPath(Path path) {
        ...
        if (((double) Math.abs(this.mX[0])) > 1.0E-5d || ((double) Math.abs(this.mY[0])) > 1.0E-5d || ((double) Math.abs(this.mX[numPoints - 1] - 1.0f)) > 1.0E-5d || ((double) Math.abs(this.mY[numPoints - 1] - 1.0f)) > 1.0E-5d) {
            Throwable th6 = th;
            new StringBuilder();
            new IllegalArgumentException(sb.append("The Path must start at (0,0) and end at (1,1) start: ").append(this.mX[0]).append(",").append(this.mY[0]).append(" end:").append(this.mX[numPoints - 1]).append(",").append(this.mY[numPoints - 1]).toString());
            throw th6;
        }
        float prevX = 0.0f;
    ...
    public float getInterpolation(float f) {
        ...
        return startY + (fraction * (this.mY[endIndex] - startY));
    }
}
