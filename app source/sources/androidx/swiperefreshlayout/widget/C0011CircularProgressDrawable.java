...
/* renamed from: androidx.swiperefreshlayout.widget.CircularProgressDrawable */
public class C0011CircularProgressDrawable extends Drawable implements Animatable {
    ...
    /* renamed from: androidx.swiperefreshlayout.widget.CircularProgressDrawable$ProgressDrawableSize */
    ...
    public C0011CircularProgressDrawable(@NonNull Context context) {
        Ring ring;
    ...
    public void updateRingColor(float f, Ring ring) {
        ...
        if (interpolatedTime > 0.75f) {
            ring2.setColor(evaluateColorChange((interpolatedTime - 0.75f) / 0.25f, ring2.getStartingColor(), ring2.getNextColor()));
        } else {
    ...
    private void applyFinishTranslation(float f, Ring ring) {
        ...
        float targetRotation = (float) (Math.floor((double) (ring2.getStartingRotation() / 0.8f)) + 1.0d);
        ring2.setStartTrim(ring2.getStartingStartTrim() + (((ring2.getStartingEndTrim() - 0.01f) - ring2.getStartingStartTrim()) * interpolatedTime));
    ...
    public void applyTransformation(float f, Ring ring, boolean z) {
        ...
        if (this.mFinishing) {
            ...
            if (interpolatedTime < 0.5f) {
                ...
                endTrim = startTrim + (0.79f * MATERIAL_INTERPOLATOR.getInterpolation(interpolatedTime / 0.5f)) + 0.01f;
            } else {
                endTrim = ring2.getStartingStartTrim() + 0.79f;
                startTrim = endTrim - ((0.79f * (1.0f - MATERIAL_INTERPOLATOR.getInterpolation((interpolatedTime - 0.5f) / 0.5f))) + 0.01f);
            }
            float groupRotation = 216.0f * (interpolatedTime + this.mRotationCount);
            ring2.setStartTrim(startTrim);
            ring2.setEndTrim(endTrim);
            ring2.setRotation(startingRotation + (0.20999998f * interpolatedTime));
    ...
    private void setupAnimators() {
        ...
        new ValueAnimator.AnimatorUpdateListener(this) {
            final /* synthetic */ C0011CircularProgressDrawable this$0;
    ...
    /* renamed from: androidx.swiperefreshlayout.widget.CircularProgressDrawable$Ring */
