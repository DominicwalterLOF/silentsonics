...
/* renamed from: androidx.swiperefreshlayout.widget.CircleImageView */
class C0010CircleImageView extends ImageView {
    ...
    C0010CircleImageView(Context context, int i) {
        super(context);
        OvalShape oval;
    ...
    /* renamed from: androidx.swiperefreshlayout.widget.CircleImageView$OvalShadow */
    private class OvalShadow extends OvalShape {
        private RadialGradient mRadialGradient;
        private Paint mShadowPaint;
        final /* synthetic */ C0010CircleImageView this$0;

        OvalShadow(C0010CircleImageView circleImageView, int shadowRadius) {
            Paint paint;
            C0010CircleImageView circleImageView2 = circleImageView;
        ...
        private void updateRadialGradient(int i) {
            ...
            int diameter = i;
            new RadialGradient((float) (diameter / 2), (float) (diameter / 2), (float) this.this$0.mShadowRadius, new int[]{1023410176, 0}, (float[]) null, Shader.TileMode.CLAMP);
