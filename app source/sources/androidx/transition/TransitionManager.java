...
public class TransitionManager {
    ...
    public TransitionManager() {
        ...
        ArrayMap<Scene, ArrayMap<Scene, Transition>> arrayMap2;
        new ArrayMap<>();
    ...
    static {
        ...
        ThreadLocal<WeakReference<ArrayMap<ViewGroup, ArrayList<Transition>>>> threadLocal;
    ...
    public void setTransition(@NonNull Scene scene, @NonNull Scene scene2, @Nullable Transition transition) {
        ...
        ArrayMap arrayMap2 = this.mScenePairTransitions.get(toScene);
        if (arrayMap2 == null) {
            new ArrayMap();
            arrayMap2 = arrayMap;
            ArrayMap<Scene, Transition> put = this.mScenePairTransitions.put(toScene, arrayMap2);
        }
    ...
    private static void sceneChangeRunTransition(android.view.ViewGroup r8, androidx.transition.Transition r9) {
        /*
            r0 = r8
            r1 = r9
            r3 = r1
            ...
            r3 = r0
            if (r3 == 0) goto L_0x0021
            androidx.transition.TransitionManager$MultiListener r3 = new androidx.transition.TransitionManager$MultiListener
            r7 = r3
            r3 = r7
            r4 = r7
            r5 = r1
        ...
        L_0x0021:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.transition.TransitionManager.sceneChangeRunTransition(android.view.ViewGroup, androidx.transition.Transition):void");
    }
    ...
    private static class MultiListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        public boolean onPreDraw() {
            ...
            final ArrayMap<ViewGroup, ArrayList<Transition>> arrayMap = runningTransitions;
