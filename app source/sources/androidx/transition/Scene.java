...
public class Scene {
    ...
    public static Scene getSceneForLayout(@NonNull ViewGroup viewGroup, @LayoutRes int i, @NonNull Context context) {
        ...
        SparseArray sparseArray2 = (SparseArray) sceneRoot.getTag(R.id.transition_scene_layoutid_cache);
        if (sparseArray2 == null) {
            new SparseArray();
            sparseArray2 = sparseArray;
            sceneRoot.setTag(R.id.transition_scene_layoutid_cache, sparseArray2);
        }
