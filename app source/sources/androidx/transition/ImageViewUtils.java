        ...
        if (Build.VERSION.SDK_INT < 21) {
            ...
            new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animator) {
                    ...
                    ImageView.ScaleType scaleType = (ImageView.ScaleType) imageView2.getTag(R.id.save_scale_type);
                    imageView2.setScaleType(scaleType);
                    imageView2.setTag(R.id.save_scale_type, (Object) null);
                    if (scaleType == ImageView.ScaleType.MATRIX) {
                        imageView2.setImageMatrix((Matrix) imageView2.getTag(R.id.save_image_matrix));
                        imageView2.setTag(R.id.save_image_matrix, (Object) null);
                    }
