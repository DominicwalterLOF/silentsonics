...
class ViewUtilsBase {
    ...
    public void setTransitionAlpha(@NonNull View view, float f) {
        View view2 = view;
        float alpha = f;
        Float savedAlpha = (Float) view2.getTag(R.id.save_non_transition_alpha);
        if (savedAlpha != null) {
    ...
    public void saveNonTransitionAlpha(@NonNull View view) {
        View view2 = view;
        if (view2.getTag(R.id.save_non_transition_alpha) == null) {
    ...
    public void clearNonTransitionAlpha(@NonNull View view) {
        ...
        if (view2.getVisibility() == 0) {
            view2.setTag(R.id.save_non_transition_alpha, (Object) null);
        }
    }
