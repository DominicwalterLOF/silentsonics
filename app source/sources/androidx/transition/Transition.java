...
public abstract class Transition implements Cloneable {
    ...
    static {
        ...
        ThreadLocal<ArrayMap<Animator, AnimationInfo>> threadLocal;
        new PathMotion() {
    ...
    private void matchInstances(ArrayMap<View, TransitionValues> arrayMap, ArrayMap<View, TransitionValues> arrayMap2) {
        ...
        ArrayMap<View, TransitionValues> unmatchedStart = arrayMap;
        ArrayMap<View, TransitionValues> unmatchedEnd = arrayMap2;
    ...
    private void matchItemIds(ArrayMap<View, TransitionValues> arrayMap, ArrayMap<View, TransitionValues> arrayMap2, LongSparseArray<View> longSparseArray, LongSparseArray<View> longSparseArray2) {
        ...
        ArrayMap<View, TransitionValues> unmatchedStart = arrayMap;
        ArrayMap<View, TransitionValues> unmatchedEnd = arrayMap2;
        LongSparseArray<View> startItemIds = longSparseArray;
        LongSparseArray<View> endItemIds = longSparseArray2;
    ...
    private void matchNames(ArrayMap<View, TransitionValues> arrayMap, ArrayMap<View, TransitionValues> arrayMap2, ArrayMap<String, View> arrayMap3, ArrayMap<String, View> arrayMap4) {
        ...
        ArrayMap<View, TransitionValues> unmatchedStart = arrayMap;
        ArrayMap<View, TransitionValues> unmatchedEnd = arrayMap2;
        ArrayMap<String, View> startNames = arrayMap3;
        ArrayMap<String, View> endNames = arrayMap4;
    ...
    private void matchStartAndEnd(TransitionValuesMaps transitionValuesMaps, TransitionValuesMaps transitionValuesMaps2) {
        ...
        new ArrayMap((SimpleArrayMap) startValues.mViewValues);
        ArrayMap arrayMap3 = arrayMap;
        new ArrayMap((SimpleArrayMap) endValues.mViewValues);
    ...
    private static ArrayMap<Animator, AnimationInfo> getRunningAnimators() {
        ArrayMap arrayMap;
        ArrayMap arrayMap2 = sRunningAnimators.get();
        if (arrayMap2 == null) {
            new ArrayMap();
            arrayMap2 = arrayMap;
    ...
    private void runAnimator(Animator animator, ArrayMap<Animator, AnimationInfo> arrayMap) {
        ...
        if (animator2 != null) {
            final ArrayMap<Animator, AnimationInfo> arrayMap2 = runningAnimators;
