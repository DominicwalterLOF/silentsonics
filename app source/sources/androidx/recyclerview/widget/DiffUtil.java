...
public class DiffUtil {
    ...
    public static DiffResult calculateDiff(@NonNull Callback callback, boolean z) {
        ...
        while (!stack.isEmpty()) {
            ...
            if (snake != null) {
                ...
                snake.x += range2.oldListStart;
                snake.y += range2.newListStart;
    ...
    private static androidx.recyclerview.widget.DiffUtil.Snake diffPartial(androidx.recyclerview.widget.DiffUtil.Callback r28, int r29, int r30, int r31, int r32, int[] r33, int[] r34, int r35) {
        /*
            r2 = r28
            r3 = r29
            r4 = r30
        ...
        L_0x0165:
            ...
            r1 = r23
            if (r0 < r1) goto L_0x021e
            androidx.recyclerview.widget.DiffUtil$Snake r22 = new androidx.recyclerview.widget.DiffUtil$Snake
            r27 = r22
            r22 = r27
            r23 = r27
            r23.<init>()
