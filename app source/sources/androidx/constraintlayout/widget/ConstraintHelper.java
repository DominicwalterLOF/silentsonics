...
public abstract class ConstraintHelper extends View {
    ...
    public ConstraintHelper(android.content.Context r5) {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.widget.ConstraintHelper.<init>(android.content.Context):void");
    }
    ...
    public ConstraintHelper(android.content.Context r7, android.util.AttributeSet r8) {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.widget.ConstraintHelper.<init>(android.content.Context, android.util.AttributeSet):void");
    }
    ...
    public ConstraintHelper(android.content.Context r9, android.util.AttributeSet r10, int r11) {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.widget.ConstraintHelper.<init>(android.content.Context, android.util.AttributeSet, int):void");
    }
    ...
    private void addID(String str) {
        ...
        if (idString != null && this.myContext != null) {
            ...
            if (tag == 0) {
                tag = this.myContext.getResources().getIdentifier(idString2, CommonProperties.ID, this.myContext.getPackageName());
            }
