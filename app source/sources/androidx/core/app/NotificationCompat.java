...
public class NotificationCompat {
        ...
        public static final class Message {
            ...
            public Message(java.lang.CharSequence r13, long r14, java.lang.CharSequence r16) {
                /*
                    ...
                    r5.<init>((java.lang.CharSequence) r6, (long) r7, (androidx.core.app.Person) r9)
                    return
                */
            ...
            private Bundle toBundle() {
                ...
                if (this.mDataMimeType != null) {
                    bundle2.putString("type", this.mDataMimeType);
                }
            ...
            static Message getMessageFromBundle(Bundle bundle) {
                ...
                try {
                    ...
                    Message message2 = message;
                    if (bundle2.containsKey("type") && bundle2.containsKey(KEY_DATA_URI)) {
                        Message data = message2.setData(bundle2.getString("type"), (Uri) bundle2.getParcelable(KEY_DATA_URI));
                    }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean showActions) {
            ...
            RemoteViews remoteViews2 = applyStandardTemplate(true, R.layout.notification_template_custom_big, false);
            remoteViews2.removeAllViews(R.id.actions);
            boolean actionsVisible = false;
            if (showActions && this.mBuilder.mActions != null && (numActions = Math.min(this.mBuilder.mActions.size(), 3)) > 0) {
                actionsVisible = true;
                for (int i = 0; i < numActions; i++) {
                    remoteViews2.addView(R.id.actions, generateActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            int actionVisibility = actionsVisible ? 0 : 8;
            remoteViews2.setViewVisibility(R.id.actions, actionVisibility);
            remoteViews2.setViewVisibility(R.id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews2 = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? R.layout.notification_action_tombstone : R.layout.notification_action);
            RemoteViews button = remoteViews;
            button.setImageViewBitmap(R.id.action_image, createColoredBitmap(action2.getIcon(), this.mBuilder.mContext.getResources().getColor(R.color.notification_action_color_filter)));
            button.setTextViewText(R.id.action_text, action2.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(R.id.action_container, action2.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(R.id.action_container, action2.title);
            }
            return button;
        }
    }
        ...
        public static final class Builder {
            ...
            public Builder(androidx.core.app.NotificationCompat.Action r13) {
                /*
                    ...
                    r7.<init>(r8)
                    r7 = r1
                    androidx.core.app.RemoteInput[] r7 = r7.getRemoteInputs()
                    r8 = r1
