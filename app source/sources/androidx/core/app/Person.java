...
public class Person {
    ...
    public static Person fromBundle(@NonNull Bundle bundle) {
        ...
        new Builder();
        return builder.setName(bundle2.getCharSequence("name")).setIcon(iconBundle != null ? IconCompat.createFromBundle(iconBundle) : null).setUri(bundle2.getString(URI_KEY)).setKey(bundle2.getString(KEY_KEY)).setBot(bundle2.getBoolean(IS_BOT_KEY)).setImportant(bundle2.getBoolean(IS_IMPORTANT_KEY)).build();
    }
