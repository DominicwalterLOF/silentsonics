...
public final class PathSegment {
    ...
    public int hashCode() {
        return (31 * ((31 * ((31 * this.mStart.hashCode()) + (this.mStartFraction != 0.0f ? Float.floatToIntBits(this.mStartFraction) : 0))) + this.mEnd.hashCode())) + (this.mEndFraction != 0.0f ? Float.floatToIntBits(this.mEndFraction) : 0);
    }

    public String toString() {
        StringBuilder sb;
        new StringBuilder();
        return sb.append("PathSegment{start=").append(this.mStart).append(", startFraction=").append(this.mStartFraction).append(", end=").append(this.mEnd).append(", endFraction=").append(this.mEndFraction).append('}').toString();
    }
}
