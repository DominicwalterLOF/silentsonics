...
public class AccessibilityRecordCompat {
    ...
    public static AccessibilityRecordCompat obtain(AccessibilityRecordCompat record) {
        AccessibilityRecordCompat record2;
        new AccessibilityRecordCompat(AccessibilityRecord.obtain(record.mRecord));
        return record2;
    }
    ...
    public static AccessibilityRecordCompat obtain() {
        ...
        new AccessibilityRecordCompat(AccessibilityRecord.obtain());
