...
public final class PointerIconCompat {
    ...
    public static PointerIconCompat getSystemIcon(Context context, int i) {
        ...
        PointerIconCompat pointerIconCompat2;
        Context context2 = context;
        int style = i;
        if (Build.VERSION.SDK_INT >= 24) {
            new PointerIconCompat(PointerIcon.getSystemIcon(context2, style));
            return pointerIconCompat2;
        }
        new PointerIconCompat((Object) null);
    ...
    public static PointerIconCompat create(Bitmap bitmap, float f, float f2) {
        ...
        float hotSpotY = f2;
        if (Build.VERSION.SDK_INT >= 24) {
            new PointerIconCompat(PointerIcon.create(bitmap2, hotSpotX, hotSpotY));
            return pointerIconCompat2;
        }
        new PointerIconCompat((Object) null);
        return pointerIconCompat;
    ...
    public static PointerIconCompat load(Resources resources, int i) {
        ...
        int resourceId = i;
        if (Build.VERSION.SDK_INT >= 24) {
            new PointerIconCompat(PointerIcon.load(resources2, resourceId));
            return pointerIconCompat2;
        }
        new PointerIconCompat((Object) null);
        return pointerIconCompat;
