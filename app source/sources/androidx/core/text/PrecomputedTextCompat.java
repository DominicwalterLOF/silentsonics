...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static PrecomputedTextCompat create(@NonNull CharSequence charSequence, @NonNull Params params) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT < 28 || params2.mWrapped == null) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    StaticLayout build = StaticLayout.Builder.obtain(text, 0, text.length(), params2.getTextPaint(), ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED).setBreakStrategy(params2.getBreakStrategy()).setHyphenationFrequency(params2.getHyphenationFrequency()).setTextDirection(params2.getTextDirection()).build();
                } else if (Build.VERSION.SDK_INT >= 21) {
                    Object obj2 = obj;
                    new StaticLayout(text, params2.getTextPaint(), ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                }
    ...
    private static class PrecomputedTextFutureTask extends FutureTask<PrecomputedTextCompat> {
        ...
        PrecomputedTextFutureTask(@androidx.annotation.NonNull androidx.core.text.PrecomputedTextCompat.Params r10, @androidx.annotation.NonNull java.lang.CharSequence r11) {
            /*
                r9 = this;
                r0 = r9
                r1 = r10
                r2 = r11
                r3 = r0
                androidx.core.text.PrecomputedTextCompat$PrecomputedTextFutureTask$PrecomputedTextCallback r4 = new androidx.core.text.PrecomputedTextCompat$PrecomputedTextFutureTask$PrecomputedTextCallback
                r8 = r4
                r4 = r8
                r5 = r8
                r6 = r1
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.text.PrecomputedTextCompat.PrecomputedTextFutureTask.<init>(androidx.core.text.PrecomputedTextCompat$Params, java.lang.CharSequence):void");
        }
    }

    /* JADX WARNING: type inference failed for: r0v1, types: [java.util.concurrent.Future<androidx.core.text.PrecomputedTextCompat>] */
    /* JADX WARNING: Multi-variable type inference failed */
    @androidx.annotation.UiThread
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.concurrent.Future<androidx.core.text.PrecomputedTextCompat> getTextFuture(@androidx.annotation.NonNull java.lang.CharSequence r11, @androidx.annotation.NonNull androidx.core.text.PrecomputedTextCompat.Params r12, @androidx.annotation.Nullable java.util.concurrent.Executor r13) {
        /*
            r0 = r11
            r1 = r12
            r2 = r13
            androidx.core.text.PrecomputedTextCompat$PrecomputedTextFutureTask r6 = new androidx.core.text.PrecomputedTextCompat$PrecomputedTextFutureTask
            r10 = r6
            r6 = r10
            r7 = r10
            r8 = r1
        ...
        L_0x0030:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.text.PrecomputedTextCompat.getTextFuture(java.lang.CharSequence, androidx.core.text.PrecomputedTextCompat$Params, java.util.concurrent.Executor):java.util.concurrent.Future");
    }
