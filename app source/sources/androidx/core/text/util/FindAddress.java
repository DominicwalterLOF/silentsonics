...
class FindAddress {
    ...
    static {
        /*
            ...
            r1 = r9
            r2 = 0
            androidx.core.text.util.FindAddress$ZipRange r3 = new androidx.core.text.util.FindAddress$ZipRange
            r9 = r3
            r3 = r9
            r4 = r9
            r5 = 99
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.text.util.FindAddress.<clinit>():void");
    }
                ...
                if (matcher.find(it)) {
                    if (matcher.end() - matcher.start() <= 25) {
                        while (it < matcher.start()) {
                            int i = it;
                            it++;
                            if (NL.indexOf(content.charAt(i)) != -1) {
                                numLines++;
                            }
                        }
                        if (numLines <= 5) {
