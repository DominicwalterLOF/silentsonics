...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            StringBuilder append = sb2.append(res.getString(R.string.abc_prepend_shortcut_label));
        }
        ...
        int modifiers = i;
        appendModifier(sb2, modifiers, 65536, res.getString(R.string.abc_menu_meta_shortcut_label));
        appendModifier(sb2, modifiers, 4096, res.getString(R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(sb2, modifiers, 2, res.getString(R.string.abc_menu_alt_shortcut_label));
        appendModifier(sb2, modifiers, 1, res.getString(R.string.abc_menu_shift_shortcut_label));
        appendModifier(sb2, modifiers, 4, res.getString(R.string.abc_menu_sym_shortcut_label));
        appendModifier(sb2, modifiers, 8, res.getString(R.string.abc_menu_function_shortcut_label));
        switch (shortcut) {
            case 8:
                StringBuilder append2 = sb2.append(res.getString(R.string.abc_menu_delete_shortcut_label));
                break;
            case 10:
                StringBuilder append3 = sb2.append(res.getString(R.string.abc_menu_enter_shortcut_label));
                break;
            case ' ':
                StringBuilder append4 = sb2.append(res.getString(R.string.abc_menu_space_shortcut_label));
                break;
            default:
