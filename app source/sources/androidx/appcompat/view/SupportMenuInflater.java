...
public class SupportMenuInflater extends MenuInflater {
    ...
    public SupportMenuInflater(android.content.Context r9) {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.view.SupportMenuInflater.<init>(android.content.Context):void");
    }
    ...
    private class MenuState {
        ...
        public void readItem(AttributeSet attrs) {
            ...
            this.itemCategoryOrder = (a.getInt(R.styleable.MenuItem_android_menuCategory, this.groupCategory) & SupportMenu.CATEGORY_MASK) | (a.getInt(R.styleable.MenuItem_android_orderInCategory, this.groupOrder) & 65535);
