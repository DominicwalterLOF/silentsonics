...
class TwilightCalculator {
    ...
    public void calculateTwilight(long j, double latitude, double longitude) {
        ...
        double solarTransitJ2000 = ((double) (((float) Math.round(((double) (daysSince2000 - J0)) - arcLongitude)) + J0)) + arcLongitude + (0.0053d * Math.sin((double) meanAnomaly)) + (-0.0069d * Math.sin(2.0d * solarLng));
