...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    protected AlertDialog(@androidx.annotation.NonNull android.content.Context r11, @androidx.annotation.StyleRes int r12) {
        /*
            r10 = this;
            r0 = r10
            r1 = r11
    ...
    static int resolveDialogTheme(@NonNull Context context, @StyleRes int i) {
        ...
        boolean resolveAttribute = context2.getTheme().resolveAttribute(R.attr.alertDialogTheme, outValue, true);
    ...
    public static class Builder {
        ...
        /* JADX WARNING: Illegal instructions before constructor call */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public Builder(@androidx.annotation.NonNull android.content.Context r7) {
            /*
                r6 = this;
                r0 = r6
                r1 = r7
                ...
                r4 = r1
                r5 = 0
                int r4 = androidx.appcompat.app.AlertDialog.resolveDialogTheme(r4, r5)
                r2.<init>(r3, r4)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.app.AlertDialog.Builder.<init>(android.content.Context):void");
        }
        ...
        public Builder setIconAttribute(@AttrRes int attrId) {
            ...
            new TypedValue();
            TypedValue out = typedValue;
            boolean resolveAttribute = this.P.mContext.getTheme().resolveAttribute(attrId, out, true);
        ...
        public AlertDialog create() {
            ...
            new AlertDialog(this.P.mContext, this.mTheme);
