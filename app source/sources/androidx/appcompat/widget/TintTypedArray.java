...
public class TintTypedArray {
    ...
    public static TintTypedArray obtainStyledAttributes(Context context, AttributeSet set, int[] attrs) {
        ...
        new TintTypedArray(context2, context2.obtainStyledAttributes(set, attrs));
    ...
    public static TintTypedArray obtainStyledAttributes(Context context, AttributeSet set, int[] attrs, int defStyleAttr, int defStyleRes) {
        TintTypedArray tintTypedArray;
        Context context2 = context;
        new TintTypedArray(context2, context2.obtainStyledAttributes(set, attrs, defStyleAttr, defStyleRes));
        return tintTypedArray;
    }
    ...
    public static TintTypedArray obtainStyledAttributes(Context context, int resid, int[] attrs) {
        TintTypedArray tintTypedArray;
        Context context2 = context;
        new TintTypedArray(context2, context2.obtainStyledAttributes(resid, attrs));
        return tintTypedArray;
    }
    ...
    @Nullable
    public Typeface getFont(@StyleableRes int index, int i, @Nullable ResourcesCompat.FontCallback fontCallback) {
        ...
        return ResourcesCompat.getFont(this.mContext, resourceId, this.mTypedValue, style, fontCallback2);
    }
