...
public final class AppCompatDrawableManager {
    ...
    public AppCompatDrawableManager() {
        WeakHashMap<Context, LongSparseArray<WeakReference<Drawable.ConstantState>>> weakHashMap;
        new WeakHashMap<>(0);
    ...
    static {
        ...
        int[] iArr4 = new int[7];
        iArr4[0] = R.drawable.abc_ic_commit_search_api_mtrl_alpha;
        int[] iArr5 = iArr4;
        iArr5[1] = R.drawable.abc_seekbar_tick_mark_material;
        int[] iArr6 = iArr5;
        iArr6[2] = R.drawable.abc_ic_menu_share_mtrl_alpha;
        int[] iArr7 = iArr6;
        iArr7[3] = R.drawable.abc_ic_menu_copy_mtrl_am_alpha;
        int[] iArr8 = iArr7;
        iArr8[4] = R.drawable.abc_ic_menu_cut_mtrl_alpha;
        int[] iArr9 = iArr8;
        iArr9[5] = R.drawable.abc_ic_menu_selectall_mtrl_alpha;
        int[] iArr10 = iArr9;
        iArr10[6] = R.drawable.abc_ic_menu_paste_mtrl_am_alpha;
        TINT_COLOR_CONTROL_NORMAL = iArr10;
        int[] iArr11 = new int[10];
        iArr11[0] = R.drawable.abc_textfield_activated_mtrl_alpha;
        int[] iArr12 = iArr11;
        iArr12[1] = R.drawable.abc_textfield_search_activated_mtrl_alpha;
        int[] iArr13 = iArr12;
        iArr13[2] = R.drawable.abc_cab_background_top_mtrl_alpha;
        int[] iArr14 = iArr13;
        iArr14[3] = R.drawable.abc_text_cursor_material;
        int[] iArr15 = iArr14;
        iArr15[4] = R.drawable.abc_text_select_handle_left_mtrl_dark;
        int[] iArr16 = iArr15;
        iArr16[5] = R.drawable.abc_text_select_handle_middle_mtrl_dark;
        int[] iArr17 = iArr16;
        iArr17[6] = R.drawable.abc_text_select_handle_right_mtrl_dark;
        int[] iArr18 = iArr17;
        iArr18[7] = R.drawable.abc_text_select_handle_left_mtrl_light;
        int[] iArr19 = iArr18;
        iArr19[8] = R.drawable.abc_text_select_handle_middle_mtrl_light;
        int[] iArr20 = iArr19;
        iArr20[9] = R.drawable.abc_text_select_handle_right_mtrl_light;
        COLORFILTER_COLOR_CONTROL_ACTIVATED = iArr20;
        int[] iArr21 = new int[3];
        iArr21[0] = R.drawable.abc_popup_background_mtrl_mult;
        int[] iArr22 = iArr21;
        iArr22[1] = R.drawable.abc_cab_background_internal_bg;
        int[] iArr23 = iArr22;
        iArr23[2] = R.drawable.abc_menu_hardkey_panel_mtrl_mult;
        COLORFILTER_COLOR_BACKGROUND_MULTIPLY = iArr23;
        int[] iArr24 = new int[2];
        iArr24[0] = R.drawable.abc_tab_indicator_material;
        int[] iArr25 = iArr24;
        iArr25[1] = R.drawable.abc_textfield_search_material;
        TINT_COLOR_CONTROL_STATE_LIST = iArr25;
        int[] iArr26 = new int[2];
        iArr26[0] = R.drawable.abc_btn_check_material;
        int[] iArr27 = iArr26;
        iArr27[1] = R.drawable.abc_btn_radio_material;
    ...
    public synchronized void onConfigurationChanged(@NonNull Context context) {
        Context context2 = context;
        synchronized (this) {
            LongSparseArray<WeakReference<Drawable.ConstantState>> cache = this.mDrawableCaches.get(context2);
            if (cache != null) {
                cache.clear();
            }
        }
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i, boolean z, @NonNull Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context2, R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context2, R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context2, R.attr.colorControlActivated), DEFAULT_MODE);
            ...
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context2, R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context2, R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context2, R.attr.colorControlActivated), DEFAULT_MODE);
    ...
    private synchronized boolean addDrawableToCache(@NonNull Context context, long j, @NonNull Drawable drawable) {
        ...
        synchronized (this) {
            ...
            if (cs != null) {
                LongSparseArray longSparseArray2 = this.mDrawableCaches.get(context2);
                if (longSparseArray2 == null) {
                    new LongSparseArray();
                    longSparseArray2 = longSparseArray;
                    LongSparseArray<WeakReference<Drawable.ConstantState>> put = this.mDrawableCaches.put(context2, longSparseArray2);
                }
    ...
    private void addDelegate(@NonNull String str, @NonNull InflateDelegate inflateDelegate) {
        ArrayMap<String, InflateDelegate> arrayMap;
        String tagName = str;
        ...
        synchronized (this) {
            ...
            if (tint == null) {
                if (resId == R.drawable.abc_edit_text_material) {
                    tint = AppCompatResources.getColorStateList(context2, R.color.abc_tint_edittext);
                } else if (resId == R.drawable.abc_switch_track_mtrl_alpha) {
                    tint = AppCompatResources.getColorStateList(context2, R.color.abc_tint_switch_track);
                    ...
                    tint = AppCompatResources.getColorStateList(context2, R.color.abc_tint_spinner);
                } else if (arrayContains(TINT_COLOR_CONTROL_NORMAL, resId)) {
                    tint = ThemeUtils.getThemeAttrColorStateList(context2, R.attr.colorControlNormal);
                } else if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, resId)) {
                    tint = AppCompatResources.getColorStateList(context2, R.color.abc_tint_default);
                } else if (arrayContains(TINT_CHECKABLE_BUTTON_LIST, resId)) {
                    tint = AppCompatResources.getColorStateList(context2, R.color.abc_tint_btn_checkable);
                } else if (resId == R.drawable.abc_seekbar_thumb_material) {
                    tint = AppCompatResources.getColorStateList(context2, R.color.abc_tint_seek_thumb);
                }
                if (tint != null) {
    ...
    private ColorStateList getTintListFromCache(@NonNull Context context, @DrawableRes int i) {
        ...
        SparseArrayCompat<ColorStateList> tints = this.mTintLists.get(context2);
    ...
    private void addTintListToCache(@NonNull Context context, @DrawableRes int i, @NonNull ColorStateList colorStateList) {
        ...
        WeakHashMap<Context, SparseArrayCompat<ColorStateList>> weakHashMap;
        Context context2 = context;
        int resId = i;
        ...
        SparseArrayCompat sparseArrayCompat2 = this.mTintLists.get(context2);
        if (sparseArrayCompat2 == null) {
            new SparseArrayCompat();
            sparseArrayCompat2 = sparseArrayCompat;
            SparseArrayCompat<ColorStateList> put = this.mTintLists.put(context2, sparseArrayCompat2);
        }
    ...
    private ColorStateList createDefaultButtonColorStateList(@NonNull Context context) {
        Context context2 = context;
        return createButtonColorStateList(context2, ThemeUtils.getThemeAttrColor(context2, R.attr.colorButtonNormal));
    }
    ...
    private ColorStateList createColoredButtonColorStateList(@NonNull Context context) {
        Context context2 = context;
        return createButtonColorStateList(context2, ThemeUtils.getThemeAttrColor(context2, R.attr.colorAccent));
    }
    ...
    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int i) {
        ...
        int colorControlHighlight = ThemeUtils.getThemeAttrColor(context2, R.attr.colorControlHighlight);
        int disabledColor = ThemeUtils.getDisabledThemeAttrColor(context2, R.attr.colorButtonNormal);
    ...
    private ColorStateList createSwitchThumbColorStateList(Context context) {
        ...
        ColorStateList thumbColor = ThemeUtils.getThemeAttrColorStateList(context2, R.attr.colorSwitchThumbNormal);
        if (thumbColor == null || !thumbColor.isStateful()) {
            states[0] = ThemeUtils.DISABLED_STATE_SET;
            colors[0] = ThemeUtils.getDisabledThemeAttrColor(context2, R.attr.colorSwitchThumbNormal);
            int i = 0 + 1;
            states[i] = ThemeUtils.CHECKED_STATE_SET;
            colors[i] = ThemeUtils.getThemeAttrColor(context2, R.attr.colorControlActivated);
            int i2 = i + 1;
            states[i2] = ThemeUtils.EMPTY_STATE_SET;
            colors[i2] = ThemeUtils.getThemeAttrColor(context2, R.attr.colorSwitchThumbNormal);
            int i3 = i2 + 1;
        } else {
            states[0] = ThemeUtils.DISABLED_STATE_SET;
            ...
            colors[i4] = ThemeUtils.getThemeAttrColor(context2, R.attr.colorControlActivated);
            int i5 = i4 + 1;
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        ...
        if (!this.mHasCheckedVectorDrawableSetup) {
            ...
            Drawable d = getDrawable(context2, R.drawable.abc_vector_test);
