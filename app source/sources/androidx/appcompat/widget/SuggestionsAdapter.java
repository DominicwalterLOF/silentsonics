...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public SuggestionsAdapter(android.content.Context r11, androidx.appcompat.widget.SearchView r12, android.app.SearchableInfo r13, java.util.WeakHashMap<java.lang.String, android.graphics.drawable.Drawable.ConstantState> r14) {
        /*
            r10 = this;
            r0 = r10
            r1 = r11
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.SuggestionsAdapter.<init>(android.content.Context, androidx.appcompat.widget.SearchView, android.app.SearchableInfo, java.util.WeakHashMap):void");
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        ...
        if (this.mUrlColor == null) {
            ...
            boolean resolveAttribute = this.mContext.getTheme().resolveAttribute(R.attr.textColorSearchUrl, colorValue, true);
