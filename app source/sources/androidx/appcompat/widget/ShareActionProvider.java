...
public class ShareActionProvider extends ActionProvider {
    ...
    public ShareActionProvider(android.content.Context r8) {
        /*
            ...
            r2 = r0
            androidx.appcompat.widget.ShareActionProvider$ShareMenuItemOnMenuItemClickListener r3 = new androidx.appcompat.widget.ShareActionProvider$ShareMenuItemOnMenuItemClickListener
            r6 = r3
            r3 = r6
            r4 = r6
            r5 = r0
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.ShareActionProvider.<init>(android.content.Context):void");
    }
    ...
    public View onCreateActionView() {
        ...
        boolean resolveAttribute = this.mContext.getTheme().resolveAttribute(R.attr.actionModeShareDrawable, outTypedValue, true);
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (collapsedActivityCount < expandedActivityCount) {
            SubMenu expandedSubMenu = subMenu2.addSubMenu(0, collapsedActivityCount, collapsedActivityCount, this.mContext.getString(R.string.abc_activity_chooser_view_see_all));
