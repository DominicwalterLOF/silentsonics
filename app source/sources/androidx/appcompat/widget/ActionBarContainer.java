...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(android.content.Context r11, android.util.AttributeSet r12) {
        /*
            ...
            r7 = r2
            r5.<init>(r6, r7)
            androidx.appcompat.widget.ActionBarBackgroundDrawable r5 = new androidx.appcompat.widget.ActionBarBackgroundDrawable
            r9 = r5
            r5 = r9
            r6 = r9
            r7 = r0
            ...
            r5 = r1
            r6 = r2
            int[] r7 = androidx.appcompat.R.styleable.ActionBar
            android.content.res.TypedArray r5 = r5.obtainStyledAttributes(r6, r7)
            r4 = r5
            r5 = r0
            r6 = r4
            int r7 = androidx.appcompat.R.styleable.ActionBar_background
            android.graphics.drawable.Drawable r6 = r6.getDrawable(r7)
            r5.mBackground = r6
            r5 = r0
            r6 = r4
            int r7 = androidx.appcompat.R.styleable.ActionBar_backgroundStacked
            android.graphics.drawable.Drawable r6 = r6.getDrawable(r7)
            r5.mStackedBackground = r6
            r5 = r0
            r6 = r4
            int r7 = androidx.appcompat.R.styleable.ActionBar_height
            r8 = -1
            int r6 = r6.getDimensionPixelSize(r7, r8)
            r5.mHeight = r6
            r5 = r0
            int r5 = r5.getId()
            int r6 = androidx.appcompat.R.id.split_action_bar
            ...
            r5 = r0
            r6 = r4
            int r7 = androidx.appcompat.R.styleable.ActionBar_backgroundSplit
            android.graphics.drawable.Drawable r6 = r6.getDrawable(r7)
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mActionBarView != null) {
            ...
            if (this.mTabContainer != null && this.mTabContainer.getVisibility() != 8 && mode != 1073741824) {
                ...
                setMeasuredDimension(getMeasuredWidth(), Math.min(topMarginForTabs + getMeasuredHeightWithMargins(this.mTabContainer), mode == Integer.MIN_VALUE ? View.MeasureSpec.getSize(heightMeasureSpec) : ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED));
            }
        }
    }
