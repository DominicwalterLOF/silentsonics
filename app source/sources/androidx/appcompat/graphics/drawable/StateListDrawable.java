...
class StateListDrawable extends DrawableContainer {
    ...
    public void inflate(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser parser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        TypedArray a = TypedArrayUtils.obtainAttributes(r, theme2, attrs, R.styleable.StateListDrawable);
        boolean visible = setVisible(a.getBoolean(R.styleable.StateListDrawable_android_visible, true), true);
        ...
        while (true) {
            ...
            if (next2 != 1) {
                ...
                if (type2 == 2 && depth2 <= innerDepth && parser.getName().equals("item")) {
                    TypedArray a = TypedArrayUtils.obtainAttributes(r, theme2, attrs, R.styleable.StateListDrawableItem);
                    Drawable dr = null;
    ...
    static class StateListState extends DrawableContainer.DrawableContainerState {
        ...
        StateListState(androidx.appcompat.graphics.drawable.StateListDrawable.StateListState r9, androidx.appcompat.graphics.drawable.StateListDrawable r10, android.content.res.Resources r11) {
            /*
                r8 = this;
                r0 = r8
                r1 = r9
            ...
            L_0x0015:
                ...
                goto L_0x0014
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.graphics.drawable.StateListDrawable.StateListState.<init>(androidx.appcompat.graphics.drawable.StateListDrawable$StateListState, androidx.appcompat.graphics.drawable.StateListDrawable, android.content.res.Resources):void");
        }
