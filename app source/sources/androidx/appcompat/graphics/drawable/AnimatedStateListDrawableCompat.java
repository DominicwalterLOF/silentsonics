...
public class AnimatedStateListDrawableCompat extends StateListDrawable {
    ...
    public void inflate(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser parser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        AttributeSet attrs = attributeSet;
        Resources.Theme theme2 = theme;
        TypedArray a = TypedArrayUtils.obtainAttributes(resources2, theme2, attrs, R.styleable.AnimatedStateListDrawableCompat);
        boolean visible = setVisible(a.getBoolean(R.styleable.AnimatedStateListDrawableCompat_android_visible, true), true);
    ...
    private static abstract class Transition {
        ...
        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        /* synthetic */ Transition(AnonymousClass1 r4) {
            this();
    ...
    private int parseTransition(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        AttributeSet attrs = attributeSet;
        Resources.Theme theme2 = theme;
        TypedArray a = TypedArrayUtils.obtainAttributes(resources2, theme2, attrs, R.styleable.AnimatedStateListDrawableTransition);
    ...
    private int parseItem(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        AttributeSet attrs = attributeSet;
        Resources.Theme theme2 = theme;
        TypedArray a = TypedArrayUtils.obtainAttributes(resources2, theme2, attrs, R.styleable.AnimatedStateListDrawableItem);
    ...
    static class AnimatedStateListState extends StateListDrawable.StateListState {
        ...
        AnimatedStateListState(@androidx.annotation.Nullable androidx.appcompat.graphics.drawable.AnimatedStateListDrawableCompat.AnimatedStateListState r10, @androidx.annotation.NonNull androidx.appcompat.graphics.drawable.AnimatedStateListDrawableCompat r11, @androidx.annotation.Nullable android.content.res.Resources r12) {
            /*
                r9 = this;
                r0 = r9
                r1 = r10
                ...
                r4 = r0
                r5 = r1
                androidx.collection.LongSparseArray<java.lang.Long> r5 = r5.mTransitions
                r4.mTransitions = r5
                r4 = r0
                r5 = r1
                androidx.collection.SparseArrayCompat<java.lang.Integer> r5 = r5.mStateIds
                r4.mStateIds = r5
            L_0x001a:
                return
            L_0x001b:
                ...
                r4.mTransitions = r5
                r4 = r0
                androidx.collection.SparseArrayCompat r5 = new androidx.collection.SparseArrayCompat
                r8 = r5
                r5 = r8
                r6 = r8
                r6.<init>()
