...
public class SimpleCursorAdapter extends ResourceCursorAdapter {
    ...
    public SimpleCursorAdapter(android.content.Context r11, int r12, android.database.Cursor r13, java.lang.String[] r14, int[] r15) {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.cursoradapter.widget.SimpleCursorAdapter.<init>(android.content.Context, int, android.database.Cursor, java.lang.String[], int[]):void");
    }
    ...
    public SimpleCursorAdapter(android.content.Context r13, int r14, android.database.Cursor r15, java.lang.String[] r16, int[] r17, int r18) {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.cursoradapter.widget.SimpleCursorAdapter.<init>(android.content.Context, int, android.database.Cursor, java.lang.String[], int[], int):void");
    }
