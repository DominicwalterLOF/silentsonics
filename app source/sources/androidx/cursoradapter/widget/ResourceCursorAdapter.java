...
public abstract class ResourceCursorAdapter extends CursorAdapter {
    ...
    public ResourceCursorAdapter(android.content.Context r11, int r12, android.database.Cursor r13) {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.cursoradapter.widget.ResourceCursorAdapter.<init>(android.content.Context, int, android.database.Cursor):void");
    }
    ...
    public ResourceCursorAdapter(android.content.Context r12, int r13, android.database.Cursor r14, boolean r15) {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.cursoradapter.widget.ResourceCursorAdapter.<init>(android.content.Context, int, android.database.Cursor, boolean):void");
    }
    ...
    public ResourceCursorAdapter(android.content.Context r12, int r13, android.database.Cursor r14, int r15) {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.cursoradapter.widget.ResourceCursorAdapter.<init>(android.content.Context, int, android.database.Cursor, int):void");
    }
